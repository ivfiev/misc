...
class ProcessExitedException(ProcessException):
    ...
    __slots__ = ...
    def __init__(self, msg: str, error_index: int, error_pid: int, exit_code: int, signal_name: str | None = ...) -> None:
        ...
...
def start_processes(fn, args=..., nprocs=..., join=..., daemon=..., start_method=...) -> ProcessContext | None:
    ...
