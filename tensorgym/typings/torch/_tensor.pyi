...
class Tensor(torch._C.TensorBase):
    _is_param: bool
    __dlpack_c_exchange_api__: object = ...
    ...
    def index(self, positions, dims) -> Any | _Tensor:
        """
    ...
    def stft(self, n_fft: int, hop_length: int | None = ..., win_length: int | None = ..., window: Tensor | None = ..., center: bool = ..., pad_mode: str = ..., normalized: bool = ..., onesided: bool | None = ..., return_complex: bool | None = ..., align_to_window: bool | None = ...) -> Any | Tensor:
    ...
    def istft(self, n_fft: int, hop_length: int | None = ..., win_length: int | None = ..., window: Tensor | None = ..., center: bool = ..., normalized: bool = ..., onesided: bool | None = ..., length: int | None = ..., return_complex: bool = ...) -> Any:
    ...
    @property
    def __cuda_array_interface__(self) -> Any | dict[str, str | tuple[int, ...] | int | None]:
    ...
    @classmethod
    def __torch_function__(cls, func, types, args=..., kwargs=...) -> NotImplementedType | list[Any] | tuple[Any, ...] | Tensor:
        """
    ...
    __torch_dispatch__ = ...
    def __dlpack__(self, *, stream: Any | None = ..., max_version: tuple[int, int] | None = ..., dl_device: tuple[enum.IntEnum, int] | None = ..., copy: bool | None = ...) -> Any:
        """
