...
class OutDtypeOperator(HigherOrderOperator):
    ...
    def __call__(self, op, output_dtype, *args) -> Any:
        ...
...
def out_dtype_dense(op: torch._ops.OpOverload, output_dtype: torch.dtype, *args) -> Tensor:
    ...
...
def out_dtype_proxy(mode: ProxyTorchDispatchMode, op: torch._ops.OpOverload, output_dtype: torch.dtype, *args) -> object:
    ...

@out_dtype.py_impl(FakeTensorMode)
def out_dtype_fake_tensor_mode(mode: FakeTensorMode, op: torch._ops.OpOverload, output_dtype: torch.dtype, *args) -> Tensor:
    ...
