...
class FlexAttentionHOP(HigherOrderOperator):
    ...
    def __call__(self, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
...
class FlexAttentionBackwardHOP(HigherOrderOperator):
    ...
    def __call__(self, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, out: torch.Tensor, logsumexp: torch.Tensor, grad_out: torch.Tensor | None, grad_logsumexp: torch.Tensor | None, fw_graph: Union[Callable, GraphModule], joint_graph: GraphModule, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, tuple[Optional[torch.Tensor], ...]]:
        ...
    


flex_attention_backward = ...
def math_attention(query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def flex_attention_autocast_cuda(query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...

@flex_attention.py_impl(DispatchKey.AutocastCPU)
def flex_attention_autocast_cpu(query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...

@flex_attention.py_impl(DispatchKey.CompositeExplicitAutograd)
def sdpa_dense(query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...

def trace_flex_attention(proxy_mode: ProxyTorchDispatchMode, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def flex_attention_proxy_torch_dispatch_mode(mode: ProxyTorchDispatchMode, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...
...
def flex_attention_fake_impl(query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple = ..., mask_mod_other_buffers: tuple = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...
...
class FlexAttentionAutogradOp(torch.autograd.Function):
    @staticmethod
    def forward(ctx: Any, query: Tensor, key: Tensor, value: Tensor, fw_graph: Callable, joint_graph: Callable, block_mask: tuple[Any, ...], scale: float, kernel_options: dict[str, Any], mask_mod_other_buffers: tuple[Any, ...], *score_mod_other_buffers: tuple[Any, ...]) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
    
    @staticmethod
    def backward(ctx: Any, grad_out: Tensor, grad_logsumexp: Tensor, grad_max_scores: Tensor) -> tuple[Optional[Tensor], ...]:
        ...
    


@flex_attention.py_impl(DispatchKey.Autograd)
def flex_attention_autograd(query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, score_mod: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple[Tensor, ...] = ..., mask_mod_other_buffers: tuple[Tensor, ...] = ...) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...

@flex_attention_backward.py_impl(DispatchKey.CompositeExplicitAutograd)
def sdpa_dense_backward(query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, out: torch.Tensor, logsumexp: torch.Tensor, grad_out: torch.Tensor | None, grad_logsumexp: torch.Tensor | None, fw_graph: Callable, joint_graph: Callable, block_mask: tuple, scale: float, kernel_options: dict[str, Any], score_mod_other_buffers: tuple, mask_mod_other_buffers: tuple) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, tuple[Optional[torch.Tensor], ...]]:
    ...
