...
class HopArgumentInfoGen:
    @staticmethod
    def from_example(example_value: Any, *, name: str = ..., default_value: Optional[Any] = ..., is_mutated: bool = ..., kw_only: bool = ...) -> HopArgumentInfo:
        ...
...
class HopSchemaGenerator:
    ...
    def add_arg(self, name: str, example_value: Any, default_value: Optional[Any] = ..., is_mutated: bool = ..., kw_only: bool = ...) -> None:
        ...
...
class CFunctionSchemaGen:
    ...
    """
    @staticmethod
    def from_hop_argument_info(op_name: str, inp_argument_info: list[HopArgumentInfo], out_argument_info: HopArgumentInfo, schema_tree_spec: Optional[pytree.TreeSpec]) -> Any:
        ...
    


class HopSchema(torch._C.FunctionSchema):
    def __init__(self, name: str, overload_name: str, arguments: list[torch._C.Argument], returns: list[torch._C.Argument], is_vararg: bool, is_varret: bool, schema_tree_spec: Optional[pytree.TreeSpec]) -> None:
        ...
