...
_op_identifier = Union[str, "torch._ops.OpOverload", "torch._library.custom_ops.CustomOpDef", "torch._ops.HigherOrderOperator",]
...
with_effects = ...
def has_aliasing(op: OpType) -> bool:
    ...
...
def with_effects_functional(ctx, token: torch.Tensor, op: torch._ops.OpOverload, *args: tuple[Any, ...], **kwargs: dict[str, Any]) -> tuple[torch.Tensor, ...]:
    ...

_EFFECTFUL_HOPS_WITH_SCHEMA = ...
