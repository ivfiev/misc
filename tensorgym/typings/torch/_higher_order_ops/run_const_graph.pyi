...
def run_const_graph_dispatch_mode(mode: ProxyTorchDispatchMode, graph: torch.fx.GraphModule, args: tuple[object, ...]) -> object:
    ...

@run_const_graph.py_functionalize_impl
def run_const_graph_functional(ctx: BaseFunctionalizeAPI, graph: torch.fx.GraphModule, args: tuple[Any, ...]) -> Any:
    ...

@run_const_graph.py_impl(FakeTensorMode)
def run_const_graph_fake_tensor_mode(mode: FakeTensorMode, graph: torch.fx.GraphModule, args: tuple[object, ...]) -> object:
    ...
