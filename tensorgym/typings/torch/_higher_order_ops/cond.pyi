...
class CondOp(HigherOrderOperator):
    ...
    def __call__(self, pred, true_fn, false_fn, operands) -> Any:
        ...
...
class CondAutogradOp(torch.autograd.Function):
    @staticmethod
    def forward(ctx, pred, true_fn, false_fn, *operands) -> Any:
        ...
...
def cond_autograd(pred, true_fn, false_fn, operands) -> Any:
    ...
