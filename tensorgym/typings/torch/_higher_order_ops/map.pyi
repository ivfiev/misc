...
map_impl = ...
def map(f: Callable[[pytree.PyTree, tuple[pytree.PyTree, ...]], pytree.PyTree], xs: Union[pytree.PyTree, torch.Tensor], *args: TypeVarTuple):
    r"""
...
def trace_map(proxy_mode, func_overload, f, xs, pos_args) -> Any:
    ...
...
def map_autograd(f, xs, pos_args) -> Any:
    ...

@map_impl.py_impl(ProxyTorchDispatchMode)
def map_proxy_torch_dispatch_mode(mode, f, xs, args) -> Any:
    ...
