...
class WhileLoopOp(HigherOrderOperator):
    ...
    def __call__(self, cond_fn: Callable, body_fn: Callable, carried_inputs: tuple[Union[torch.Tensor, int, float, bool]], additional_inputs: tuple[Union[torch.Tensor, torch.SymInt, int], ...], /) -> Any:
        ...
...
while_loop_op = ...
def while_loop(cond_fn, body_fn, carried_inputs) -> Any:
    r"""
...
def while_loop_dense(cond_fn, body_fn, carried_inputs, additional_inputs, stack_output=...) -> tuple[Tensor | Any, ...] | tuple[Tensor, ...] | tuple[Any, ...]:
    ...

@while_loop_op.py_autograd_impl
def while_loop_autograd(cond_fn, body_fn, operands, additional_inputs) -> Any:
    ...
...
def while_loop_fake_tensor_mode(mode, cond_fn, body_fn, carried_inputs, additional_inputs, stack_output=...) -> PyTree:
    ...
...
class WhileLoopAutogradOp(torch.autograd.Function):
    @staticmethod
    def forward(ctx, cond_fn, body_fn, num_carried_inputs, num_additional_inputs, *carries_and_inputs) -> tuple[Any, ...]:
        ...
