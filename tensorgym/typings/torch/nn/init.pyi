...
_R = TypeVar("_R")
_P = ParamSpec("_P")
_NonlinearityType = Literal["linear", "conv1d", "conv2d", "conv3d", "conv_transpose1d", "conv_transpose2d", "conv_transpose3d", "sigmoid", "tanh", "relu", "leaky_relu", "selu",]
_FanMode = Literal["fan_in", "fan_out"]
def calculate_gain(nonlinearity: _NonlinearityType, param: int | float | None = ...) -> float:
...
def trunc_normal_(tensor: Tensor, mean: float = ..., std: float = ..., a: float = ..., b: float = ..., generator: torch.Generator | None = ...) -> Tensor:
...
def kaiming_uniform_(tensor: Tensor, a: float = ..., mode: _FanMode = ..., nonlinearity: _NonlinearityType = ..., generator: torch.Generator | None = ...) -> Tensor:
...
def kaiming_normal_(tensor: Tensor, a: float = ..., mode: _FanMode = ..., nonlinearity: _NonlinearityType = ..., generator: torch.Generator | None = ...) -> Tensor:
