...
def orthogonal(module: Module, name: str = ..., orthogonal_map: str | None = ..., *, use_trivialization: bool = ...) -> Module:
...
def spectral_norm(module: Module, name: str = ..., n_power_iterations: int = ..., eps: float = ..., dim: int | None = ...) -> Module:
