...
__all__: list[str] = ...
_tensor_or_tensors: TypeAlias = torch.Tensor | typing.Iterable[torch.Tensor]
_P = ParamSpec("_P")
_R = TypeVar("_R")
@_no_grad
def clip_grad_norm_(parameters: _tensor_or_tensors, max_norm: float, norm_type: float = ..., error_if_nonfinite: bool = ..., foreach: bool | None = ...) -> torch.Tensor:
...
def clip_grad_norm(parameters: _tensor_or_tensors, max_norm: float, norm_type: float = ..., error_if_nonfinite: bool = ..., foreach: bool | None = ...) -> torch.Tensor:
    r"""Clip the gradient norm of an iterable of parameters.
