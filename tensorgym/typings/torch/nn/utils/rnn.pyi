...
class PackedSequence(PackedSequence_):
    ...
    """
    def __new__(cls, data: Tensor, batch_sizes: Tensor | None = ..., sorted_indices: Tensor | None = ..., unsorted_indices: Tensor | None = ...) -> Self:
        ...
...
def pad_sequence(sequences: Tensor | list[Tensor], batch_first: bool = ..., padding_value: float = ..., padding_side: str = ...) -> Tensor:
