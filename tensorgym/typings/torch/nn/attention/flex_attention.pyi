...
__all__ = ["BlockMask", "flex_attention", "AuxOutput", "AuxRequest", "FlexKernelOptions", "create_block_mask", "create_mask", "or_masks", "and_masks", "noop_mask"]
...
class BlockMask:
    ...
    **Details**
    ...
    @classmethod
    def from_kv_blocks(cls, kv_num_blocks: Tensor, kv_indices: Tensor, full_kv_num_blocks: Tensor | None = ..., full_kv_indices: Tensor | None = ..., BLOCK_SIZE: int | tuple[int, int] = ..., mask_mod: _mask_mod_signature | None = ..., seq_lengths: tuple[int, int] | None = ..., compute_q_blocks: bool = ...) -> Self:
        """
...
def create_mask(mod_fn: _score_mod_signature | _mask_mod_signature, B: int | None, H: int | None, Q_LEN: int, KV_LEN: int, device: DeviceLikeType | None = ...) -> Tensor:
...
def create_block_mask(mask_mod: _mask_mod_signature, B: int | None, H: int | None, Q_LEN: int, KV_LEN: int, device: DeviceLikeType | None = ..., BLOCK_SIZE: int | tuple[int, int] = ..., _compile=...) -> BlockMask:
...
def flex_attention(query: Tensor, key: Tensor, value: Tensor, score_mod: _score_mod_signature | None = ..., block_mask: BlockMask | None = ..., scale: float | None = ..., enable_gqa: bool = ..., return_lse: bool = ..., kernel_options: FlexKernelOptions | None = ..., *, return_aux: AuxRequest | None = ...) -> Tensor | tuple[Tensor, Tensor] | tuple[Tensor, AuxOutput]:
