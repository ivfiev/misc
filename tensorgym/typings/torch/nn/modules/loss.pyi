...
class NLLLoss(_WeightedLoss):
    ...
    __constants__ = ...
    ignore_index: int
    def __init__(self, weight: Tensor | None = ..., size_average=..., ignore_index: int = ..., reduce=..., reduction: str = ...) -> None:
        ...
...
@deprecated("`NLLLoss2d` has been deprecated. " "Please use `NLLLoss` instead as a drop-in replacement and see " "https://pytorch.org/docs/main/nn.html#torch.nn.NLLLoss for more details.", category=FutureWarning)
...
class BCEWithLogitsLoss(_Loss):
    ...
    Examples:
        ...
        >>> output.backward()
    """
    def __init__(self, weight: Tensor | None = ..., size_average=..., reduce=..., reduction: str = ..., pos_weight: Tensor | None = ...) -> None:
        ...
...
class CrossEntropyLoss(_WeightedLoss):
    ...
    def __init__(self, weight: Tensor | None = ..., size_average=..., ignore_index: int = ..., reduce=..., reduction: str = ..., label_smoothing: float = ...) -> None:
        ...
...
class MultiMarginLoss(_WeightedLoss):
    ...
    margin: float
    p: int
    def __init__(self, p: int = ..., margin: float = ..., weight: Tensor | None = ..., size_average=..., reduce=..., reduction: str = ...) -> None:
        ...
...
class TripletMarginWithDistanceLoss(_Loss):
    ...
    margin: float
    swap: bool
    def __init__(self, *, distance_function: Callable[[Tensor, Tensor], Tensor] | None = ..., margin: float = ..., swap: bool = ..., reduction: str = ...) -> None:
        ...
