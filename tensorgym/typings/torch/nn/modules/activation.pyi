...
class Hardtanh(Module):
    ...
    max_val: float
    inplace: bool
    def __init__(self, min_val: float = ..., max_val: float = ..., inplace: bool = ..., min_value: float | None = ..., max_value: float | None = ...) -> None:
        ...
...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=..., bias=..., add_bias_kv=..., add_zero_attn=..., kdim=..., vdim=..., batch_first=..., device=..., dtype=...) -> None:
        ...
    
    def __setstate__(self, state) -> None:
        ...
    
    def forward(self, query: Tensor, key: Tensor, value: Tensor, key_padding_mask: Tensor | None = ..., need_weights: bool = ..., attn_mask: Tensor | None = ..., average_attn_weights: bool = ..., is_causal: bool = ...) -> tuple[Tensor, Tensor | None]:
