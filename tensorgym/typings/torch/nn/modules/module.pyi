...
def register_module_forward_hook(hook: Callable[..., None], *, with_kwargs: bool = ..., always_call: bool = ...) -> RemovableHandle:
...
def register_module_backward_hook(hook: Callable[[Module, _grad_t, _grad_t], _grad_t | None]) -> RemovableHandle:
...
def register_module_full_backward_pre_hook(hook: Callable[[Module, _grad_t], _grad_t | None]) -> RemovableHandle:
...
def register_module_full_backward_hook(hook: Callable[[Module, _grad_t, _grad_t], _grad_t | None]) -> RemovableHandle:
    r"""Register a backward hook common to all the modules.
...
class Module:
    ...
    def register_full_backward_pre_hook(self, hook: Callable[[Module, _grad_t], _grad_t | None], prepend: bool = ...) -> RemovableHandle:
    ...
    def register_backward_hook(self, hook: Callable[[Module, _grad_t, _grad_t], _grad_t | None]) -> RemovableHandle:
    ...
    def register_full_backward_hook(self, hook: Callable[[Module, _grad_t, _grad_t], _grad_t | None], prepend: bool = ...) -> RemovableHandle:
        r"""Register a backward hook on the module.
    ...
    def register_forward_pre_hook(self, hook: Callable[[T, tuple[Any, ...]], Any | None] | Callable[[T, tuple[Any, ...], dict[str, Any]], tuple[Any, dict[str, Any]] | None], *, prepend: bool = ..., with_kwargs: bool = ...) -> RemovableHandle:
    ...
    def register_forward_hook(self, hook: Callable[[T, tuple[Any, ...], Any], Any | None] | Callable[[T, tuple[Any, ...], dict[str, Any], Any], Any | None], *, prepend: bool = ..., with_kwargs: bool = ..., always_call: bool = ...) -> RemovableHandle:
    ...
    def load_state_dict(self, state_dict: Mapping[str, Any], strict: bool = ..., assign: bool = ...) -> _IncompatibleKeys:
    ...
    def modules(self, remove_duplicate: bool = ...) -> Iterator[Module]:
    ...
    def named_modules(self, memo: set[Module] | None = ..., prefix: str = ..., remove_duplicate: bool = ...) -> Generator[tuple[str, Self] | Any, Any, None]:
