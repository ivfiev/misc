...
class DataParallel(Module, Generic[T]):
    ...
    **scattered** on dim specified (default 0). tuple, list and dict types will
    ...
    """
    def __init__(self, module: T, device_ids: Sequence[int | torch.device] | None = ..., output_device: int | torch.device | None = ..., dim: int = ...) -> None:
        ...
...
def data_parallel(module: Module, inputs: Any, device_ids: Sequence[int | torch.device] | None = ..., output_device: int | torch.device | None = ..., dim: int = ..., module_kwargs: Any | None = ...) -> torch.Tensor:
