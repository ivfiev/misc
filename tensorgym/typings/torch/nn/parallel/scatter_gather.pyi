...
def scatter(inputs, target_gpus, dim=...) -> Any | list[Any] | list[tuple[Any, ...]] | list[list[Any]] | list[dict[Any, Any]] | list[Any | tuple[()] | list[Any] | dict[Any, Any]]:
...
def scatter_kwargs(inputs: tuple[Any, ...], kwargs: dict[str, Any] | None, target_gpus: Sequence[int | torch.device], dim: int = ...) -> tuple[tuple[Any, ...], tuple[dict[str, Any], ...]]:
