...
def parallel_apply(modules: Sequence[Module], inputs: Sequence[Any], kwargs_tup: Sequence[dict[str, Any]] | None = ..., devices: Sequence[int | torch.device | None] | None = ...) -> list[Any]:
