...
def gaussian_nll_loss(input: Tensor, target: Tensor, var: Tensor | float, full: bool | None = ..., eps: float | None = ..., reduction: str | None = ...) -> Tensor:
    ...
...
def interpolate(input: Tensor, size: int | Sequence[int] | None = ..., scale_factor: float | Sequence[float] | None = ..., mode: str = ..., align_corners: bool | None = ..., recompute_scale_factor: bool | None = ..., antialias: bool = ...) -> Tensor:
    ...
...
__all__ += ["log_softmax"]
def lp_pool1d(input: Tensor, norm_type: float, kernel_size: _size_1_t, stride: _size | None | int = ..., ceil_mode: bool = ...) -> Tensor:
    ...

__all__ += ["lp_pool1d"]
def lp_pool2d(input: Tensor, norm_type: float, kernel_size: _size_2_t, stride: _size | None | int = ..., ceil_mode: bool = ...) -> Tensor:
    ...

__all__ += ["lp_pool2d"]
def lp_pool3d(input: Tensor, norm_type: float, kernel_size: _size_3_t, stride: _size | None | int = ..., ceil_mode: bool = ...) -> Tensor:
    ...
...
__all__ += ["mse_loss"]
def multi_head_attention_forward(query: Tensor, key: Tensor, value: Tensor, embed_dim_to_check: int, num_heads: int, in_proj_weight: Tensor | None, in_proj_bias: Tensor | None, bias_k: Tensor | None, bias_v: Tensor | None, add_zero_attn: bool, dropout_p: float, out_proj_weight: Tensor, out_proj_bias: Tensor | None, training: bool = ..., key_padding_mask: Tensor | None = ..., need_weights: bool = ..., attn_mask: Tensor | None = ..., use_separate_proj_weight: bool = ..., q_proj_weight: Tensor | None = ..., k_proj_weight: Tensor | None = ..., v_proj_weight: Tensor | None = ..., static_k: Tensor | None = ..., static_v: Tensor | None = ..., average_attn_weights: bool = ..., is_causal: bool = ...) -> tuple[Tensor, Tensor | None]:
    ...
...
__all__ += ["relu6"]
def rms_norm(input: Tensor, normalized_shape: Sequence[int], weight: Tensor | None = ..., eps: float | None = ...) -> Tensor:
    ...
...
__all__ += ["unfold"]
def upsample_bilinear(input: Any, size: Any | None = ..., scale_factor: Any | None = ...) -> Tensor:
    ...

__all__ += ["upsample_bilinear"]
def upsample_nearest(input: Any, size: Any | None = ..., scale_factor: Any | None = ...) -> Tensor:
    ...

__all__ += ["upsample_nearest"]
def upsample(input: Any, size: Any | None = ..., scale_factor: Any | None = ..., mode: str = ..., align_corners: Any | None = ...) -> Tensor:
    ...
...
@overload
def adaptive_max_pool1d(input: Tensor, output_size: _int | _size, return_indices: Literal[True], /) -> tuple[Tensor, Tensor]:
    ...
...
@overload
def adaptive_max_pool2d(input: Tensor, output_size: _int | _size, return_indices: Literal[True], /) -> tuple[Tensor, Tensor]:
    ...
...
@overload
def adaptive_max_pool3d(input: Tensor, output_size: _int | _size, return_indices: Literal[True], /) -> tuple[Tensor, Tensor]:
    ...
...
@overload
def fractional_max_pool2d(input: Tensor, kernel_size: _int | _size, output_size: _int | _size | None = ..., output_ratio: _ratio_any_t | None = ..., return_indices: Literal[False] = ..., _random_samples: Tensor | None = ...) -> Tensor:
    ...

@overload
def fractional_max_pool2d(input: Tensor, kernel_size: _int | _size, output_size: _int | _size | None, output_ratio: _ratio_any_t | None, return_indices: Literal[True], /, _random_samples: Tensor | None = ...) -> tuple[Tensor, Tensor]:
    ...
...
@overload
def fractional_max_pool3d(input: Tensor, kernel_size: _int | _size, output_size: _int | _size | None = ..., output_ratio: _ratio_any_t | None = ..., return_indices: Literal[False] = ..., _random_samples: Tensor | None = ...) -> Tensor:
    ...

@overload
def fractional_max_pool3d(input: Tensor, kernel_size: _int | _size, output_size: _int | _size | None, output_ratio: _ratio_any_t | None, return_indices: Literal[True], /, _random_samples: Tensor | None = ...) -> tuple[Tensor, Tensor]:
    ...
...
@overload
def max_pool1d(input: Tensor, kernel_size: _int | _size, stride: _int | _size | None = ..., padding: _int | _size = ..., dilation: _int | _size = ..., ceil_mode: bool = ..., return_indices: Literal[False] = ...) -> Tensor:
    ...

@overload
def max_pool1d(input: Tensor, kernel_size: _int | _size, stride: _int | _size | None, padding: _int | _size, dilation: _int | _size, ceil_mode: bool, return_indices: Literal[True], /) -> tuple[Tensor, Tensor]:
    ...
...
@overload
def max_pool2d(input: Tensor, kernel_size: _int | _size, stride: _int | _size | None = ..., padding: _int | _size = ..., dilation: _int | _size = ..., ceil_mode: bool = ..., return_indices: Literal[False] = ...) -> Tensor:
    ...

@overload
def max_pool2d(input: Tensor, kernel_size: _int | _size, stride: _int | _size | None, padding: _int | _size, dilation: _int | _size, ceil_mode: bool, return_indices: Literal[True], /) -> tuple[Tensor, Tensor]:
    ...
...
@overload
def max_pool3d(input: Tensor, kernel_size: _int | _size, stride: _int | _size | None = ..., padding: _int | _size = ..., dilation: _int | _size = ..., ceil_mode: bool = ..., return_indices: Literal[False] = ...) -> Tensor:
    ...

@overload
def max_pool3d(input: Tensor, kernel_size: _int | _size, stride: _int | _size | None, padding: _int | _size, dilation: _int | _size, ceil_mode: bool, return_indices: Literal[True], /) -> tuple[Tensor, Tensor]:
    ...
...
__all__ += ["adaptive_avg_pool1d", "avg_pool1d", "bilinear", "celu_", "channel_shuffle", "conv_tbc", "conv_transpose1d", "conv_transpose2d", "conv_transpose3d", "conv1d", "conv2d", "conv3d", "cosine_similarity", "hardshrink", "native_channel_shuffle", "pairwise_distance", "pdist", "pixel_shuffle", "pixel_unshuffle", "prelu", "relu_", "rrelu_", "selu_", "avg_pool2d", "avg_pool3d", "elu_", "gelu", "hardtanh_", "leaky_relu_", "linear", "logsigmoid", "one_hot", "pad", "scaled_dot_product_attention", "softplus", "softshrink", "max_pool1d", "adaptive_max_pool1d", "max_pool2d", "fractional_max_pool2d", "adaptive_max_pool2d", "max_pool3d", "fractional_max_pool3d", "adaptive_max_pool3d"]
