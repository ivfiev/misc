...
class _KinetoProfile:
    ...
    .. note::
        ...
        extra tensor copies.
    """
    def __init__(self, *, activities: Iterable[ProfilerActivity] | None = ..., record_shapes: bool = ..., profile_memory: bool = ..., with_stack: bool = ..., with_flops: bool = ..., with_modules: bool = ..., experimental_config: _ExperimentalConfig | None = ..., execution_trace_observer: _ITraceObserver | None = ..., acc_events: bool = ..., custom_trace_id_callback: Callable[[], str] | None = ..., post_processing_timeout_s: float | None = ...) -> None:
        ...
    ...
    def key_averages(self, group_by_input_shape: bool = ..., group_by_stack_n: int = ..., group_by_overload_name: bool = ...) -> EventList:
    ...
    @deprecated("`export_memory_timeline` is deprecated and will be removed in a future version. " "Please use `torch.cuda.memory._record_memory_history` and `torch.cuda.memory._export_memory_snapshot` instead.", category=FutureWarning)
...
def schedule(*, wait: int, warmup: int, active: int, repeat: int = ..., skip_first: int = ..., skip_first_wait: int = ...) -> Callable:
    """
...
def tensorboard_trace_handler(dir_name: str, worker_name: str | None = ..., use_gzip: bool = ...) -> Callable[..., None]:
    """
...
class profile(_KinetoProfile):
    ...
    """
    def __init__(self, *, activities: Iterable[ProfilerActivity] | None = ..., schedule: Callable[[int], ProfilerAction] | None = ..., on_trace_ready: Callable[..., Any] | None = ..., record_shapes: bool = ..., profile_memory: bool = ..., with_stack: bool = ..., with_flops: bool = ..., with_modules: bool = ..., experimental_config: _ExperimentalConfig | None = ..., execution_trace_observer: _ITraceObserver | None = ..., acc_events: bool = ..., use_cuda: bool | None = ..., custom_trace_id_callback: Callable[[], str] | None = ..., post_processing_timeout_s: float | None = ...) -> None:
        ...
