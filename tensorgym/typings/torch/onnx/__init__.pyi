...
from ._internal.torchscript_exporter import symbolic_helper, symbolic_opset10, symbolic_opset9, utils
from ._internal.torchscript_exporter._type_utils import JitScalarType
from ._internal.torchscript_exporter.utils import register_custom_op_symbolic, select_model_mode_for_export, unregister_custom_op_symbolic
from .errors import OnnxExporterError
from collections.abc import Callable, Collection, Mapping, Sequence

__all__ = ["errors", "ops", "export", "is_in_onnx_export", "OnnxExporterError", "ONNXProgram", "ExportableModule", "InputObserver"]
if TYPE_CHECKING:
    ...
producer_name = ...
producer_version = ...
def export(model: torch.nn.Module | torch.export.ExportedProgram | torch.jit.ScriptModule | torch.jit.ScriptFunction, args: tuple[Any, ...] = ..., f: str | os.PathLike | None = ..., *, kwargs: dict[str, Any] | None = ..., verbose: bool | None = ..., input_names: Sequence[str] | None = ..., output_names: Sequence[str] | None = ..., opset_version: int | None = ..., dynamo: bool = ..., external_data: bool = ..., dynamic_shapes: dict[str, Any] | tuple[Any, ...] | list[Any] | None = ..., custom_translation_table: dict[Callable, Callable] | None = ..., report: bool = ..., optimize: bool = ..., verify: bool = ..., profile: bool = ..., dump_exported_program: bool = ..., artifacts_dir: str | os.PathLike = ..., export_params: bool = ..., keep_initializers_as_inputs: bool = ..., dynamic_axes: Mapping[str, Mapping[int, str]] | Mapping[str, Sequence[int]] | None = ..., training: _C_onnx.TrainingMode = ..., operator_export_type: _C_onnx.OperatorExportTypes = ..., do_constant_folding: bool = ..., custom_opsets: Mapping[str, int] | None = ..., export_modules_as_functions: bool | Collection[type[torch.nn.Module]] = ..., autograd_inlining: bool = ...) -> ONNXProgram | None:
