...
from torch.onnx._internal._lazy_import import onnx, onnx_ir as ir
...
class ONNXProgram:
    ...
    def compute_values(self, value_names: Sequence[str], args=..., kwargs=...) -> Sequence[torch.Tensor]:
    ...
    def save(self, destination: str | os.PathLike, *, include_initializers: bool = ..., keep_initializers_as_inputs: bool = ..., external_data: bool | None = ...) -> None:
