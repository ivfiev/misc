...
class OverrideDict(Collection[_K], Generic[_K, _V]):
    ...
    def get(self, key: _K, default: Optional[_V] = ...) -> _V | None:
        ...
...
class SymbolicRegistry:
    ...
    def register(self, name: str, opset: OpsetVersion, func: Callable, custom: bool = ...) -> None:
...
def onnx_symbolic(name: str, opset: Union[OpsetVersion, Sequence[OpsetVersion]], decorate: Optional[Sequence[Callable]] = ..., custom: bool = ...) -> Callable:
    """Registers a symbolic function.
...
def custom_onnx_symbolic(name: str, opset: Union[OpsetVersion, Sequence[OpsetVersion]], decorate: Optional[Sequence[Callable]] = ...) -> Callable:
