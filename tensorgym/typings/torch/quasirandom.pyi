...
class SobolEngine:
    ...
    def draw(self, n: int = ..., out: torch.Tensor | None = ..., dtype: torch.dtype | None = ...) -> torch.Tensor:
        r"""
    ...
    def draw_base2(self, m: int, out: torch.Tensor | None = ..., dtype: torch.dtype | None = ...) -> torch.Tensor:
        r"""
