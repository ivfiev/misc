...
class Reducer:
    def __init__(self, params: list[Tensor], bucket_indices: list[list[int]], per_bucket_size_limits: list[int], process_group: ProcessGroup, expect_sparse_gradients: list[bool] = ..., bucket_bytes_cap: int = ..., find_unused_parameters: bool = ..., gradient_as_bucket_view: bool = ..., param_to_name_mapping: dict[int, str] = ..., first_bucket_types_cap: int = ..., skip_all_reduce_unused_params: bool = ..., use_python_reducer: bool = ..., bucket_bytes_cap_list: list[int] = ...) -> None:
        ...
...
class Logger:
    ...
    def set_construction_data_and_log(self, module_name: str, device_ids: list[int], output_device: int, broadcast_buffers: bool, has_sync_bn: bool, static_graph: bool) -> None:
        ...
...
class TCPStore(Store):
    def __init__(self, host_name: str, port: int, world_size: int | None = ..., is_master: bool = ..., timeout: timedelta = ..., wait_for_workers: bool = ..., multi_tenant: bool = ..., master_listen_fd: int | None = ..., use_libuv: bool | None = ...) -> None:
        ...
...
class ProcessGroup:
    ...
    def split_group(self, new_ranks: list[int], timeout: Optional[timedelta] = ..., opts: Optional[Backend.Options] = ..., group_name: GroupName | None = ..., group_desc: Optional[str] = ...) -> Optional[ProcessGroup]:
        ...
    
    def merge_remote_group(self, store: Store, size: int, timeout: timedelta, group_name: GroupName | None = ..., group_desc: Optional[str] = ...) -> ProcessGroup:
        ...
    ...
    def reduce_scatter_tensor_coalesced(self, outputTensors: list[Tensor], inputTensors: list[Tensor], opts: ReduceScatterOptions | None = ...) -> Work:
        ...
    ...
    @overload
    def gather(self, output_tensors: list[Tensor], input_tensor: Tensor, root: int, timeout: timedelta | None = ...) -> Work:
        ...
    ...
    @overload
    def scatter(self, output_tensor: Tensor, input_tensors: list[Tensor], root: int, timeout: timedelta | None = ...) -> Work:
        ...
    ...
    @overload
    def reduce_scatter(self, output_tensors: Tensor, input_tensor: list[Tensor], op=..., timeout: timedelta | None = ...) -> Work:
        ...
    
    @overload
    def alltoall_base(self, output_tensor: Tensor, input_tensor: Tensor, output_split_sizes: list[int], input_split_sizes: list[int], opts=...) -> Work:
        ...
    
    @overload
    def alltoall_base(self, output: Tensor, input: Tensor, output_split_sizes: list[int], input_split_sizes: list[int], timeout: timedelta | None = ...) -> Work:
        ...
...
class _SymmetricMemory:
    ...
    @staticmethod
    def empty_strided_p2p(size: torch.types._size, stride: torch.types._size, dtype: torch.dtype, device: torch.device, group_name: str | None = ..., alloc_id: int | None = ...) -> torch.Tensor:
        ...
    ...
    def get_buffer(self, rank: int, sizes: torch.types._size, dtype: torch.dtype, storage_offset: int | None = ...) -> torch.Tensor:
        ...
    
    def get_signal_pad(self, rank: int, sizes: torch.types._size = ..., dtype: torch.dtype | None = ..., storage_offset: int | None = ...) -> torch.Tensor:
        ...
