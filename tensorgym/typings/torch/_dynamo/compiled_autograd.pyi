...
class AutogradCompilerInstance:
    ...
    def begin_capture(self, inputs: list[torch.Tensor], sizes: list[int], scalars: list[Union[int, float]], origins: list[list[tuple[int, str]]], accumulate_grad: bool, check_nans: bool) -> tuple[str, list[torch.Tensor], list[IntLikeType], list[FloatLikeType]]:
        ...
    
    def log_compile_reasons(self, compile_reasons: list[str]) -> None:
        ...
    
    def proxy_call_aot_backward(self, pinputs: Sequence[Any], psaved_tensors: Sequence[torch.Tensor], saved_tensors: Sequence[torch.Tensor], pctx: Any, ctx: Any, maybe_backward_state_idx: Optional[int], opaque_object_indices: list[int]) -> Sequence[Any]:
        ...
    
    def proxy_call_backward(self, inputs: Sequence[Any], output_metadatas: Sequence[Any], saved_tensors: Sequence[torch.Tensor], backward_idx: int, ctx: torch.autograd.function.BackwardCFunction, maybe_backward_state_idx: Optional[int], opaque_object_indices: list[int]) -> tuple[Optional[torch.Tensor], ...]:
        ...
    
    def call_copy_slices_prologue(self, inputs: Sequence[Any], base_sizes: Sequence[Any], base_strides: Sequence[Any], base_storage_offset: Any, view_sizes: Sequence[Any], view_strides: Sequence[Any], view_storage_offset: Any) -> Sequence[torch.Tensor]:
        ...
    
    def call_copy_slices_epilogue(self, needs_input_grad: Sequence[bool], result: torch.Tensor, res: Sequence[Any], grad_slice: torch.Tensor) -> Sequence[torch.Tensor]:
        ...
    ...
    def apply_functional(self, fn_name: str, grads: Sequence[Any], args: Any, output_metadata: Sequence[Any]) -> Sequence[torch.Tensor]:
    ...
    def validate_outputs(self, _: Any, outputs: Sequence[Any], args: Any, output_metadata: Sequence[Any]) -> Sequence[torch.Tensor]:
    ...
    def post_hook(self, outputs: list[torch.Tensor], inputs: Sequence[torch.Tensor], hook_id: int) -> list[torch.Tensor]:
        ...
    ...
    def bind_objects_to_proxies(self, objects: Sequence[Any], proxies: Any, origins: Optional[list[tuple[int, str]]] = ...) -> Sequence[Any]:
        ...
...
def copy_slices_prologue(inputs: Sequence[torch.Tensor], base_sizes: Sequence[IntLikeType], base_strides: Sequence[IntLikeType], base_storage_offset: IntLikeType, view_sizes: Sequence[IntLikeType], view_strides: Sequence[IntLikeType], view_storage_offset: IntLikeType) -> list[torch.Tensor]:
    ...

def copy_slices_epilogue(needs_input_grad: Sequence[bool], result: torch.Tensor, res: Sequence[Optional[torch.Tensor]], grad_slice: torch.Tensor) -> list[Optional[torch.Tensor]]:
    ...
