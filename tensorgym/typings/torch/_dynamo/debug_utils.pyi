...
def run_fwd_maybe_bwd(gm: torch.fx.GraphModule, args: Sequence[Any], only_fwd: bool = ..., disable_clone: bool = ...) -> Any:
    """
...
def same_two_models(gm: torch.fx.GraphModule, opt_gm: torch.fx.GraphModule, example_inputs: Sequence[Any], only_fwd: bool = ..., *, require_fp64: bool = ..., ignore_non_fp: bool = ...) -> bool:
    """
...
def cast_to(dtype: torch.dtype, model: torch.fx.GraphModule, inputs: list[Any]) -> tuple[torch.fx.GraphModule, list[Any]]:
    ...

def cast_to_fp64(model: torch.fx.GraphModule, inputs: list[Any]) -> tuple[torch.fx.GraphModule, list[Any]]:
    ...

def backend_accuracy_fails(gm: torch.fx.GraphModule, example_inputs: Sequence[Any], compiler_fn: Callable[[torch.fx.GraphModule, list[Any]], torch.fx.GraphModule], only_fwd: bool = ..., *, require_fp64: bool = ..., ignore_non_fp: bool = ...) -> bool:
    ...
...
class NopInputReader:
    ...
    def storage(self, storage_hash: Optional[str], nbytes: int, *, device: Optional[torch._prims_common.DeviceLikeType] = ..., dtype_hint: Optional[torch.dtype] = ...) -> None:
        ...
...
class InputReader:
    ...
    def storage(self, storage_hash: Optional[str], nbytes: int, *, device: Optional[torch._prims_common.DeviceLikeType] = ..., dtype_hint: Optional[torch.dtype] = ...) -> UntypedStorage:
        ...
    
    def tensor(self, storage: UntypedStorage, shape: torch._prims_common.ShapeType, stride: Optional[torch._prims_common.StrideType] = ..., *, storage_offset: Optional[int] = ..., dtype: Optional[torch.dtype] = ..., requires_grad: Optional[bool] = ..., is_leaf: Optional[bool] = ..., **metadata: Any) -> torch.Tensor:
        ...
...
class InputWriter:
    ...
    def storage(self, untyped_storage: UntypedStorage, *, device_hint: Optional[torch._prims_common.DeviceLikeType] = ..., dtype_hint: Optional[torch.dtype] = ...) -> str:
        ...
