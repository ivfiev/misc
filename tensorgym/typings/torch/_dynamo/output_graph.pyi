...
from .source import AttrSource, ParamBufferSource
from .variables.builder import GraphArg
from .variables.functions import VariableTracker
...
def collect_reachable_grad_fns(tensors_with_sources: list[tuple[torch.Tensor, str | None]], stop_at: set[torch.autograd.graph.Node] | None = ...) -> set[torch.autograd.graph.Node]:
...
@dataclass
class BytecodeTracingTimings:
    """Accumulated wall-clock time (ns) for major components during Dynamo
    ...
    and wire up the wrapper in the relevant function."""
    get_fake_value_ns: int = ...
    create_proxy_ns: int = ...
    wrap_to_fake_tensor_and_record_ns: int = ...
    variable_builder_call_ns: int = ...
...
class ExportMetaData:
    graph_input_idx_to_local_source: dict[int, Source | None] = ...
    output_return_type: dict[int, tuple[str, Any]] = ...
    out_spec: Union[torch.utils._pytree.TreeSpec, torch.utils._pytree.LeafSpec] = ...
    module_call_spec: dict[str, dict[str, Union[torch.utils._pytree.TreeSpec, torch.utils._pytree.LeafSpec]],] = ...
...
class OutputGraphCommon(OutputGraphGuardsState):
    ...
    """
    def __init__(self, output_graph_guards_state: OutputGraphGuardsState, import_sources: Optional[dict[str, str]] = ..., shape_env: Optional[ShapeEnv] = ..., export_metadata: Optional[ExportMetaData] = ..., tracked_fakes_id_to_source: Optional[dict[int, list[Source]]] = ...) -> None:
        ...
...
class OutputGraph(OutputGraphCommon):
    ...
    def __init__(self, code_options: dict[str, Any], compiler_fn: Optional[CompilerFn], root_tx: InstructionTranslatorBase, export: bool, export_constraints: Sequence[_ConstraintTarget], frame_state: Any, local_scope: Scope, global_scope: Scope, f_code: CodeType, torch_function_mode_stack: list[torch.overrides.TorchFunctionMode], package: Optional[CompilePackage], one_graph: bool = ...) -> None:
        ...
    
    def get_chained_attr_source(self, base: Source, path: str) -> AttrSource:
        ...
    
    def get_chained_param_buffer_source(self, base: Source, path: str) -> ParamBufferSource:
        ...
    ...
    def subtracer(self, source_target: Optional[Target], prior_tracer: Optional[SubgraphTracer], description: Optional[str] = ...) -> Generator[SubgraphTracer, None, None]:
        ...
    ...
    def register_attr_or_module(self, target: Union[torch.nn.Module, torch.Tensor, Any], *names: Any, **options: Any) -> VariableTracker:
        ...
    
    def handle_aliases_for_stolen_lists(self, tx: InstructionTranslatorBase) -> tuple[list[Instruction], dict[Source, Source]]:
        ...
    
    def compile_subgraph(self, tx: InstructionTranslatorBase, reason: GraphCompileReason, stack_pops: int = ...) -> list[StackLocalsMetadata]:
        """
    ...
    def codegen_suffix(self, tx: InstructionTranslatorBase, stack_values: list[VariableTracker], cg: PyCodegen, log_side_effects: bool) -> None:
        ...
    ...
    def compile_and_call_fx_graph(self, tx: InstructionTranslatorBase, rv: list[VariableTracker], root: FakeRootModule) -> list[Instruction]:
        """
    ...
    def add_fqn_info_for_inlined_modules(self, inlined_module: torch.nn.Module, source: Source) -> None:
        ...
...
class SubgraphTracer(fx.Tracer):
    ...
    """
    def __init__(self, output_graph: OutputGraph, parent: Optional[SubgraphTracer] = ..., is_export: bool = ..., source_target: Optional[Target] = ..., description: Optional[str] = ...) -> None:
        ...
    
    def record_tensor_or_symint_vt(self, vt: VariableTracker) -> None:
        ...
    
    def create_proxy(self, kind: str, target: Any, args: Any, kwargs: Any, name: Optional[str] = ..., type_expr: Optional[Any] = ..., proxy_factory_fn: Optional[Callable[[fx.Node], fx.Proxy]] = ...) -> fx.Proxy:
        ...
    
    def create_node(self, kind: str, target: Target, args: Any = ..., kwargs: Any = ..., name: Optional[str] = ..., type_expr: Optional[Any] = ...) -> fx.Node:
        ...
    
    def remove_node(self, node: fx.Node) -> None:
        ...
    
    def create_graph_input(self, name: str, type_expr: Any, example_value: Any, before: bool = ..., source: Optional[Source] = ...) -> fx.Proxy:
        ...
