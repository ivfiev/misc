...
class SideEffects:
    ...
    def __init__(self, output_graph: OutputGraph, id_to_variable: Optional[dict[int, VariableTracker]] = ..., store_attr_mutations: Optional[dict[VariableTracker, dict[str, VariableTracker]]] = ..., mutation_user_stacks: dict[VariableTracker, list[traceback.StackSummary]] | None = ..., keepalive: Optional[list[Any]] = ..., save_for_backward: Optional[list[tuple[AutogradFunctionContextVariable, list[VariableTracker]]]] = ..., tensor_hooks: Optional[dict[int, tuple[variables.TensorVariable, VariableTracker, variables.RemovableHandleVariable, str,],]] = ...) -> None:
        ...
    ...
    def load_attr(self, item: VariableTracker, name: str, deleted_ok: bool = ..., check: bool = ...) -> VariableTracker:
        ...
    ...
    def track_object_new(self, cls_source: Source | None, user_cls: Any, variable_cls: Any, options: dict[str, Any]) -> VariableTracker:
        ...
    
    def get_variable_cls(self, user_cls: type) -> type:
        ...
    
    def get_example_value(self, base_cls_vt: VariableTracker, cls_vt: VariableTracker, init_args: list[VariableTracker]) -> Any:
        ...
    
    def track_new_user_defined_object(self, base_cls_vt: VariableTracker, cls_vt: VariableTracker, init_args: list[VariableTracker]) -> VariableTracker:
        """
    ...
    def track_cell_existing(self, source: Optional[Source], cell: CellType, contents: VariableTracker) -> VariableTracker:
        ...
    ...
    def register_hook(self, tensor: variables.TensorVariable, hook: VariableTracker, handle: variables.RemovableHandleVariable, name: str) -> None:
        ...
    ...
    def codegen_update_mutated(self, cg: PyCodegen, log_side_effects: bool = ...) -> None:
        ...
...
def allow_side_effects_in_hop(tx: InstructionTranslatorBase) -> Generator[None, None, None]:
...
@contextlib.contextmanager
def allow_externally_visible_side_effects_in_subtracer(tx: InstructionTranslatorBase) -> Generator[None, None, None]:
    ...
