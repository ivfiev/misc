...
if sys.version_info >= (3, 12):
    ...
    ...
def create_instruction(name: str, *, arg: Optional[int] = ..., argval: Optional[Any] = ..., target: Optional[Instruction] = ...) -> Instruction:
    """
...
def add_push_null(inst_or_insts: Union[Instruction, list[Instruction]]) -> list[Instruction]:
    """
...
def add_push_null_call_function_ex(inst_or_insts: Union[Instruction, list[Instruction]]) -> list[Instruction]:
...
def create_call_function_ex(has_kwargs: bool, push_null: bool, ignore_314_kwargs_push: bool = ...) -> list[Instruction]:
    """
...
def create_binary_slice(start: Optional[int], end: Optional[int], store: bool = ...) -> list[Instruction]:
    """
...
def linetable_writer(first_lineno: int) -> tuple[list[int], Callable[[int, int], None], Callable[[int], None]]:
    """
...
def fix_vars(instructions: list[Instruction], code_options: dict[str, Any], varname_from_oparg: Optional[Callable[..., Any]] = ...) -> None:
    ...
...
def transform_code_object(code: types.CodeType, transformations: Callable[[list[Instruction], dict[str, Any]], Optional[DynamoTracerOutput]], safe: bool = ...) -> tuple[types.CodeType, Optional[DynamoTracerOutput]]:
    ...
...
def bytecode_from_template(fn: Callable[..., Any], varname_map: Optional[Mapping[Any, Any]] = ..., noreturn: bool = ..., noprefix: bool = ...) -> list[Instruction]:
