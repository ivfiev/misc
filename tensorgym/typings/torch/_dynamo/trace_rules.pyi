...
manual_torch_name_rule_map: dict[str, Union[type[TorchInGraphFunctionVariable], type[SkipFunctionVariable], type[UserFunctionVariable],],] = ...
...
def lookup_inner(obj: Any, name: Optional[str] = ..., filename: Optional[str] = ..., is_direct_call: bool = ..., reasons: Union[None, set[str]] = ...) -> Optional[type[VariableTracker]]:
    ...
