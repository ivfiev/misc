...
log = ...
inductor_config = ...
def setup_fake_process_groups(group_info: dict[str, dict[str, int]]) -> None:
    """
...
def generate_standalone_repro(gm: torch.fx.GraphModule, args: Sequence[Any], *, save_path: Optional[str] = ...) -> str:
    """
...
def generate_compiler_repro_string(gm: torch.fx.GraphModule, args: Sequence[Any], *, stable_output: bool = ..., save_dir: Optional[str] = ..., stable_hash: bool = ..., has_distributed_ops: bool = ...) -> str:
    ...

def save_graph_repro(fd: IO[Any], gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: str, *, stable_output: bool = ..., save_dir: Optional[str] = ..., command: str = ..., accuracy: Optional[Union[str, bool]] = ..., tracing_mode: Optional[str] = ..., check_str: Optional[str] = ..., stable_hash: bool = ...) -> None:
    ...

def dump_compiler_graph_state(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: str, *, accuracy: Optional[Union[str, bool]] = ...) -> None:
    ...

def dump_to_minify(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: str) -> None:
    ...

def isolate_fails(fx_g: torch.fx.GraphModule, args: Sequence[Any], compiler_name: str, env: Optional[dict[str, Any]] = ..., save_dir: Optional[str] = ..., accuracy: Optional[Union[bool, str]] = ..., tracing_mode: Optional[str] = ..., check_str: Optional[str] = ...) -> bool:
    ...

def inductor_fails(fx_g: torch.fx.GraphModule, args: Sequence[Any], check_str: Optional[str] = ...) -> bool:
    ...

def inductor_accuracy_fails(fx_g: torch.fx.GraphModule, args: Sequence[Any], check_str: Optional[str] = ..., *, require_fp64: bool = ..., ignore_non_fp: bool = ...) -> bool:
    ...
...
def run_repro(mod: nn.Module, load_args: Any, *, command: str = ..., accuracy: Union[bool, str] = ..., save_dir: Optional[str] = ..., tracing_mode: Optional[str] = ..., patch_code: Optional[str] = ..., check_str: Optional[str] = ..., **kwargs: Any) -> Any:
    ...
