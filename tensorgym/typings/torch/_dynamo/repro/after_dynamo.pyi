...
class WrapBackendDebug:
    def __init__(self, unconfigured_compiler_fn: CompilerFn, compiler_name: Optional[str]) -> None:
        ...
...
def wrap_backend_debug(unconfigured_compiler_fn: CompilerFn, compiler_name: Optional[str]) -> WrapBackendDebug:
    """
...
def generate_dynamo_fx_repro_string(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: Optional[str], check_accuracy: bool = ..., *, stable_output: bool = ..., save_dir: Optional[str] = ..., command: str = ...) -> str:
    """
    Generate a repro string for backend-agnostic minified version.
    """
    ...

def dump_backend_repro_as_file(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: Optional[str], check_accuracy: bool = ...) -> None:
    """
    Saves the repro to a repro.py file
    """
    ...

def dump_backend_state(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: Optional[str], check_accuracy: bool = ...) -> None:
    """
...
def dump_to_minify_after_dynamo(gm: torch.fx.GraphModule, args: Sequence[Any], compiler_name: Optional[str]) -> None:
    ...

@register_debug_backend
def dynamo_minifier_backend(gm: fx.GraphModule, example_inputs: Sequence[Any], compiler_name: Optional[str]) -> fx.GraphModule:
    ...

@register_debug_backend
def dynamo_accuracy_minifier_backend(gm: fx.GraphModule, example_inputs: Sequence[Any], compiler_name: Optional[str]) -> fx.GraphModule:
    ...

def backend_fails(gm: fx.GraphModule, example_inputs: Sequence[Any], compiler_fn: CompilerFn, orig_failure: Sequence[Any]) -> bool:
    """
...
def run_repro(mod: torch.nn.Module, load_args: Any, *, command: str = ..., accuracy: Union[bool, str] = ..., save_dir: Optional[str] = ..., autocast: bool = ..., backend: str = ..., **kwargs: Any) -> None:
    ...
