...
if TYPE_CHECKING:
    ...
log = ...
_vt_active_calls: ContextVar[set[tuple[int, str]] | None] = ...
...
class VariableTracker(metaclass=VariableTrackerMeta):
    ...
    @classmethod
    def visit(cls, fn: Callable[[VariableTracker], None], value: Any, cache: Optional[dict[int, Any]] = ...) -> None:
        """
    ...
    @staticmethod
    def build(tx: Any, value: Any, source: Optional[Source] = ..., realize: bool = ...) -> Any:
    ...
    def __init__(self, *, source: Optional[Source] = ..., mutation_type: Optional[MutationType] = ...) -> None:
        ...
