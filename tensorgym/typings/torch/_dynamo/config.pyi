...
verbose = ...
verify_correctness = ...
debug_backend_override: str = ...
debug_inductor_config_override: str = ...
leaf_function_validate_outputs = ...
leaf_function_check_escaped_gradients = ...
minimum_call_count = ...
dead_code_elimination = ...
replay_side_effects = ...
side_effect_replay_policy = ...
recompile_limit = ...
...
nested_graph_breaks = ...
error_on_dynamo_callback_in_fullgraph_compiled_code = ...
install_free_tensors = ...
install_free_tensors_for_export = ...
...
capture_profiler_record_function: bool = ...
log_compilation_metrics = ...
reorderable_logging_functions: set[Callable[[Any], None]] = ...
ignore_logging_functions: set[Callable[..., Any]] = ...
...
strict_precompile = ...
compiled_autograd = ...
enable_dynamo_decompositions = ...
graph_break_on_nn_param_ctor = ...
inline_torch_dispatch_torch_compile = ...
skip_fwd_side_effects_in_bwd_under_checkpoint = ...
...
pt2_compile_id_prefix: Optional[str] = ...
run_gc_after_compile = ...
constant_fold_autograd_profiler_enabled = ...
wrap_top_frame = ...
record_runtime_overhead = ...
enable_aot_compile = ...
_custom_ops_profile: Optional[Any] = ...
enable_invoke_subgraph_regional_compile: bool = ...
invalidate_compile_context_weakrefs: Optional[bool] = ...
if TYPE_CHECKING:
    ...
