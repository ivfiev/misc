...
class PyCodegen:
    ...
    """
    def __init__(self, tx: InstructionTranslatorBase, root: Optional[torch.nn.Module] = ..., graph_output_var: Optional[str] = ..., tempvars: Optional[dict[Union[VariableTracker, Source], Any]] = ..., overridden_sources: Optional[dict[Source, Source]] = ...) -> None:
        ...
    ...
    def call_reconstruct(self, value: Union[VariableTracker, Source, GraphArg]) -> None:
        ...
    ...
    def __call__(self, value: Union[VariableTracker, Source, None], allow_cache: bool = ...) -> None:
        """
    ...
    def make_function_with_closure(self, fn_name: str, code: types.CodeType) -> None:
