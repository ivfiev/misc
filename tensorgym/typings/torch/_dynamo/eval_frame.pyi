...
from torch._utils_internal import DISABLE_JUSTKNOBS
from torch.export.dynamic_shapes import Constraint
from torch.fx import GraphModule
from .backends.registry import CompilerFn
from .exc import UserErrorType
...
class _TorchDynamoContext:
    def __init__(self, callback: DynamoCallback, on_enter: Callable[[], Any] = ..., backend_ctx_ctor: Callable[[], contextlib.AbstractContextManager[Any]] = ..., patch_fn: Callable[[], Any] = ..., first_ctx: bool = ..., *, fullgraph: bool = ..., error_on_graph_break: Optional[bool] = ..., export: bool = ..., dynamic: Optional[bool] = ..., compiler_config: Optional[Any] = ..., package: Optional[CompilePackage] = ..., hooks: Optional[Hooks] = ...) -> None:
        ...
...
class OptimizeContext(_TorchDynamoContext):
    def __init__(self, callback: DynamoCallback, backend_ctx_ctor: Callable[[], contextlib.AbstractContextManager[Any]], first_ctx: bool = ..., *, fullgraph: bool = ..., error_on_graph_break: Optional[bool] = ..., export: bool = ..., dynamic: Optional[bool] = ..., compiler_config: Optional[Any] = ..., rebuild_ctx: Optional[Callable[[], Union[OptimizeContext, _NullDecorator]]] = ..., package: Optional[CompilePackage] = ..., hooks: Optional[Hooks] = ...) -> None:
        ...
...
def argument_names(f_sig: inspect.Signature, args: Union[list[Any], tuple[Any, ...]], kwargs: dict[str, Any]) -> list[str]:
    ...
...
class FlattenInputOutputSignature(torch.fx.Transformer):
    def __init__(self, m: torch.fx.GraphModule, flat_args: list[Any], matched_input_elements_positions: list[int], flat_results: Sequence[Any], matched_output_elements_positions: list[int], example_fake_inputs: list[torch.Tensor], flat_args_dynamic_dims: list[set[int]], fake_mode: Optional[fake_tensor.FakeTensorMode] = ...) -> None:
        ...
