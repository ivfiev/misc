...
_KNOWN_DYNAMIC_SOURCES: set[str] = ...
@dataclasses.dataclass(frozen=True)
class InferStride:
    """
...
def lookup_remote_cache_entry(remote_cache: RemoteCache[JsonDataTy], cache_key: str, event_name: Optional[str] = ...) -> Optional[defaultdict[CodeId, CodeState]]:
    ...
...
def put_remote_code_state(cache_key: str, extra_code_state: bool = ...) -> None:
    ...
