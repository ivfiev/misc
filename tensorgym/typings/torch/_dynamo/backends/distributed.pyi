...
class SubmodCompiler(torch.fx.interpreter.Interpreter):
    def __init__(self, module: fx.GraphModule, compiler: CompilerFn, fake_mode: torch._subclasses.fake_tensor.FakeTensorMode) -> None:
        ...
...
class DDPOptimizer:
    ...
    """
    def __init__(self, bucket_bytes_cap: int, backend_compile_fn: CompilerFn, first_bucket_cap: Optional[int] = ...) -> None:
        ...
    
    def add_param(self, bucket: Bucket, param: torch.nn.Parameter, name: str) -> None:
        ...
    
    def add_module_params_to_bucket(self, mod: torch.nn.Module, bucket: Bucket, processed_modules: set[torch.nn.Module], prefix: str) -> None:
        ...
