...
from typing import Optional, TYPE_CHECKING, TypeAlias, TypeVar, overload
...
if TYPE_CHECKING:
    ...
__all__ = ["accumulate", "chain", "chain_from_iterable", "compress", "cycle", "dropwhile", "filterfalse", "islice", "tee", "zip_longest", "pairwise"]
_T = TypeVar("_T")
_U = TypeVar("_U")
...
def accumulate(iterable: Iterable[_T], func: Optional[Callable[[_T, _T], _T]] = ..., *, initial: Optional[_T] = ...) -> Iterator[_T]:
    ...
