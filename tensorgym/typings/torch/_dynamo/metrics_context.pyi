...
OnExitType: TypeAlias = Callable[[int, int, dict[str, Any], Optional[type[BaseException]], Optional[BaseException]], None,]
class MetricsContext:
    ...
    def __exit__(self, exc_type: Optional[type[BaseException]], exc_value: Optional[BaseException], _traceback: Any) -> None:
        """
...
class RuntimeMetricsContext:
    ...
    def increment(self, metric: str, value: int, extra: Optional[dict[str, Any]] = ...) -> None:
        """
        Increment a metric by a given amount.
        """
        ...
