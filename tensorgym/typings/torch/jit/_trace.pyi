...
class ONNXTracedModule(torch.nn.Module):
    ...
    def forward(self, *args: torch.Tensor) -> tuple[Graph, Any, Any] | tuple[Graph, Any]:
        ...
...
def trace(func, example_inputs=..., optimize=..., check_trace=..., check_inputs=..., check_tolerance=..., strict=..., _force_outplace=..., _module_class=..., _compilation_unit=..., example_kwarg_inputs=..., _store_inputs=...) -> ScriptModule | TopLevelTracedModule | tuple[Graph, Stack]:
    r"""
...
def trace_module(mod, inputs, optimize=..., check_trace=..., check_inputs=..., check_tolerance=..., strict=..., _force_outplace=..., _module_class=..., _compilation_unit=..., example_inputs_is_kwarg=..., _store_inputs=...) -> ScriptModule | TopLevelTracedModule:
    """
