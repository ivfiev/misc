...
class RecursiveScriptClass:
    ...
    def forward_magic_method(self, method_name: str, *args: Any, **kwargs: Any) -> Any:
        ...
...
class ScriptModule(Module, metaclass=ScriptMeta):
    ...
    def __reduce_package__(self, exporter: PackageExporter) -> tuple[Any, tuple[Any, ...]]:
        ...
