...
def get_module_concrete_type(nn_module, share_types=...) -> Any | ConcreteModuleType:
    """
...
def create_script_class(obj) -> RecursiveScriptClass:
    """
...
def try_compile_fn(fn, loc) -> ScriptFunction | None:
    ...

def wrap_cpp_class(cpp_class) -> RecursiveScriptClass:
