...
from typing import Any, ClassVar, Generic, NewType, Optional, Protocol, TYPE_CHECKING, TypeGuard, TypeVar, Union
...
def safe_is_leaf(t: Union[MetaTensorDesc[Any], torch.Tensor]) -> bool:
    ...
...
def assert_metadata_eq(assert_eq: Callable[[object, object], None], m1: Union[MetaTensorDesc[Any], torch.Tensor], m2: torch.Tensor, *, skip_symbolic: bool = ..., skip_leaf: bool = ...) -> None:
    ...
...
class MetaTensorDescriber:
    ...
    def describe_tensor(self, t: torch.Tensor, *, recurse: bool = ..., trace: bool = ...) -> MetaTensorDesc[Any]:
        ...
...
class MetaTensorDesc(Generic[_TensorT]):
    ...
    crow_indices: Optional[MetaTensorDesc[Any]] = ...
    col_indices: Optional[MetaTensorDesc[Any]] = ...
    ccol_indices: Optional[MetaTensorDesc[Any]] = ...
    row_indices: Optional[MetaTensorDesc[Any]] = ...
    values: Optional[MetaTensorDesc[Any]] = ...
    unwrapped: Optional[MetaTensorDesc[Any]] = ...
    bdim: Optional[int] = ...
    base: Optional[MetaTensorDesc[Any]] = ...
    attrs: Optional[dict[str, MetaTensorDesc[Any]]] = ...
    creation_meta: Optional[CreationMeta] = ...
    grad: Optional[MetaTensorDesc[Any]] = ...
    _UNSERIALIZABLE: ClassVar[set[str]] = ...
    ctx: Optional[object] = ...
    type: Optional[type] = ...
    fake_mode: Optional[FakeTensorMode] = ...
    view_func: Optional[ViewFunc[Any]] = ...
    level: Optional[int] = ...
...
class MetaConverter(Generic[_TensorT]):
    ...
    def get_tensor_memo(self, t: MetaTensorDesc[Any]) -> Optional[torch.Tensor]:
        ...
    ...
    def meta_tensor(self, t: MetaTensorDesc[Any], shape_env: Optional[ShapeEnv], callback_: _MetaTensorCallback[_TensorT], source: Optional[Source], symbolic_context: Optional[SymbolicContext]) -> _TensorT:
        ...
