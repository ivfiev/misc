...
from typing import Any, Literal, Optional, TYPE_CHECKING, TypeGuard, TypeVar, Union
...
def get_plain_tensors(subclass: Tensor, *, out: list[Tensor | int | SymInt | OpaqueType]) -> list[Tensor | int | SymInt | OpaqueType]:
    ...
...
class FakeTensorConverter:
    @property
    def tensor_memo(self) -> weakref.WeakValueDictionary[torch._subclasses.meta_utils.MetaTensorId, FakeTensor]:
        ...
...
class FakeTensor(Tensor):
    ...
    nonzero_memo: SymNumberMemoDescriptor | int | None = ...
    item_memo = ...
    unique_memo: SymNumberMemoDescriptor | int | None = ...
