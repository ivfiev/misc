...
from typing import Any, Generic, IO, TypeAlias, TypeVar
...
def register_package(priority: int, tagger: Callable[[STORAGE], str | None], deserializer: Callable[[STORAGE, str], STORAGE | None]) -> None:
    """
...
def save(obj: object, f: FileLike, pickle_module: Any = ..., pickle_protocol: int = ..., _use_new_zipfile_serialization: bool = ..., _disable_byteorder_record: bool = ...) -> None:
...
def load(f: FileLike, map_location: MAP_LOCATION = ..., pickle_module: Any = ..., *, weights_only: bool | None = ..., mmap: bool | None = ..., **pickle_load_args: Any) -> Any:
