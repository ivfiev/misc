...
def functional_call(module: torch.nn.Module, parameter_and_buffer_dicts: dict[str, Tensor] | Sequence[dict[str, Tensor]], args: Any = ..., kwargs: dict[str, Any] | None = ..., *, tie_weights: bool = ..., strict: bool = ...) -> Any:
