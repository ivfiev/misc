...
def vmap(func: Callable[_P, _R], in_dims: in_dims_t = ..., out_dims: out_dims_t = ..., randomness: str = ..., *, chunk_size: int | None = ...) -> Callable[_P, _R]:
    """
...
def chunk_vmap(func: Callable[_P, _R], in_dims: in_dims_t = ..., out_dims: out_dims_t = ..., randomness: str = ..., chunks: int = ...) -> Callable[_P, _R]:
    """
...
@exposed_in("torch.func")
def grad(func: Callable[_P, Any], argnums: argnums_t = ..., has_aux: bool = ...) -> Callable[_P, Any]:
...
@exposed_in("torch.func")
def grad_and_value(func: Callable[_P, Any], argnums: argnums_t = ..., has_aux: bool = ...) -> Callable[_P, tuple[Any, Any]]:
    """
