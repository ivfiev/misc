...
def vjp(func: Callable[..., Any], *primals: Any, has_aux: bool = ...) -> tuple[Any, Callable[..., Any]] | tuple[Any, Callable[..., Any], Any]:
    """
...
@exposed_in("torch.func")
def jacrev(func: Callable[..., Any], argnums: Union[int, tuple[int, ...]] = ..., *, has_aux: bool = ..., chunk_size: Optional[int] = ..., _preallocate_and_copy: bool = ...) -> Callable[..., Any]:
    """
...
jvp_str = ...
def safe_unpack_dual(dual: torch.Tensor, strict: bool) -> tuple[torch.Tensor, torch.Tensor]:
    ...

@exposed_in("torch.func")
def jvp(func: Callable[..., Any], primals: Any, tangents: Any, *, strict: bool = ..., has_aux: bool = ...) -> tuple[Any, Any] | tuple[Any, Any, Any]:
    """
...
@exposed_in("torch.func")
def jacfwd(func: Callable[..., Any], argnums: argnums_t = ..., has_aux: bool = ..., *, randomness: str = ...) -> Callable[..., Any]:
    """
    Computes the Jacobian of ``func`` with respect to the arg(s) at index
...
@exposed_in("torch.func")
def hessian(func: Callable[..., Any], argnums: argnums_t = ...) -> Callable[..., Any]:
    """
...
def grad_and_value_impl(func: Callable[..., Any], argnums: argnums_t, has_aux: bool, args: tuple[Any, ...], kwargs: dict[str, Any]) -> tuple[Any, Any]:
    ...

def grad_impl(func: Callable[..., Any], argnums: argnums_t, has_aux: bool, args: tuple[Any, ...], kwargs: dict[str, Any]) -> Any:
    ...

@exposed_in("torch.func")
def functionalize(func: Callable[..., Any], *, remove: str = ...) -> Callable[..., Any]:
    """
...
@exposed_in("torch.func")
def linearize(func: Callable[..., Any], *primals: Any) -> tuple[Any, Callable[..., Any]]:
    """
...
@exposed_in("torch.func")
def debug_unwrap(tensor: torch.Tensor, *, recurse: bool = ...) -> torch.Tensor:
