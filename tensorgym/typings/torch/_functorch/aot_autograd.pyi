...
from ._aot_autograd.schemas import AOTConfig, AOTDispatchCompiler, AOTState, FakifiedFlatArgs, GraphSignature, JointWithDescriptors
from ._aot_autograd.utils import PytreeThunk
...
def create_aot_state(stack: contextlib.ExitStack, flat_fn: Callable[_P, _R], fake_flat_args: FakifiedFlatArgs, flat_args_descs: list[AOTInput], aot_config: AOTConfig, fake_mode: FakeTensorMode, shape_env: ShapeEnv | None) -> AOTState:
    """
...
def aot_function(fn: Callable[_P, _R], fw_compiler: AOTDispatchCompiler, bw_compiler: AOTDispatchCompiler | None = ..., partition_fn: Callable[..., Any] = ..., decompositions: dict[OpOverload, Callable[..., Any]] | None = ..., num_params_buffers: int = ..., keep_inference_input_mutations: bool = ..., inference_compiler: AOTDispatchCompiler | None = ..., *, dynamic: bool = ..., enable_log: bool = ..., disable_functionalization: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> Callable[_P, Any]:
    """
...
def prepare_aot_module_simplified(mod: nn.Module, args: Iterable[Any], kwargs: dict[str, Any] | None, decompositions: dict[OpOverload, Callable[..., Any]] | None, keep_inference_input_mutations: bool, boxed_forward_device_index: BoxedDeviceIndex | None, ignore_shape_env: bool, flatten: bool, *, force_non_lazy_backward_lowering: bool = ..., disable_functionalization: bool = ..., _record_nn_module_stack: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> tuple[Any, list[torch.nn.Parameter | Tensor], list[str], list[str], FakifiedFlatArgs, list[Any], AOTConfig, FakeTensorMode, ShapeEnv | None, pytree.TreeSpec | None, PytreeThunk | None,]:
    ...

def aot_module_simplified(mod: torch.fx.GraphModule | torch._dynamo.utils.GmWrapper, args: Iterable[Any], fw_compiler: AOTDispatchCompiler, bw_compiler: AOTDispatchCompiler | None = ..., partition_fn: Callable[..., Any] = ..., decompositions: dict[OpOverload, Callable[..., Any]] | None = ..., keep_inference_input_mutations: bool = ..., inference_compiler: AOTDispatchCompiler | None = ..., cudagraphs: BoxedBool | None = ..., boxed_forward_device_index: BoxedDeviceIndex | None = ..., ignore_shape_env: bool = ..., disable_functionalization: bool = ...) -> Callable[..., Any]:
    """
...
def boxed_nop_preserve_node_meta(gm: torch.fx.GraphModule, example_inputs: Sequence[InputType]) -> Any:
    ...

def aot_export_joint_with_descriptors(stack: contextlib.ExitStack, mod: nn.Module, args: tuple[Any, ...], kwargs: dict[str, Any] | None = ..., *, decompositions: dict[OpOverload, Callable[..., Any]] | None = ..., keep_inference_input_mutations: bool = ..., ignore_shape_env: bool = ..., disable_functionalization: bool = ..., _record_nn_module_stack: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> JointWithDescriptors:
    """
...
def aot_compile_joint_with_descriptors(jd: JointWithDescriptors, *, partition_fn: Callable[..., Any] = ..., fw_compiler: AOTDispatchCompiler = ..., bw_compiler: AOTDispatchCompiler | None = ..., serializable: bool = ...) -> Callable[..., Any]:
    """
...
def aot_export_module(mod: nn.Module, args: Iterable[Any], *, decompositions: dict[OpOverload, Callable[..., Any]] | None = ..., trace_joint: bool, output_loss_index: int | None = ..., pre_dispatch: bool = ..., dynamic_shapes: bool | None = ..., kwargs: dict[str, Any] | None = ...) -> tuple[Callable[..., Any] | torch.fx.GraphModule, GraphSignature]:
    """
...
def aot_export_joint_simple(func: Callable[..., Any], args: tuple[Any, ...], *, trace_joint: bool, num_params_buffers: int = ..., decompositions: dict[OpOverload, Callable[..., Any]] | None = ...) -> Callable[..., Any]:
    """
