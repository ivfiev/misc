...
from .schemas import AOTConfig, GraphSignature, ViewAndMutationMeta
...
def create_synthetic_base_metadata(m: ViewAndMutationMeta, synthetic_base_info: list[int | tuple[int, torch.Tensor]], outer_args: list[Any], inner_args: list[Any], inner_args_desc: list[AOTInput]) -> tuple[ViewAndMutationMeta, list[int]]:
    ...

def compute_overlapping_inputs(aot_config: AOTConfig, fwd_inputs: list[Any], aliased_input_indices: list[int]) -> set[int]:
    ...
