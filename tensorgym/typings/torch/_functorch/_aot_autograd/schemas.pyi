...
class OutputAliasInfo:
    ...
    requires_grad: bool
    view_meta_sequence: Optional[ViewMetaSequence] = ...
...
class SubclassCreationMeta:
    ...
    memory_format: Optional[MemoryFormatMeta] = ...
    def compute_outer_size_and_stride(self, all_args: Sequence[torch.Tensor | IntLikeType], *, curr_start_idx: int) -> tuple[Iterable[IntLikeType | None], Iterable[IntLikeType | None],]:
        ...
    
    def creation_fn(self, all_args: Sequence[torch.Tensor | IntLikeType], *, is_runtime: bool) -> torch.Tensor:
        ...
...
class ViewAndMutationMeta:
    ...
    num_tensors_saved_with_no_vc_check: Optional[int] = ...
    ...
    mutated_inp_stream_indices: Optional[list[Optional[int]]] = ...
    def __post_init__(self) -> None:
        ...
...
class AOTConfig:
    ...
    _disable_torch_fn_metadata_mode: bool = ...
    def __post_init__(self) -> None:
        ...
...
class CompilerWrapper:
    ...
    def post_compile(self, compiled_fn: Callable[_P, _R], aot_config: AOTConfig, *, runtime_metadata: ViewAndMutationMeta) -> Callable[_P, _R]:
        """
...
class InductorWrapper:
    ...
    """
    def pre_compile(self, fw_module: torch.fx.GraphModule, flat_args: list[Tensor], aot_config: AOTConfig, *, fw_metadata: ViewAndMutationMeta) -> None:
        """
        Process the inputs to the compiler_fn. You can pass in extra metadata via kwargs.
        Args:
        flat_fn: The function to compile
...
class AOTGraphCapture:
    ...
    updated_flat_args_descs: Union[list[AOTInput], tuple[list[AOTInput], list[AOTInput]]]
...
class JointTraceFn(Protocol):
    ...
    def __call__(self, primals: list[FxValue], tangents: list[FxValue]) -> tuple[tuple[list[FxValue], list[Optional[Tensor]]], tuple[list[AOTOutput], list[Optional[AOTOutput]]],]:
        ...
