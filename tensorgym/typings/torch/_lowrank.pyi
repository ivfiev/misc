...
def get_approximate_basis(A: Tensor, q: int, niter: int | None = ..., M: Tensor | None = ...) -> Tensor:
...
def svd_lowrank(A: Tensor, q: int | None = ..., niter: int | None = ..., M: Tensor | None = ...) -> tuple[Tensor, Tensor, Tensor]:
...
def pca_lowrank(A: Tensor, q: int | None = ..., center: bool = ..., niter: int = ...) -> tuple[Tensor, Tensor, Tensor]:
