...
def reduce(inputs: Sequence[torch.Tensor], output: torch.Tensor | Sequence[torch.Tensor] | None = ..., root: int = ..., op: int = ..., streams: Sequence[torch.cuda.Stream] | None = ..., comms=..., *, outputs: Sequence[torch.Tensor] | None = ...) -> None:
    ...
