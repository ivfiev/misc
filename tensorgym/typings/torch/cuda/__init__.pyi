...
from typing import Any, NewType, Optional, TYPE_CHECKING, Union, cast
from torch._utils import _LazySeedTracker, _dummy_type, classproperty
from torch.types import Device
from . import _device_limits, amp, gds, jiterator, nvtx, profiler, sparse, tunable
...
class _CompatInterval:
    ...
    def __contains__(self, x) -> Literal[False]:
        ...
