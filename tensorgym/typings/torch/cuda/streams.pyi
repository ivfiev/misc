...
class Stream(torch._C._CudaStreamBase):
    ...
    def record_event(self, event: Event | torch.Event | None = ...) -> torch.cuda.streams.Event | torch._C.Event:
        r"""Record an event.
    ...
    def __cuda_stream__(self) -> tuple[Literal[0], int]:
...
class Event(torch._C._CudaEventBase):
    ...
    """
    def __new__(cls, enable_timing=..., blocking=..., interprocess=..., external=...) -> Self:
        ...
    ...
    def wait(self, stream: Stream | torch.Stream | None = ...) -> None:
