...
if TYPE_CHECKING:
    ...
__all__ = ["is_current_stream_capturing", "graph_pool_handle", "CUDAGraph", "graph", "make_graphed_callables"]
_R = TypeVar("_R")
_P = ParamSpec("_P")
...
class graph:
    ...
    def __init__(self, cuda_graph: CUDAGraph, pool: _POOL_HANDLE | None = ..., stream: torch.cuda.Stream | None = ..., capture_error_mode: str = ...) -> None:
        ...
...
@overload
def make_graphed_callables(callables: _ModuleOrCallable, sample_args: tuple[Tensor, ...], num_warmup_iters: int = ..., allow_unused_input: bool = ..., pool: _POOL_HANDLE | None = ...) -> _ModuleOrCallable:
    ...

@overload
def make_graphed_callables(callables: tuple[_ModuleOrCallable, ...], sample_args: tuple[tuple[Tensor, ...], ...], num_warmup_iters: int = ..., allow_unused_input: bool = ..., pool: _POOL_HANDLE | None = ...) -> tuple[_ModuleOrCallable, ...]:
    ...

def make_graphed_callables(callables: _ModuleOrCallable | tuple[_ModuleOrCallable, ...], sample_args: tuple[Tensor, ...] | tuple[tuple[Tensor, ...], ...], num_warmup_iters: int = ..., allow_unused_input: bool = ..., pool: _POOL_HANDLE | None = ...) -> _ModuleOrCallable | tuple[_ModuleOrCallable, ...]:
