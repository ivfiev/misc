...
@deprecated("`torch.cuda.max_memory_cached` has been renamed to `torch.cuda.max_memory_reserved`", category=FutureWarning)
def max_memory_cached(device: Device = ...) -> int:
    r"""Deprecated; see :func:`~torch.cuda.max_memory_reserved`."""
    ...

def memory_snapshot(mempool_id=..., include_traces=...) -> Any:
...
class MemPool(_MemPool):
    ...
    """
    def __init__(self, allocator: _cuda_CUDAAllocator | None = ..., use_on_oom: bool = ..., no_split: bool = ...) -> None:
        ...
    ...
    def snapshot(self, include_traces=...) -> Any:
