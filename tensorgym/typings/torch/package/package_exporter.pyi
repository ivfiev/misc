...
class PackageExporter:
    ...
    def save_source_string(self, module_name: str, src: str, is_package: bool = ..., dependencies: bool = ...) -> None:
    ...
    def save_pickle(self, package: str, resource: str, obj: Any, dependencies: bool = ..., pickle_protocol: int = ...) -> None:
