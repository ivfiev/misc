...
def exponential(M: int, *, center: float | None = ..., tau: float = ..., sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
""".format(**window_common_args))
def cosine(M: int, *, sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
""".format(**window_common_args))
def gaussian(M: int, *, std: float = ..., sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
Examples::
    ...
    tensor([1.9858e-07, 5.1365e-05, 3.8659e-03, 8.4658e-02, 5.3941e-01, 1.0000e+00, 5.3941e-01, 8.4658e-02, 3.8659e-03, 5.1365e-05])
""".format(**window_common_args))
def kaiser(M: int, *, beta: float = ..., sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
""".format(**window_common_args))
def hamming(M: int, *, sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
""".format(**window_common_args))
def hann(M: int, *, sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
""".format(**window_common_args))
def blackman(M: int, *, sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
""".format(**window_common_args))
def bartlett(M: int, *, sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
Examples::
    ...
    tensor([0.0000, 0.0955, 0.3455, 0.6545, 0.9045, 1.0000, 0.9045, 0.6545, 0.3455, 0.0955])
""".format(**window_common_args))
def general_cosine(M, *, a: Iterable, sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
Examples::
    ...
    tensor([0.0000, 0.0955, 0.3455, 0.6545, 0.9045, 1.0000, 0.9045, 0.6545, 0.3455, 0.0955])
""".format(**window_common_args))
def general_hamming(M, *, alpha: float = ..., sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
...
""".format(**window_common_args))
def nuttall(M: int, *, sym: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device: torch.device | None = ..., requires_grad: bool = ...) -> Tensor:
    ...
