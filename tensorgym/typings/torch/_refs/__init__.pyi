...
from torch._prims_common import BoolLike, DeviceLikeType, Dim, DimsSequenceType, DimsType, ELEMENTWISE_TYPE_PROMOTION_KIND, FloatLike, FloatWithoutSymFloat, IntLike, Number, NumberType, REDUCTION_OUTPUT_TYPE_KIND, RealNumberType, ShapeType, StrideType, TensorLike, TensorLikeType, TensorOrNumberLikeType, TensorSequenceType, dtype_to_type, is_contiguous_for_memory_format_or_false, is_contiguous_or_false, is_weakly_lesser_type
...
def add(a: Union[TensorLikeType, NumberType], b: Union[TensorLikeType, NumberType], *, alpha: Optional[NumberType] = ...):
    """
...
@out_wrapper()
@elementwise_type_promotion_wrapper(type_promoting_args=("a", "b"), type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.DEFAULT)
def sub(a: Union[TensorLikeType, NumberType], b: Union[TensorLikeType, NumberType], *, alpha: NumberType = ...):
    """
...
unsqueeze_copy = ...
view_copy = ...
def tensor(data, *, dtype=..., device=..., pin_memory=..., requires_grad=...) -> Tensor | NotImplementedType:
    ...
