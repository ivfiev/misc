...
from typing import Any, Literal, SupportsFloat, TYPE_CHECKING, TypedDict
...
class LambdaLR(LRScheduler):
    ...
    """
    def __init__(self, optimizer: Optimizer, lr_lambda: Callable[[int], float] | list[Callable[[int], float]], last_epoch: int = ...) -> None:
        ...
...
class SequentialLR(LRScheduler):
    ...
    """
    def __init__(self, optimizer: Optimizer, schedulers: list[LRScheduler], milestones: list[int], last_epoch: int = ...) -> None:
        ...
...
class PolynomialLR(LRScheduler):
    ...
    """
    def __init__(self, optimizer: Optimizer, total_iters: int = ..., power: float = ..., last_epoch: int = ...) -> None:
        ...
...
class ReduceLROnPlateau(LRScheduler):
    ...
    """
    def __init__(self, optimizer: Optimizer, mode: Literal["min", "max"] = ..., factor: float = ..., patience: int = ..., threshold: float = ..., threshold_mode: Literal["rel", "abs"] = ..., cooldown: int = ..., min_lr: list[float] | float = ..., eps: float = ...) -> None:
        ...
...
class CyclicLR(LRScheduler):
    ...
    * "exp_range": A cycle that scales initial amplitude by :math:`\text{gamma}^{\text{cycle iterations}}`
    ...
    """
    def __init__(self, optimizer: Optimizer, base_lr: float | list[float], max_lr: float | list[float], step_size_up: int = ..., step_size_down: int | None = ..., mode: Literal["triangular", "triangular2", "exp_range"] = ..., gamma: float = ..., scale_fn: Callable[[float], float] | None = ..., scale_mode: Literal["cycle", "iterations"] = ..., cycle_momentum: bool = ..., base_momentum: float = ..., max_momentum: float = ..., last_epoch: int = ...) -> None:
        ...
...
class OneCycleLR(LRScheduler):
    ...
    """
    def __init__(self, optimizer: Optimizer, max_lr: float | list[float], total_steps: int | None = ..., epochs: int | None = ..., steps_per_epoch: int | None = ..., pct_start: float = ..., anneal_strategy: Literal["cos", "linear"] = ..., cycle_momentum: bool = ..., base_momentum: float | list[float] = ..., max_momentum: float | list[float] = ..., div_factor: float = ..., final_div_factor: float = ..., three_phase: bool = ..., last_epoch: int = ...) -> None:
        ...
