...
class AveragedModel(Module):
    ...
    """
    n_averaged: Tensor
    def __init__(self, model: Module, device: int | torch.device | None = ..., avg_fn: Callable[[Tensor, Tensor, Tensor | int], Tensor] | None = ..., multi_avg_fn: Callable[[PARAM_LIST, PARAM_LIST, Tensor | int], None] | None = ..., use_buffers=...) -> None:
        ...
...
class SWALR(LRScheduler):
    ...
    .. _Averaging Weights Leads to Wider Optima and Better Generalization:
        https://arxiv.org/abs/1803.05407
    """
    def __init__(self, optimizer: Optimizer, swa_lr: float, anneal_epochs=..., anneal_strategy: Literal["cos", "linear"] = ..., last_epoch=...) -> None:
        ...
