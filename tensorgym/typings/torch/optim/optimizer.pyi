...
class Optimizer:
    ...
    def register_state_dict_post_hook(self, hook: Callable[[Optimizer, StateDict], StateDict | None], prepend: bool = ...) -> RemovableHandle:
    ...
    def register_load_state_dict_pre_hook(self, hook: Callable[[Optimizer, StateDict], StateDict | None], prepend: bool = ...) -> RemovableHandle:
    ...
    def register_load_state_dict_post_hook(self, hook: Callable[[Optimizer], None], prepend: bool = ...) -> RemovableHandle:
