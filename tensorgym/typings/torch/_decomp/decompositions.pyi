...
def type_casts(f: Callable, type_promotion: utils.ELEMENTWISE_TYPE_PROMOTION_KIND, compute_dtype_only: bool = ..., include_non_tensor_args: bool = ...) -> _Wrapped[..., Any, ..., Any | PyTree]:
    ...
...
@pw_cast_for_opmath
def smooth_l1_loss_backward_out(grad_output: Tensor, self: Tensor, target: Tensor, reduction: int, beta: float, grad_input: Tensor) -> Tensor:
    ...
...
@pw_cast_for_opmath
def huber_loss_backward_out(grad_output: Tensor, self: Tensor, target: Tensor, reduction: int, delta: float, grad_input: Tensor) -> Tensor:
    ...
...
def slice_forward(self: Tensor, dim: int = ..., start: Optional[int] = ..., end: Optional[int] = ..., step: int = ...) -> Tensor:
    ...

@register_decomposition(aten.slice_scatter)
@out_wrapper()
def slice_scatter(input: Tensor, src: Tensor, dim: int = ..., start: Optional[int] = ..., end: Optional[int] = ..., step: int = ...) -> Tensor | Any:
    ...
...
def dropout(input: Tensor, p: float, train: Optional[bool]) -> Any | Tensor:
    ...
...
def cudnn_batch_norm(input: Tensor, weight: Tensor, bias: Optional[Tensor], running_mean: Optional[Tensor], running_var: Optional[Tensor], training: bool, exponential_average_factor: float, epsilon: float) -> tuple[Any, Any, Any, Tensor] | tuple[Any, Tensor, Tensor, Tensor]:
    ...
...
@out_wrapper()
@pw_cast_for_opmath
def adaptive_avg_pool2d(input: Tensor, output_size: tuple[int, int]) -> Tensor | SymFloat | Any | NotImplementedType:
    ...

@register_decomposition(aten.max_unpool2d)
@out_wrapper()
def max_unpool2d(self: TensorLike, indices: TensorLike, output_size: list[int]) -> Tensor | Any:
    ...

@register_decomposition(aten.max_unpool3d)
@out_wrapper()
def max_unpool3d(input: TensorLike, indices: TensorLike, output_size: list[int], stride: list[int], padding: list[int]) -> Tensor | Any:
    ...
...
def rnn_tanh_input(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first) -> tuple[Tensor | Any, Tensor]:
    ...
...
def rnn_relu_input(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first) -> tuple[Tensor | Any, Tensor]:
    ...
...
def rnn_relu_data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional) -> tuple[Tensor | Any, Tensor]:
    ...
...
def rnn_tanh_data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional) -> tuple[Tensor | Any, Tensor]:
    ...

def lstm_cell(inp, hx, cx, hh_weight, hh_bias, hr_weight, chunk_dim) -> tuple[Any | Tensor, Any]:
    ...

def one_layer_lstm(inp, hidden, params, has_biases, reverse=...) -> tuple[Tensor, tuple[Tensor | Any, Any]]:
    ...

def one_layer_lstm_data(inp, hidden, params, has_biases, batch_sizes, reverse=...) -> tuple[Tensor, tuple[Any | Tensor, Any] | tuple[Tensor, Tensor]]:
    ...

def select_one_layer_lstm_function(input, hx, params) -> Callable[..., tuple[Any, tuple[Any, Any]]] | Callable[..., tuple[Tensor, tuple[Tensor | Any, Any]]]:
...
def lstm_impl(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first) -> tuple[Tensor | Any, Tensor, Tensor]:
    ...
...
def lstm_data_impl(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional) -> tuple[Tensor | Any, Tensor, Tensor]:
    ...
...
def gru_impl_data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional) -> tuple[Tensor | Any, Tensor]:
    ...
...
def gru_impl(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first) -> tuple[Tensor | Any, Tensor]:
    ...
...
@out_wrapper()
@pw_cast_for_opmath
def affine_grid_generator(theta: Tensor, size: list[int], align_corners: bool) -> Tensor:
    ...
