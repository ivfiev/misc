...
class UniformQuantizationObserverBase(ObserverBase):
    ...
    _version = ...
    eps: torch.Tensor
    def __init__(self, dtype=..., qscheme=..., reduce_range=..., quant_min=..., quant_max=..., factory_kwargs=..., eps=..., is_dynamic=..., **kwargs) -> None:
        ...
...
class MovingAverageMinMaxObserver(MinMaxObserver):
    ...
    .. note:: If the running minimum equals to the running maximum, the scale
              and zero_point are set to 1.0 and 0.
    """
    def __init__(self, averaging_constant=..., dtype=..., qscheme=..., reduce_range=..., quant_min=..., quant_max=..., eps=..., is_dynamic=..., **kwargs) -> None:
        ...
...
class PerChannelMinMaxObserver(UniformQuantizationObserverBase):
    ...
    min_val: torch.Tensor
    max_val: torch.Tensor
    def __init__(self, ch_axis=..., dtype=..., qscheme=..., reduce_range=..., quant_min=..., quant_max=..., factory_kwargs=..., eps=..., is_dynamic=..., **kwargs) -> None:
        ...
...
class MovingAveragePerChannelMinMaxObserver(PerChannelMinMaxObserver):
    ...
    .. note:: If the running minimum equals to the running maximum, the scales
              and zero_points are set to 1.0 and 0.
    """
    def __init__(self, averaging_constant=..., ch_axis=..., dtype=..., qscheme=..., reduce_range=..., quant_min=..., quant_max=..., eps=..., is_dynamic=..., **kwargs) -> None:
        ...
...
class HistogramObserver(UniformQuantizationObserverBase):
    ...
    min_val: torch.Tensor
    max_val: torch.Tensor
    def __init__(self, bins: int = ..., dtype: torch.dtype = ..., qscheme=..., reduce_range=..., quant_min=..., quant_max=..., factory_kwargs=..., eps=..., is_dynamic=..., **kwargs) -> None:
        ...
...
class FixedQParamsObserver(ObserverBase):
    ...
    def __init__(self, scale, zero_point, dtype=..., qscheme=..., quant_min=..., quant_max=..., is_dynamic=..., **kwargs) -> None:
        ...
...
class PlaceholderObserver(ObserverBase):
    ...
    """
    def __init__(self, dtype=..., custom_op_name=..., compute_dtype=..., quant_min=..., quant_max=..., qscheme=..., eps=..., is_dynamic=...) -> None:
        ...
...
class AffineQuantizedObserverBase(ABC, torch.nn.Module):
    ...
    """
    with_args = ...
    def __init__(self, mapping_type: MappingType, target_dtype: torch.dtype, granularity: Granularity, quant_min: int | None = ..., quant_max: int | None = ..., eps: float | None = ..., scale_dtype: torch.dtype | None = ..., zero_point_dtype: torch.dtype | None = ..., preserve_zero: bool = ..., zero_point_domain: ZeroPointDomain | None = ..., **kwargs) -> None:
        ...
