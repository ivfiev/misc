...
scale_min_lower_bound=None, scale_max_upper_bound=None)
    ...
    def __init__(self, input_dtype: torch.dtype | DTypeWithConstraints | None = ..., output_dtype: torch.dtype | DTypeWithConstraints | None = ..., weight_dtype: torch.dtype | DTypeWithConstraints | None = ..., bias_dtype: torch.dtype | None = ..., is_dynamic: bool | None = ...) -> None:
        ...
