...
def create_getattr_from_value(module: torch.nn.Module, graph: Graph, prefix: str, value: Any, device: torch.device | None = ...) -> Node:
    """
...
def maybe_get_next_module(node: Node, modules: dict[str, nn.Module], target_module_type: type[nn.Module] | None = ..., target_functional_type: Any = ...) -> Node | None:
