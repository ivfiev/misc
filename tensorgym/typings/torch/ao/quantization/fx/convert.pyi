...
def convert_weighted_module(node: Node, modules: dict[str, torch.nn.Module], observed_node_names: set[str], node_name_to_qconfig: dict[str, QConfigAny], backend_config: BackendConfig, is_decomposed: bool = ..., is_reference: bool = ..., model_device: torch.device | None = ...) -> None:
...
def convert(model: GraphModule, is_reference: bool = ..., convert_custom_config: ConvertCustomConfig | dict[str, Any] | None = ..., is_standalone_module: bool = ..., _remove_qconfig_flag: bool = ..., qconfig_mapping: QConfigMapping | dict[str, Any] | None = ..., backend_config: BackendConfig | dict[str, Any] | None = ..., is_decomposed: bool = ..., keep_original_weights: bool = ...) -> GraphModule:
    """
