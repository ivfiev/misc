...
class _DerivedObserverOrFakeQuantize(ObserverBase):
    ...
    """
    def __init__(self, dtype: torch.dtype, obs_or_fqs: list[ObserverOrFakeQuantize], derive_qparams_fn: Callable[[list[ObserverOrFakeQuantize]], tuple[Tensor, Tensor]], quant_min: int | None = ..., quant_max: int | None = ..., qscheme: torch.qscheme | None = ..., ch_axis: int | None = ...) -> None:
        ...
