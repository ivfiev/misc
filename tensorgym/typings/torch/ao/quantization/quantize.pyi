...
def get_default_custom_config_dict() -> dict[str, dict[Any, Any]]:
...
@typing_extensions.deprecated(DEPRECATION_WARNING)
def convert(module, mapping=..., inplace=..., remove_qconfig=..., is_reference=..., convert_custom_config_dict=..., use_precomputed_fake_quant=...):
