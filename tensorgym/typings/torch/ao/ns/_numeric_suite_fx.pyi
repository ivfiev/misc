...
def extract_weights(model_name_a: str, model_a: nn.Module, model_name_b: str, model_b: nn.Module, base_name_to_sets_of_related_ops: dict[str, set[NSNodeTargetType]] | None = ..., unmatchable_types_map: dict[str, set[NSNodeTargetType]] | None = ..., op_to_type_to_weight_extraction_fn: dict[str, dict[Callable, Callable]] | None = ...) -> NSResultsType:
    """
...
def add_loggers(name_a: str, model_a: nn.Module, name_b: str, model_b: nn.Module, logger_cls: Callable, should_log_inputs: bool = ..., base_name_to_sets_of_related_ops: dict[str, set[NSNodeTargetType]] | None = ..., unmatchable_types_map: dict[str, set[NSNodeTargetType]] | None = ...) -> tuple[nn.Module, nn.Module]:
    """
...
def add_shadow_loggers(name_a: str, model_a: nn.Module, name_b: str, model_b: nn.Module, logger_cls: Callable, should_log_inputs: bool = ..., base_name_to_sets_of_related_ops: dict[str, set[NSNodeTargetType]] | None = ..., node_type_to_io_type_map: dict[str, set[NSNodeTargetType]] | None = ..., unmatchable_types_map: dict[str, set[NSNodeTargetType]] | None = ...) -> nn.Module:
    """
...
def prepare_n_shadows_model(model: torch.nn.Module, example_inputs: Any, qconfig_multi_mapping: QConfigMultiMapping, backend_config: BackendConfig, custom_prepare_fn: Callable | None = ..., custom_prepare_kwargs: dict[str, Any] | None = ..., custom_tracer: Any = ...) -> GraphModule:
    """
...
def convert_n_shadows_model(model: GraphModule, custom_convert_fn: Callable | None = ..., custom_convert_kwargs: dict[str, Any] | None = ...) -> GraphModule:
    """
