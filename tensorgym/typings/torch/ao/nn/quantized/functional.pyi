...
def avg_pool2d(input, kernel_size, stride=..., padding=..., ceil_mode=..., count_include_pad=..., divisor_override=...) -> Tensor:
    r"""
...
def avg_pool3d(input, kernel_size, stride=..., padding=..., ceil_mode=..., count_include_pad=..., divisor_override=...) -> Tensor:
    r"""
...
def conv1d(input, weight, bias, stride=..., padding=..., dilation=..., groups=..., padding_mode=..., scale=..., zero_point=..., dtype=...) -> Any:
    r"""
...
def conv2d(input, weight, bias, stride=..., padding=..., dilation=..., groups=..., padding_mode=..., scale=..., zero_point=..., dtype=...) -> Any:
    r"""
...
def conv3d(input, weight, bias, stride=..., padding=..., dilation=..., groups=..., padding_mode=..., scale=..., zero_point=..., dtype=...) -> Any:
    r"""
...
def linear(input: Tensor, weight: Tensor, bias: Tensor | None = ..., scale: float | None = ..., zero_point: int | None = ...) -> Tensor:
    r"""
...
def max_pool1d(input, kernel_size, stride=..., padding=..., dilation=..., ceil_mode=..., return_indices=...) -> Tensor:
...
def max_pool2d(input, kernel_size, stride=..., padding=..., dilation=..., ceil_mode=..., return_indices=...) -> Tensor:
...
def leaky_relu(input: Tensor, negative_slope: float = ..., inplace: bool = ..., scale: float | None = ..., zero_point: int | None = ...) -> Tensor:
    r"""
