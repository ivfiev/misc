...
class Embedding(nn.Embedding, ReferenceQuantizedModule):
    ...
    embedding operator.
    """
    def __init__(self, num_embeddings: int, embedding_dim: int, padding_idx: int | None = ..., max_norm: float | None = ..., norm_type: float = ..., scale_grad_by_freq: bool = ..., sparse: bool = ..., _weight: Tensor | None = ..., device=..., dtype=..., weight_qparams: dict[str, Any] | None = ...) -> None:
        ...
...
class EmbeddingBag(nn.EmbeddingBag, ReferenceQuantizedModule):
    ...
    embedding operator.
    """
    def __init__(self, num_embeddings: int, embedding_dim: int, max_norm: float | None = ..., norm_type: float = ..., scale_grad_by_freq: bool = ..., mode: str = ..., sparse: bool = ..., _weight: Tensor | None = ..., include_last_offset: bool = ..., padding_idx: int | None = ..., device=..., dtype=..., weight_qparams: dict[str, Any] | None = ...) -> None:
        ...
