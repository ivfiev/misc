...
class RNNCell(RNNCellBase):
    ...
    """
    def __init__(self, input_size: int, hidden_size: int, bias: bool = ..., nonlinearity: str = ..., device=..., dtype=..., weight_qparams_dict: dict[str, Any] | None = ...) -> None:
        ...
...
class LSTMCell(RNNCellBase):
    ...
    e.g. weight_ih, to the weight_qparams for that weight
    """
    def __init__(self, input_size: int, hidden_size: int, bias: bool = ..., device=..., dtype=..., weight_qparams_dict: dict[str, Any] | None = ...) -> None:
        ...
...
class RNNBase(nn.RNNBase):
    def __init__(self, mode: str, input_size: int, hidden_size: int, num_layers: int = ..., bias: bool = ..., batch_first: bool = ..., dropout: float = ..., bidirectional: bool = ..., proj_size: int = ..., device=..., dtype=..., weight_qparams_dict: dict[str, Any] | None = ...) -> None:
        ...
