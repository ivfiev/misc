...
class _LSTMSingleLayer(torch.nn.Module):
    ...
    def forward(self, x: Tensor, hidden: tuple[Tensor, Tensor] | None = ...) -> tuple[Tensor, tuple[Tensor, Tensor] | None]:
        ...
...
class _LSTMLayer(torch.nn.Module):
    ...
    def forward(self, x: Tensor, hidden: tuple[Tensor, Tensor] | None = ...) -> tuple[Tensor | Any, tuple[Any | Tensor | None, Any | Tensor | None]]:
        ...
