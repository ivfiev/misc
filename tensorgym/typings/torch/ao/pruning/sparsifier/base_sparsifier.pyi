...
class BaseSparsifier(abc.ABC):
    ...
    def squash_mask(self, params_to_keep: tuple[str, ...] | None = ..., params_to_keep_per_layer: dict[str, tuple[str, ...]] | None = ..., *args, **kwargs) -> None:
    ...
    def convert(self, module: nn.Module, mapping: dict[type[nn.Module], type[nn.Module]] | None = ..., inplace: bool = ..., parameterization: type[nn.Module] = ...) -> Module:
