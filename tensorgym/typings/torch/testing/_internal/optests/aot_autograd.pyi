...
def aot_autograd_check(func, args, kwargs, dynamic, assert_raises_regex_fn=..., assert_equals_fn=..., check_gradients=..., try_check_data_specialization=..., skip_correctness_check=..., disable_functionalization=...) -> None:
