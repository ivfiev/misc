...
class Distribution:
    ...
    def __init__(self, batch_shape: torch.Size = ..., event_shape: torch.Size = ..., validate_args: bool | None = ...) -> None:
        ...
    ...
    @deprecated("`sample_n(n)` will be deprecated. Use `sample((n,))` instead.", category=FutureWarning)
