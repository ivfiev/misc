...
class AffineTransform(Transform):
    ...
    """
    bijective = ...
    def __init__(self, loc: Tensor | float, scale: Tensor | float, event_dim: int = ..., cache_size: int = ...) -> None:
        ...
...
class CatTransform(Transform):
    ...
    def __init__(self, tseq: Sequence[Transform], dim: int = ..., lengths: Sequence[int] | None = ..., cache_size: int = ...) -> None:
        ...
