...
class LOBPCGAutogradFunction(torch.autograd.Function):
    @staticmethod
    def forward(ctx, A: Tensor, k: int | None = ..., B: Tensor | None = ..., X: Tensor | None = ..., n: int | None = ..., iK: Tensor | None = ..., niter: int | None = ..., tol: float | None = ..., largest: bool | None = ..., method: str | None = ..., tracker: None = ..., ortho_iparams: dict[str, int] | None = ..., ortho_fparams: dict[str, float] | None = ..., ortho_bparams: dict[str, bool] | None = ...) -> tuple[Tensor, Tensor]:
        ...
...
def lobpcg(A: Tensor, k: int | None = ..., B: Tensor | None = ..., X: Tensor | None = ..., n: int | None = ..., iK: Tensor | None = ..., niter: int | None = ..., tol: float | None = ..., largest: bool | None = ..., method: str | None = ..., tracker: None = ..., ortho_iparams: dict[str, int] | None = ..., ortho_fparams: dict[str, float] | None = ..., ortho_bparams: dict[str, bool] | None = ...) -> tuple[Tensor, Tensor]:
