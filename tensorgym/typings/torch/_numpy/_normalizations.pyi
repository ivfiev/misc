...
NotImplementedType = typing.TypeVar("NotImplementedType", bound=types.NotImplementedType)
...
def normalize_ndarray(arg, parm=...) -> Tensor | None:
    ...

def normalize_outarray(arg, parm=...) -> ndarray | None:
    ...
...
def normalizer(_func=..., *, promote_scalar_result=...) -> Callable[..., _Wrapped[..., Any, ..., ndarray | list[Any] | tuple[Any, ...] | Any]] | _Wrapped[..., Any, ..., ndarray | list[Any] | tuple[Any, ...] | Any]:
    ...
