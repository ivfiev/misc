...
def convolve(a: ArrayLike, v: ArrayLike, mode=...) -> Tensor:
    ...

def correlate(a: ArrayLike, v: ArrayLike, mode=...) -> Tensor:
    ...
...
def broadcast_shapes(*args) -> Size | Any:
    ...
...
def array_equal(a1: ArrayLike, a2: ArrayLike, equal_nan=...) -> Number:
    ...
...
def einsum(*operands, out=..., dtype=..., order=..., casting=..., optimize=...) -> ndarray | <subclass of ndarray and list> | <subclass of ndarray and tuple>:
    ...
...
def histogram(a: ArrayLike, bins: ArrayLike = ..., range=..., normed=..., weights: Optional[ArrayLike] = ..., density=...) -> tuple[Tensor | Any, Tensor | Any]:
    ...
