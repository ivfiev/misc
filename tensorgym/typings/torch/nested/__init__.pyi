...
def as_nested_tensor(ts: Tensor | list[Tensor] | tuple[Tensor, ...], dtype: DType | None = ..., device: Device | None = ..., layout=...) -> Tensor:
    r"""
...
def nested_tensor_from_jagged(values: Tensor, offsets: Tensor | None = ..., lengths: Tensor | None = ..., jagged_dim: int | None = ..., min_seqlen: int | None = ..., max_seqlen: int | None = ...) -> Tensor:
    r"""
