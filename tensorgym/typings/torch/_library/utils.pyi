...
def is_functional_schema(schema: Any, *, allow_valid_view: bool = ...) -> bool:
...
def mutates_and_returns_first_arg(op: OpOverload) -> bool:
...
def fill_defaults(schema, args, kwargs) -> tuple[tuple[Any, ...], dict[Any, Any]]:
    ...
...
def hop_schema_from_fx_node(node) -> FunctionSchema:
    ...
...
def has_kwarg_only_args(schema: _C.FunctionSchema) -> bool:
    ...

def has_kwarg_only_tensors(schema: _C.FunctionSchema) -> bool:
    ...
...
def check_aliasing_constraint(name, prev, result, get_module=...) -> None:
    """
...
@overload
def get_layout_constraint_tag(fn: Any, *, with_default: Literal[False]) -> Optional[_C.Tag]:
    ...

def get_layout_constraint_tag(fn, *, with_default=...) -> Tag | Any | None:
    ...

_RANDOM_FUNCTIONS = ...
def is_impure(op: Callable, *, args: Optional[tuple[Any, ...]] = ..., kwargs: Optional[dict[str, Any]] = ..., impure_random: bool = ...) -> bool:
    """
