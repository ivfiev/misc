...
log = ...
@overload
def custom_op(name: str, fn: None = ..., /, *, mutates_args: Union[str, Iterable[str]], device_types: device_types_t = ..., schema: Optional[str] = ..., tags: Optional[Sequence[_C.Tag]] = ...) -> Callable[[Callable[..., object]], CustomOpDef]:
    ...

@overload
def custom_op(name: str, fn: Callable[..., object], /, *, mutates_args: Union[str, Iterable[str]], device_types: device_types_t = ..., schema: Optional[str] = ..., tags: Optional[Sequence[_C.Tag]] = ...) -> CustomOpDef:
    ...

@exposed_in("torch.library")
def custom_op(name: str, fn: Optional[Callable] = ..., /, *, mutates_args: Union[str, Iterable[str]], device_types: device_types_t = ..., schema: Optional[str] = ..., tags: Optional[Sequence[_C.Tag]] = ...) -> Union[Callable[[Callable[..., object]], CustomOpDef], CustomOpDef]:
...
class CustomOpDef:
    ...
    """
    def __init__(self, namespace: str, name: str, schema: str, fn: Callable, tags: Optional[Sequence[_C.Tag]] = ...) -> None:
        ...
