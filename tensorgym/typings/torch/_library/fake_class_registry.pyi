...
class FakeScriptObject:
    def __init__(self, wrapped_obj: Any, script_class_name: str, x: Optional[torch.ScriptObject]) -> None:
        ...
...
def maybe_to_fake_obj(fake_mode, x: Any) -> Union[FakeScriptObject, torch.ScriptObject]:
    ...
