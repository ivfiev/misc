...
def substitute_in_graph(original_fn: Callable[_P, _R], *, can_constant_fold_through: bool = ..., skip_signature_check: bool = ...) -> Callable[[Callable[_P, _R]], Callable[_P, _R]]:
    """
...
def disable(fn=..., recursive=..., *, reason=...) -> Callable[..., Any] | DisableContext | Callable[..., Callable[_P, _R]]:
    """
...
def set_stance(stance: str = ..., *, skip_guard_eval_unsafe: bool = ..., force_backend: Union[str, Callable[..., Any], None] = ...) -> set_stance:
    """
...
def keep_portable_guards_unsafe(guard_entries) -> list[Any | bool]:
    """
...
def skip_all_guards_unsafe(guard_entries) -> list[bool]:
    """
...
def nested_compile_region(fn=..., options: Optional[NestedCompileRegionOptions] = ...) -> Callable[..., Any] | Callable[..., Callable[..., Any]]:
    """
...
def load_compiled_function(file: io.IOBase, *, f_globals: dict[str, object] | None = ..., external_data: dict[str, Any] | None = ...) -> Callable[..., Any]:
    """
