...
class _ExportCodeGen(_PyTreeCodeGen):
    def __init__(self, pytree_info: _PyTreeInfo, in_shuffle_graph: GraphModule, out_shuffle_graph: GraphModule, tree_leaf_names: list[str], root: Optional[torch.nn.Module]) -> None:
        ...
...
class Graph:
    ...
    """
    @compatibility(is_backward_compatible=True)
    def __init__(self, owning_module: Optional[GraphModule] = ..., tracer_cls: Optional[type[Tracer]] = ..., tracer_extras: Optional[dict[str, Any]] = ...) -> None:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def create_node(self, op: str, target: Target, args: Optional[tuple[Argument, ...]] = ..., kwargs: Optional[dict[str, Argument]] = ..., name: Optional[str] = ..., type_expr: Optional[Any] = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def call_module(self, module_name: str, args: Optional[tuple[Argument, ...]] = ..., kwargs: Optional[dict[str, Argument]] = ..., type_expr: Optional[Any] = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def call_method(self, method_name: str, args: Optional[tuple[Argument, ...]] = ..., kwargs: Optional[dict[str, Argument]] = ..., type_expr: Optional[Any] = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def call_function(self, the_function: Callable[..., Any], args: Optional[tuple[Argument, ...]] = ..., kwargs: Optional[dict[str, Argument]] = ..., type_expr: Optional[Any] = ..., name: Optional[str] = ...) -> Node:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def python_code(self, root_module: str, *, verbose: bool = ..., include_stride: bool = ..., include_device: bool = ..., colored: bool = ..., expanded_def: bool = ..., record_func: bool = ..., additional_meta: Optional[list[str]] = ...) -> PythonCode:
        """
    ...
    @compatibility(is_backward_compatible=False)
    def on_generate_code(self, make_transformer: Callable[[Optional[TransformCodeFunc]], TransformCodeFunc]) -> _GeneratorContextManager[None, None, None]:
