...
log = ...
BaseArgumentTypes = Union[str, int, float, bool, complex, torch.dtype, torch.Tensor, torch.device, torch.memory_format, torch.layout, torch._ops.OpOverload, torch.SymInt, torch.SymBool, torch.SymFloat,]
base_types = ...
Target: TypeAlias = Union[Callable[..., Any], str]
Argument = Optional[Union[tuple["Argument", ...], Sequence["Argument"], Mapping[str, "Argument"], slice, range, "Node", BaseArgumentTypes,]]
...
class Node(_NodeBase):
    ...
    meta: dict[str, Any]
    @compatibility(is_backward_compatible=True)
    def __init__(self, graph: Graph, name: str, op: str, target: Target, args: tuple[Argument, ...], kwargs: dict[str, Argument], return_type: Optional[Any] = ...) -> None:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def format_node(self, placeholder_names: Optional[list[str]] = ..., maybe_return_typename: Optional[list[str]] = ..., *, include_tensor_metadata: bool = ...) -> Optional[str]:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def replace_all_uses_with(self, replace_with: Node, delete_user_cb: Optional[Callable[[Node], bool]] = ..., *, propagate_meta: bool = ...) -> list[Node]:
        """
    ...
    @compatibility(is_backward_compatible=False)
    def normalized_arguments(self, root: torch.nn.Module, arg_types: Optional[tuple[Any]] = ..., kwarg_types: Optional[dict[str, Any]] = ..., normalize_to_only_use_kwargs: bool = ...) -> Optional[ArgsKwargsPair]:
        """
