...
from typing import Any, Generic, NamedTuple, NoReturn, Optional, TYPE_CHECKING, TypeAlias, TypeGuard, TypeVar, Union
...
aten = ...
__all__ = ["size_hint", "guard_or_false", "guard_or_true", "has_symbolic_sizes_strides", "create_contiguous", "ShapeEnv", "is_concrete_int", "is_concrete_float", "is_concrete_bool", "has_static_value", "guard_int", "guard_float", "guard_scalar", "canonicalize_bool_expr", "hint_int", "SYMPY_INTERP", "free_symbols", "is_symbol_binding_fx_node", "is_nested_int", "SHAPEENV_EVENT_KEY", "CURRENT_NODE_KEY", "has_free_symbols", "has_free_unbacked_symbols", "sym_and", "sym_eq", "sym_or", "SymbolicContext", "StatelessSymbolicContext", "StatefulSymbolicContext", "SubclassSymbolicContext", "SymIntSymbolicContext", "TrackedFake", "statically_known_true", "statically_known_false", "guard_size_oblivious", "check_consistent", "compute_unbacked_bindings", "ConvertIntKey", "rebind_unbacked", "resolve_unbacked_bindings", "is_accessor_node", "ValueRangesSLoc", "SymIntEqByExpr", "Specialization"]
SHAPEENV_EVENT_KEY = ...
CURRENT_NODE_KEY = ...
...
def size_hint(a: Union[torch.SymInt, int], fallback: Optional[int] = ...) -> int:
    """
...
@deprecated("guard_size_oblivious will be removed. Consider using explicit unbacked handling \
    potentially utilizing guard_or_false, guard_or_true, or statically_known_true", category=FutureWarning)
...
class StatelessSymbolicContext(SymbolicContext, Generic[_P1, _T1]):
    ...
    shape_ids: Optional[dict[int, Optional[str]]] = ...
    def __post_init__(self) -> None:
        ...
...
class ShapeEnv:
    ...
    @record_shapeenv_event()
    def create_symfloatnode(self, sym: sympy.Expr, *, hint: Optional[int | float | bool], source: Optional[Source] = ...) -> FloatLikeType:
    ...
    @property
    @deprecated("var_to_val is deprecated, use backed_var_to_val instead", category=FutureWarning)
    def var_to_val(self) -> dict[sympy.Symbol, sympy.Integer]:
        """Deprecated: use backed_var_to_val instead."""
        ...
    
    @deprecated("add_var_to_val is deprecated, use add_backed_var_to_val instead", category=FutureWarning)
