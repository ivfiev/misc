...
from typing import Any, Optional, Protocol, TYPE_CHECKING, TypeAlias, TypeVar, Union, overload
...
if TYPE_CHECKING:
    ...
__all__ = ["PythonKeyTracer", "dispatch_trace", "make_fx", "DecompositionInterpreter", "selective_decompose", "py_sym_types", "get_innermost_proxy_mode", "get_proxy_mode", "handle_sym_dispatch", "maybe_enable_thunkify", "maybe_disable_thunkify"]
...
@overload
def set_proxy_slot(obj: _AnyScriptObjectType | OpaqueType, tracer: _ProxyTracer, proxy: Proxy) -> None:
    ...
...
def set_proxy_slot(obj: Union[PySymType, _AnyScriptObjectType, Tensor, OpaqueType], tracer: _ProxyTracer, proxy: object) -> None:
    ...
...
@overload
def get_proxy_slot(obj: OpaqueType, tracer: _ProxyTracer, default: T) -> Union[T, _OpaqueObjectProxyType]:
    ...
...
def get_proxy_slot(obj: Union[Tensor, _AnyScriptObjectType, PySymType, OpaqueType], tracer: _ProxyTracer, default: object = ..., transform: Callable = ...) -> object:
    ...

def snapshot_fake(val: Tensor, include_real: bool = ...) -> Optional[Tensor]:
    ...

_ExtractValType: TypeAlias = (None | PySymType | OpaqueType | _AnyScriptObjectType | BackwardState | list["_ExtractValType"] | tuple["_ExtractValType", ...] | dict[str, "_ExtractValType"] | Tensor | int | float | bool)
...
@overload
def fetch_object_proxy(tracer: _ProxyTracer, t: OpaqueType) -> Union[_OpaqueObjectProxyType, PySymType]:
    ...

def fetch_object_proxy(tracer: _ProxyTracer, t: Tensor | _AnyScriptObjectType | PySymType | OpaqueType) -> object:
    ...
...
@contextmanager
def set_original_aten_op(func: OpOverload | torch._ops.HigherOrderOperator) -> Generator[None, None, None]:
    ...
...
class _SelectiveDecomposeInterpreter(fx.Interpreter):
    def __init__(self, module: fx.GraphModule, should_decompose: Callable[[fx.Node], bool], decomposition_table: Mapping[OpOverload, Callable], **kwargs: object) -> None:
        """
    ...
    @staticmethod
    def recursive_wrap(gm: fx.GraphModule, should_decompose: Callable[[fx.Node], bool], decomposition_table: Mapping[OpOverload, Callable], **kwargs: object) -> _SelectiveDecomposeInterpreter:
        """
...
def selective_decompose(joint_gm: fx.GraphModule, *args, decomposition, should_decompose, trace_joint_graph: bool) -> fx.GraphModule:
...
class _MakefxTracer:
    def __init__(self, decomposition_table: Optional[Mapping[OpOverload, Callable]], tracing_mode: str, _allow_non_fake_inputs: bool, pre_dispatch: bool, record_module_stack: bool, _allow_fake_constant: bool, _error_on_data_dependent_ops: bool, record_stack_traces: bool = ..., parent_tracer: Optional[_MakefxTracer] = ..., proxy_module_inputs: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> None:
        ...
...
def make_fx(f: Callable, decomposition_table: Optional[Mapping[OpOverload, Callable]] = ..., tracing_mode: str = ..., _allow_non_fake_inputs: bool = ..., *, pre_dispatch: bool = ..., record_module_stack: bool = ..., _allow_fake_constant: bool = ..., _error_on_data_dependent_ops: bool = ..., record_stack_traces: bool = ..., proxy_module_inputs: bool = ..., _disable_torch_fn_metadata_mode: bool = ...) -> Callable[..., GraphModule]:
    """
