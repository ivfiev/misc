...
_is_fx_tracing_flag = ...
_ConstantAttributeType: TypeAlias = Union[torch.Tensor, torch.ScriptObject, FakeScriptObject, pytree.TreeSpec]
...
class Tracer(TracerBase):
    ...
    @compatibility(is_backward_compatible=False)
    def create_args_for_root(self, root_fn, is_module, concrete_args=...) -> tuple[Any, list[Any]] | tuple[Callable[..., list[Any]], list[Any]] | tuple[FunctionType | Any, list[Any]]:
        """
    ...
    @compatibility(is_backward_compatible=True)
    def trace(self, root: Union[torch.nn.Module, Callable[..., Any]], concrete_args: Optional[dict[str, Any]] = ...) -> Graph:
        """
...
@compatibility(is_backward_compatible=True)
def wrap(fn_or_name: Union[str, Callable]) -> Callable[..., Any] | str:
    """
...
@compatibility(is_backward_compatible=True)
def symbolic_trace(root: Union[torch.nn.Module, Callable[..., Any]], concrete_args: Optional[dict[str, Any]] = ...) -> GraphModule:
    """
