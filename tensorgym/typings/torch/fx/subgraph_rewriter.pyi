...
@compatibility(is_backward_compatible=False)
def replace_pattern_with_filters(gm: GraphModule, pattern: Union[Callable, Graph, GraphModule], replacement: Union[Callable, Graph, GraphModule, None] = ..., match_filters: Optional[list[Callable[[InternalMatch, Graph, Graph], bool]]] = ..., ignore_literals: bool = ..., replacement_callback: Optional[Callable[[InternalMatch, Graph, Graph], Graph]] = ..., node_name_match: str = ...) -> list[ReplacedPatterns]:
    """
