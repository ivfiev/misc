...
__all__ = ["reduce_graph_module", "reduce_package_graph_module", "GraphModule"]
_USER_PRESERVED_ATTRIBUTES_KEY = ...
FX_GRAPH_MODULE_FILE_PREFIX = ...
class _EvalCacheLoader:
    def __init__(self) -> None:
        ...
    
    def cache(self, src: str, globals: dict[str, Any], co_fields=...) -> str:
...
class GraphModule(torch.nn.Module):
    ...
    @compatibility(is_backward_compatible=True)
    def __init__(self, root: Union[torch.nn.Module, dict[str, Any]], graph: Graph, class_name: str = ...) -> None:
        """
    ...
    def to_folder(self, folder: Union[str, os.PathLike], module_name: str = ...) -> None:
    ...
    @compatibility(is_backward_compatible=False)
    def print_readable(self, print_output=..., include_stride=..., include_device=..., colored=..., *, fast_sympy_print: bool = ..., expanded_def: bool = ..., additional_meta: Optional[list[str]] = ...):
        """
