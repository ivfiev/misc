...
class Interpreter:
    ...
    """
    @compatibility(is_backward_compatible=True)
    def __init__(self, module: torch.nn.Module, garbage_collect_values: bool = ..., graph: Optional[Graph] = ...) -> None:
        ...
    
    @compatibility(is_backward_compatible=True)
    def run(self, *args, initial_env: Optional[dict[Node, Any]] = ..., enable_io_processing: bool = ...) -> Any:
        """
