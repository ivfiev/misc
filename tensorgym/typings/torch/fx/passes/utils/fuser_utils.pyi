...
@compatibility(is_backward_compatible=False)
def fuse_as_graphmodule(gm: GraphModule, nodes: NodeList, module_name: str, partition_lookup_table: _Optional[dict[Node, _Optional[int]]] = ..., *, always_return_tuple: bool = ...) -> tuple[GraphModule, tuple[Node, ...], tuple[Node, ...]]:
    """
...
@compatibility(is_backward_compatible=False)
def fuse_by_partitions(gm: GraphModule, partitions: list[dict[Node, _Optional[int]]], prefix: str = ..., always_return_tuple: bool = ...) -> GraphModule:
    ...
