...
__all__ = ["FxNetAccNodesFinder", "FxNetSplitterInternalError", "Subgraph", "SplitResult", "generate_inputs_for_submodules", "NodeEvent", "NodeEventTracker"]
...
class _SplitterSettingBase:
    def __init__(self, min_acc_module_size=..., skip_fusion=..., allow_non_tensor=..., max_acc_splits: int = ..., move_non_tensor_nodes_on_boundary: bool = ...) -> None:
        ...
...
@compatibility(is_backward_compatible=False)
def generate_inputs_for_submodules(model: torch.nn.Module, inputs: Sequence[Any], target_submodules: Iterable[str], deepcopy: bool = ...) -> dict[str, Any]:
    """
...
class _SplitterBase:
    ...
    """
    PCIe_BW = ...
    def __init__(self, module: torch.fx.GraphModule, sample_input: Sequence[Any], operator_support: OperatorSupportBase, settings: _SplitterSettingBase, non_acc_submodule_name: str = ..., return_tuple: bool = ..., nodes_finder: Optional[FxNetAccNodesFinder] = ...) -> None:
        """
