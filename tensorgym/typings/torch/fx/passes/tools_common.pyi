...
__all__ = ["get_acc_ops_name", "get_node_target", "is_node_output_tensor", "FxNetAccFusionsFinder", "legalize_graph", "stable_topological_sort"]
...
class FxNetAccFusionsFinder:
    ...
    def recursive_add_node(self, fusion_group: FxNetAccFusionsFinder.FusionGroup, inputs: Union[NodeSet, NodeList], visited: Optional[NodeSet] = ...) -> bool:
        """
