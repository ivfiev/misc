...
@compatibility(is_backward_compatible=True)
def split_module(m: GraphModule, root_m: torch.nn.Module, split_callback: Callable[[Node], int], qualname_map: Optional[dict[str, str]] = ..., keep_original_order: Optional[bool] = ..., keep_original_node_name: Optional[bool] = ..., keep_original_input_name: bool = ..., *, partition_affix: Optional[str] = ...):
    """
