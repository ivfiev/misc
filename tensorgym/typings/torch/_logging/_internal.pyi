...
class LogRegistry:
    ...
    def get_artifact_log_qnames(self) -> set[str]:
        ...
    
    def get_child_log_qnames(self) -> set[str]:
        ...
...
class LogState:
    ...
    def get_log_level_pairs(self) -> dict_items[str, str]:
...
log_state = ...
DEFAULT_LOGGING = ...
def set_logs(*, all: Optional[int] = ..., dynamo: Optional[int] = ..., aot: Optional[int] = ..., autograd: Optional[int] = ..., dynamic: Optional[int] = ..., inductor: Optional[int] = ..., distributed: Optional[int] = ..., c10d: Optional[int] = ..., ddp: Optional[int] = ..., fsdp: Optional[int] = ..., dtensor: Optional[int] = ..., onnx: Optional[int] = ..., bytecode: bool = ..., aot_graphs: bool = ..., aot_joint_graph: bool = ..., ddp_graphs: bool = ..., graph: bool = ..., graph_code: bool = ..., graph_code_verbose: bool = ..., graph_breaks: bool = ..., side_effects: bool = ..., graph_sizes: bool = ..., guards: bool = ..., recompiles: bool = ..., recompiles_verbose: bool = ..., trace_source: bool = ..., trace_call: bool = ..., trace_bytecode: bool = ..., output_code: bool = ..., kernel_code: bool = ..., schedule: bool = ..., perf_hints: bool = ..., pre_grad_graphs: bool = ..., post_grad_graphs: bool = ..., ir_pre_fusion: bool = ..., ir_post_fusion: bool = ..., onnx_diagnostics: bool = ..., fusion: bool = ..., overlap: bool = ..., export: Optional[int] = ..., modules: Optional[dict[str, Union[int, bool]]] = ..., cudagraphs: bool = ..., sym_node: bool = ..., compiled_autograd: bool = ..., compiled_autograd_verbose: bool = ..., cudagraph_static_inputs: bool = ..., benchmarking: bool = ..., autotuning: bool = ..., graph_region_expansion: bool = ..., inductor_metrics: bool = ..., hierarchical_compile: bool = ..., compute_dependencies: bool = ..., caching: bool = ...) -> None:
    """
...
def trace_structured_artifact(name: str, encoding: str, payload_fn: Callable[[], Optional[Union[str, object]]] = ..., compile_id: Optional[CompileId] = ...) -> None:
    ...

def trace_structured(name: str, metadata_fn: Callable[[], Union[dict[str, Any], tuple[str, int]]] = ..., *, payload_fn: Callable[[], Optional[Union[str, object]]] = ..., suppress_context: bool = ..., expect_trace_id: bool = ..., record_logging_overhead: bool = ..., compile_id: Optional[CompileId] = ...) -> None:
    """
...
def dtrace_structured(name: str, metadata_fn: Callable[[], Union[dict[str, Any], tuple[str, int]]] = ..., *, payload_fn: Callable[[], Optional[Union[str, object]]] = ..., suppress_context: bool = ..., expect_trace_id: bool = ..., record_logging_overhead: bool = ...) -> None:
    """
