...
from torch._prims_common import ELEMENTWISE_TYPE_PROMOTION_KIND, NumberType
...
def meta_sparse_structured_linear(input: Tensor, weight: Tensor, _meta: Tensor, bias: Tensor | None = ..., _activation_opt: str | None = ..., out_dtype: torch.dtype | None = ...) -> Tensor:
    ...

@register_meta(aten._sparse_semi_structured_mm)
def meta_sparse_structured_mm(mat1: Tensor, mat1_meta: Tensor, mat2: Tensor, out_dtype: torch.dtype | None = ...) -> Tensor:
    ...

@register_meta(aten._sparse_semi_structured_addmm)
def meta_sparse_structured_addmm(input: Tensor, mat1: Tensor, mat1_meta: Tensor, mat2: Tensor, *, alpha=..., beta=..., out_dtype: torch.dtype | None = ...) -> Tensor:
    ...

@register_meta(aten._cslt_sparse_mm)
def meta__cslt_sparse_mm(compressed_A: torch.Tensor, dense_B: torch.Tensor, bias: Tensor | None = ..., alpha: Tensor | None = ..., out_dtype: torch.dtype | None = ..., transpose_result: bool = ..., alg_id: int = ..., split_k: int = ..., split_k_mode: int = ...) -> Tensor:
    ...
...
def meta_segment_reduce(data: Tensor, reduce: str, *, lengths: Tensor | None = ..., indices: Tensor | None = ..., offsets: Tensor | None = ..., axis: int = ..., unsafe: bool = ..., initial=...) -> Tensor:
    ...
...
def linalg_solve_triangular_meta(A: Tensor, B: Tensor, *, upper: bool, left: bool = ..., unitriangular: bool = ..., out: Tensor | None = ...) -> Tensor:
    ...
...
@register_meta(aten._weight_norm_interface_backward.default)
def meta_weight_norm_backward(grad_w, saved_v, saved_g, saved_norms, dim) -> tuple[Tensor, Tensor]:
    ...
...
@out_wrapper(exact_dtype=True)
def meta_mm(a, b, out_dtype: torch.dtype | None = ...):
    ...

def device_hint(tensor) -> str:
    ...

def calc_conv_nd_return_shape(input_tensor: torch.Tensor, weight: torch.Tensor, stride: list[int] | int, padding: list[int] | int, dilation: list[int] | int, is_transposed: bool, groups: int, output_padding: list[int] | int | None = ...) -> list[int]:
    ...
...
def meta_miopen_batch_norm(input_tensor: torch.Tensor, weight: torch.Tensor, bias: torch.Tensor | None, running_mean: torch.Tensor | None, running_var: torch.Tensor | None, training: bool, exponential_average_factor: float, epsilon: float) -> tuple[Tensor, Tensor, Tensor]:
    ...

@register_meta(aten.convolution.default)
def meta_conv(input_tensor: torch.Tensor, weight: torch.Tensor, bias: torch.Tensor, stride: list[int], padding: list[int], dilation: list[int], is_transposed: bool, output_padding: list[int], groups: int) -> Tensor:
    ...
...
@out_wrapper()
def nonzero_static(self, *, size, fill_value: int = ...) -> Tensor:
    ...
...
def meta__scaled_dot_product_flash_attention(query: Tensor, key: Tensor, value: Tensor, dropout_p: float = ..., is_causal: bool = ..., return_debug_mask: bool = ..., scale: float | None = ...) -> tuple[Tensor, Tensor, None, None, int, int, Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._scaled_dot_product_flash_attention.quantized])
def meta__scaled_dot_product_flash_attention_quantized(query: Tensor, key: Tensor, value: Tensor, q_descale: Tensor | None, k_descale: Tensor | None, v_descale: Tensor | None, dropout_p: float = ..., is_causal: bool = ..., return_debug_mask: bool = ..., scale: float | None = ...) -> tuple[Tensor, Tensor, None, None, int, int, Tensor, Tensor, Tensor]:
    ...
...
def meta__scaled_dot_product_cudnn_attention(query: Tensor, key: Tensor, value: Tensor, attn_bias: Tensor | None, compute_log_sumexp: bool, dropout_p: float = ..., is_causal: bool = ..., return_debug_mask: bool = ..., scale: float | None = ...) -> tuple[Tensor, Tensor, None, None, int, int, Tensor, Tensor, None]:
    ...

@register_meta([aten._scaled_dot_product_fused_attention_overrideable])
def meta__scaled_dot_product_fused_attention_overrideable(query: Tensor, key: Tensor, value: Tensor, attn_bias: Tensor | None = ..., dropout_p: float = ..., is_causal: bool = ..., return_debug_mask: bool = ..., scale: float | None = ...) -> tuple[Tensor, Tensor, None, None, int, int, Tensor, Tensor, None]:
    ...

@register_meta([aten._scaled_dot_product_flash_attention_backward])
def meta__scaled_dot_product_flash_backward(grad_out: Tensor, query: Tensor, key: Tensor, value: Tensor, out: Tensor, logsumexp: Tensor, cum_seq_q: Tensor, cum_seq_k: Tensor, max_q: int, max_k: int, dropout_p: float, is_causal: bool, philox_seed: Tensor, philox_offset: Tensor, scale: float | None = ...) -> tuple[Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._scaled_dot_product_flash_attention_for_cpu])
def meta__scaled_dot_product_flash_attention_for_cpu(query: Tensor, key: Tensor, value: Tensor, dropout_p: float = ..., is_causal: bool = ..., attn_mask: Tensor | None = ..., scale: float | None = ...) -> tuple[Tensor, Tensor]:
    ...

@register_meta([aten._scaled_dot_product_flash_attention_for_cpu_backward])
def meta__scaled_dot_product_flash_attention_for_cpu_backward(grad_out: Tensor, query: Tensor, key: Tensor, value: Tensor, out: Tensor, logsumexp: Tensor, dropout_p: float, is_causal: bool, attn_mask: Tensor | None = ..., scale: float | None = ...) -> tuple[Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._scaled_dot_product_attention_math_for_mps])
def meta__scaled_dot_product_attention_math_for_mps(query: Tensor, key: Tensor, value: Tensor, attn_mask: Tensor | None = ..., dropout_p: float = ..., is_causal: bool = ..., dropout_mask: Tensor | None = ..., scale: float | None = ...) -> tuple[Tensor, Tensor]:
    ...

@register_meta([aten._scaled_dot_product_efficient_attention])
def meta__scaled_dot_product_efficient_attention(query: Tensor, key: Tensor, value: Tensor, attn_bias: Tensor | None, compute_log_sumexp: bool, dropout_p=..., is_causal: bool = ..., scale: float | None = ...) -> tuple[Tensor, Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._scaled_dot_product_efficient_attention_backward])
def meta__scaled_dot_product_efficient_backward(grad_out: Tensor, query: Tensor, key: Tensor, value: Tensor, attn_bias: Tensor | None, out: Tensor, logsumexp: Tensor, philox_seed: Tensor, philox_offset: Tensor, dropout_p: float, grad_input_mask: list[bool], is_causal: bool = ..., scale: float | None = ...) -> tuple[Tensor, Tensor, Tensor, Tensor | None]:
    ...

@register_meta([aten._scaled_dot_product_cudnn_attention_backward])
def meta__scaled_dot_product_cudnn_backward(grad_out: Tensor, query: Tensor, key: Tensor, value: Tensor, out: Tensor, logsumexp: Tensor, philox_seed: Tensor, philox_offset: Tensor, attn_bias: Tensor, cum_seq_q: Tensor, cum_seq_k: Tensor, max_q: int, max_k: int, dropout_p: float, is_causal: bool, scale: float | None = ...) -> tuple[Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._flash_attention_forward.default])
def meta__flash_attention_forward(query: Tensor, key: Tensor, value: Tensor, cum_seq_q: Tensor | None, cum_seq_k: Tensor | None, max_q: int, max_k: int, dropout_p: float, is_causal: bool, return_debug_mask: bool, scale: float | None = ..., window_size_left: int | None = ..., window_size_right: int | None = ..., seqused_k: Tensor | None = ..., alibi_slopes: Tensor | None = ...) -> tuple[Tensor, Tensor, Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._flash_attention_forward.quantized])
def meta__flash_attention_forward_quantized(query: Tensor, key: Tensor, value: Tensor, cum_seq_q: Tensor | None, cum_seq_k: Tensor | None, max_q: int, max_k: int, dropout_p: float, is_causal: bool, return_debug_mask: bool, q_descale: Tensor | None, k_descale: Tensor | None, v_descale: Tensor | None, scale: float | None = ..., window_size_left: int | None = ..., window_size_right: int | None = ..., seqused_k: Tensor | None = ..., alibi_slopes: Tensor | None = ...) -> tuple[Tensor, Tensor, Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._flash_attention_backward])
def meta__flash_attention_backward(grad_out: Tensor, query: Tensor, key: Tensor, value: Tensor, out: Tensor, logsumexp: Tensor, cum_seq_q: Tensor, cum_seq_k: Tensor, max_q: int, max_k: int, dropout_p: float, is_causal: bool, philox_seed: Tensor, philox_offset: Tensor, scale: float | None = ..., window_size_left: int | None = ..., window_size_right: int | None = ...) -> tuple[Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._efficient_attention_forward])
def meta__efficient_attention_forward(query: Tensor, key: Tensor, value: Tensor, bias: Tensor | None, cu_seqlens_q: Tensor | None, cu_seqlens_k: Tensor | None, max_seqlen_q: int | None, max_seqlen_k: int | None, dropout_p: float, custom_mask_type: int, compute_log_sumexp: bool = ..., scale: float | None = ..., causal_diagonal: Tensor | None = ..., seqlen_k: Tensor | None = ..., window_size: int | None = ...) -> tuple[Tensor, Tensor, Tensor, Tensor, int, int]:
    ...

@register_meta([aten._efficient_attention_backward])
def meta__efficient_attention_backward(grad_out: Tensor, query: Tensor, key: Tensor, value: Tensor, bias: Tensor | None, cu_seqlens_q: Tensor | None, cu_seqlens_k: Tensor | None, max_seqlen_q: torch.SymInt, max_seqlen_k: torch.SymInt, logsumexp: Tensor, dropout_p: float, philox_seed: Tensor, philox_offset: Tensor, custom_mask_type: int, bias_requires_grad: bool, scale: float | None = ..., num_splits_key: int | None = ..., shared_storage_dqdkdv: bool = ...) -> tuple[Tensor, Tensor, Tensor, Tensor]:
    ...

@register_meta([aten._scaled_mm.default])
def meta_scaled_mm(self: torch.Tensor, mat2: torch.Tensor, scale_a: torch.Tensor, scale_b: torch.Tensor, bias: torch.Tensor | None = ..., scale_result: torch.Tensor | None = ..., out_dtype: torch.dtype | None = ..., use_fast_accum: bool = ...) -> Tensor:
    ...

@register_meta([aten._scaled_mm_v2.default])
def meta_scaled_mm_v2(self: torch.Tensor, mat2: torch.Tensor, scale_a: list[torch.Tensor], scale_recipe_a: list[ScalingType], swizzle_a: list[SwizzleType], scale_b: list[torch.Tensor], scale_recipe_b: list[ScalingType], swizzle_b: list[SwizzleType], bias: torch.Tensor | None = ..., output_dtype: torch.dtype | None = ..., contraction_dims: list[int] | None = ..., use_fast_accum: bool = ...) -> Tensor:
    ...
...
def upsample_nearest2d_backward(grad_output: Tensor, output_size: Sequence[int | torch.SymInt], input_size: Sequence[int | torch.SymInt], scales_h: float | None = ..., scales_w: float | None = ...) -> Tensor:
    ...
...
def miopen_rnn(input, weight, weight_stride0, hx, cx, mode, hidden_size, num_layers, batch_first, dropout, train, bidirectional, batch_sizes, dropout_state) -> tuple[Any, Any, Tensor | Any, Any, Any]:
    ...
...
def meta_bucketize_scalar(self: NumberType, boundaries: Tensor, *, out_int32: bool = ..., right: bool = ...) -> Tensor:
    ...
...
@out_wrapper()
def meta_grouped_mm(mat_a: Tensor, mat_b: Tensor, offs: Tensor | None = ..., bias: Tensor | None = ..., out_dtype: torch.dtype | None = ...) -> Tensor:
    ...

@register_meta([aten._scaled_grouped_mm])
def meta_scaled_grouped_mm(mat_a: torch.Tensor, mat_b: torch.Tensor, scale_a: torch.Tensor, scale_b: torch.Tensor, offs: torch.Tensor | None = ..., bias: torch.Tensor | None = ..., scale_result: torch.Tensor | None = ..., out_dtype: torch.dtype | None = ..., use_fast_accum: bool = ...) -> Tensor:
    ...

@register_meta(aten._foreach_norm.Scalar)
def meta_foreach_norm(tensors, ord=..., dtype=...) -> list[Any]:
    ...
...
def meta__jagged_to_padded_dense_forward(values: Tensor, offsets: list[Tensor], max_lengths: list[int], padding_value: float = ...) -> Tensor:
    ...

@register_meta(aten._native_multi_head_attention.default)
def native_multi_head_attention_fake(query, key, value, embed_dim, num_head, qkv_weight, qkv_bias, proj_weight, proj_bias, mask=..., need_weights=..., average_attn_weights=..., mask_type=...) -> tuple[Any, Any]:
    ...
