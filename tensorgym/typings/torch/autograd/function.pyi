...
class FunctionCtx:
    ...
    @deprecated("`mark_shared_storage` is deprecated. " "Tensors with shared storages are automatically tracked. " "Note that calls to `set_()` are not tracked", category=FutureWarning)
...
def once_differentiable(fn: Callable[Concatenate[_T, _P], _R]) -> Callable[Concatenate[_T, _P], _R]:
    ...
