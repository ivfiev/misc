...
from torch.types import _TensorOrOptionalTensors, _TensorOrTensorsOrGradEdge, _size
from . import forward_ad, functional, graph, profiler
from .anomaly_mode import detect_anomaly, set_detect_anomaly
from .function import Function, NestedIOFunction
from .grad_mode import _force_original_view_tracking, _unsafe_preserve_version_counter, enable_grad, inference_mode, no_grad, set_grad_enabled, set_multithreading_enabled
from .gradcheck import gradcheck, gradgradcheck
from .graph import _engine_run_backward
from .variable import Variable
from torch._C._autograd import DeviceType, ProfilerEvent, SavedTensor, _KinetoEvent, _ProfilerResult, _add_metadata_json, _disable_profiler, _disable_profiler_legacy, _enable_profiler, _enable_profiler_legacy, _enable_record_function, _get_sequence_nr, _kineto_step, _pop_saved_tensors_default_hooks, _prepare_profiler, _profiler_enabled, _push_saved_tensors_default_hooks, _record_function_with_args_enter, _record_function_with_args_exit, _set_empty_test_observer, _supported_activities, _toggle_collection_dynamic, kineto_available
...
def backward(tensors: _TensorOrTensorsOrGradEdge, grad_tensors: Optional[_TensorOrOptionalTensors] = ..., retain_graph: Optional[bool] = ..., create_graph: bool = ..., grad_variables: Optional[_TensorOrOptionalTensors] = ..., inputs: Optional[_TensorOrTensorsOrGradEdge] = ...) -> None:
...
def grad(outputs: _TensorOrTensorsOrGradEdge, inputs: _TensorOrTensorsOrGradEdge, grad_outputs: Optional[_TensorOrOptionalTensors] = ..., retain_graph: Optional[bool] = ..., create_graph: bool = ..., only_inputs: bool = ..., allow_unused: Optional[bool] = ..., is_grads_batched: bool = ..., materialize_grads: bool = ...) -> tuple[torch.Tensor, ...]:
