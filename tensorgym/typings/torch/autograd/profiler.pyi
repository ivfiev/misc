...
class profile:
    ...
    """
    def __init__(self, enabled=..., *, use_cuda=..., use_device=..., record_shapes=..., with_flops=..., profile_memory=..., with_stack=..., with_modules=..., use_kineto=..., use_cpu=..., experimental_config=..., acc_events=..., custom_trace_id_callback=..., post_processing_timeout_s: Optional[float] = ...) -> None:
        ...
