...
from typing import Any, Literal, NamedTuple, Optional, TYPE_CHECKING, TypeAlias, Union
...
if TYPE_CHECKING:
    ...
__all__ = ["saved_tensors_hooks", "save_on_cpu", "disable_saved_tensors_hooks", "register_multi_grad_hook", "allow_mutation_on_saved_tensors", "Node", "GradientEdge", "get_gradient_edge", "increment_version", "set_warn_on_accumulate_grad_stream_mismatch"]
log = ...
class Node(abc.ABC):
    @abc.abstractmethod
    def name(self) -> str:
...
def register_multi_grad_hook(tensors: Sequence[torch.Tensor], fn: Union[Callable[[Sequence[Optional[torch.Tensor]]], None], Callable[[torch.Tensor], None],], *, mode: Literal["all", "any"] = ...) -> RemovableHandle:
...
class _CloneArgBeforeMutateMode(TorchDispatchMode):
    ...
    def __torch_dispatch__(self, func: OpOverload, types: Iterable[type], args: tuple[Any, ...] = ..., kwargs: Optional[dict[Any, Any]] = ...) -> Any:
        ...
