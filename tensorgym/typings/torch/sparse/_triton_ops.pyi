...
def bsr_dense_addmm(input: torch.Tensor, bsr: torch.Tensor, dense: torch.Tensor, *, beta=..., alpha=..., left_alpha: torch.Tensor | None = ..., right_alpha: torch.Tensor | None = ..., out: torch.Tensor | None = ..., skip_checks: bool = ..., max_grid: tuple[int | None, int | None, int | None] | None = ..., meta: dict | None = ...) -> Tensor:
    """Compute
...
if has_triton():
    def sampled_addmm(input: torch.Tensor, mat1: torch.Tensor, mat2: torch.Tensor, *, beta=..., alpha=..., out: torch.Tensor | None = ..., skip_checks: bool = ..., max_grid: tuple[int | None, int | None, int | None] | None = ...) -> Tensor:
        ...
    
    def bsr_dense_mm(bsr: torch.Tensor, dense: torch.Tensor, *, out: torch.Tensor | None = ..., skip_checks: bool = ..., max_grid: tuple[int | None, int | None, int | None] | None = ..., meta: dict | None = ...) -> Tensor:
        ...
