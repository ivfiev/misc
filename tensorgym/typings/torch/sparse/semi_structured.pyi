...
class SparseSemiStructuredTensor(torch.Tensor):
    ...
    __slots__ = ...
    @staticmethod
    def __new__(cls, shape: torch.Size, packed: torch.Tensor | None, meta: torch.Tensor | None, packed_t: torch.Tensor | None, meta_t: torch.Tensor | None, compressed_swizzled_bitmask: torch.Tensor | None, fuse_transpose_cusparselt: bool = ..., alg_id_cusparselt: int = ..., requires_grad: bool = ...):
        """
