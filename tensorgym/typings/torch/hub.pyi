...
def load(repo_or_dir, model, *args, source=..., trust_repo=..., force_reload=..., verbose=..., skip_validation=..., **kwargs) -> object:
    r"""
...
def load_state_dict_from_url(url: str, model_dir: str | None = ..., map_location: MAP_LOCATION = ..., progress: bool = ..., check_hash: bool = ..., file_name: str | None = ..., weights_only: bool = ...) -> dict[str, Any]:
