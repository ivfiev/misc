...
def mesh_scatter(output: torch.Tensor, scatter_list: list[torch.Tensor], mesh: DeviceMesh, mesh_dim: int = ..., async_op: bool = ..., *, group_src: int = ...) -> Work | None:
    """
...
def mesh_broadcast(tensor: torch.Tensor, mesh: DeviceMesh, mesh_dim: int = ..., async_op: bool = ..., *, group_src: int = ...) -> Work | None:
    """
...
def one_step_redistribute_cost(current_spec: dtensor_spec.DTensorSpec, target_spec: dtensor_spec.DTensorSpec) -> float:
    """
