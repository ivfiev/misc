...
class _FromTorchTensor(torch.autograd.Function):
    @staticmethod
    def forward(ctx, input: torch.Tensor, device_mesh: DeviceMesh, placements: tuple[Placement, ...], run_check: bool, shape: torch.Size | None = ..., stride: tuple[int, ...] | None = ...) -> DTensor:
        ...
...
class DTensor(torch.Tensor):
    ...
    * :class:`Partial`: Tensor is pending reduction on the devices of the ``DeviceMesh`` dimension
    ...
    @staticmethod
    def from_local(local_tensor: torch.Tensor, device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ..., *, run_check: bool = ..., shape: torch.Size | None = ..., stride: tuple[int, ...] | None = ...) -> DTensor:
        """
    ...
    def redistribute(self, device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ..., *, async_op: bool = ..., forward_dtype: torch.dtype | None = ..., backward_dtype: torch.dtype | None = ...) -> DTensor:
        """
    ...
    @classmethod
    def __metadata_guard__(cls, orig: tuple[DTensorSpec, bool], other: tuple[DTensorSpec, bool]) -> bool:
        ...
    


def distribute_tensor(tensor: torch.Tensor, device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ..., *, src_data_rank: int | None = ...) -> DTensor:
    """
...
def distribute_module(module: nn.Module, device_mesh: DeviceMesh | None = ..., partition_fn: Callable[[str, nn.Module, DeviceMesh], None] | None = ..., input_fn: Callable[[nn.Module, Any, DeviceMesh], None] | None = ..., output_fn: Callable[[nn.Module, Any, DeviceMesh], None] | None = ...) -> nn.Module:
    """
...
def ones(*size, dtype: torch.dtype | None = ..., layout: torch.layout = ..., requires_grad: bool = ..., device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ...) -> DTensor:
    """
...
def empty(*size, dtype: torch.dtype | None = ..., layout: torch.layout = ..., requires_grad: bool = ..., device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ...) -> DTensor:
    """
...
def full(size, fill_value, *, dtype: torch.dtype | None = ..., layout: torch.layout = ..., requires_grad: bool = ..., device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ...) -> DTensor:
    """
...
def rand(*size, requires_grad: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ...) -> DTensor:
    """
...
def randn(*size, requires_grad: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ...) -> DTensor:
    """
...
def zeros(*size, requires_grad: bool = ..., dtype: torch.dtype | None = ..., layout: torch.layout = ..., device_mesh: DeviceMesh | None = ..., placements: Sequence[Placement] | None = ...) -> DTensor:
    """
