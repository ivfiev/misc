...
class _NamedOptimizer(optim.Optimizer):
    ...
    """
    def __init__(self, named_parameters: Mapping[str, torch.Tensor | ShardedTensor], optimizer_class: optim.Optimizer, param_groups: Collection[Mapping[str, Any]] | None = ..., module: nn.Module | None = ..., *args: tuple[Any, ...], **kwargs: dict[str, Any]) -> None:
        ...
