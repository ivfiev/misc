...
class ZeroRedundancyOptimizer(Optimizer, Joinable):
    ...
    def __init__(self, params: Any, optimizer_class: type[Optimizer], process_group: Any | None = ..., parameters_as_bucket_view: bool = ..., overlap_with_ddp: bool = ..., **defaults: Any) -> None:
        ...
