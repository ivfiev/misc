...
class CheckpointWrapper(ActivationWrapper):
    ...
    """
    def __init__(self, mod: torch.nn.Module, checkpoint_impl: CheckpointImpl = ..., checkpoint_fn=..., **checkpoint_fn_kwargs) -> None:
        ...
...
def checkpoint_wrapper(module: torch.nn.Module, checkpoint_impl: CheckpointImpl = ..., checkpoint_fn=..., **checkpoint_fn_kwargs) -> torch.nn.Module:
    """
