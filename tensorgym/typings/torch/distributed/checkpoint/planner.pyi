...
from torch.distributed.checkpoint.metadata import ChunkStorageMetadata, Metadata, MetadataIndex, STATE_DICT_TYPE, StorageMeta, TensorProperties
...
class SavePlanner(abc.ABC):
    ...
    @abc.abstractmethod
    def set_up_planner(self, state_dict: STATE_DICT_TYPE, storage_meta: StorageMeta | None = ..., is_coordinator: bool = ...) -> None:
        """
...
class LoadPlanner:
    ...
    """
    @abc.abstractmethod
    def set_up_planner(self, state_dict: STATE_DICT_TYPE, metadata: Metadata | None = ..., is_coordinator: bool = ...) -> None:
        """
