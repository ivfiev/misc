...
class FullyShardedDataParallel(nn.Module, _FSDPState):
    ...
    * You should avoid modifying the parameters between forward and
    ...
    """
    def __init__(self, module: nn.Module, process_group: ProcessGroupType = ..., sharding_strategy: ShardingStrategy | None = ..., cpu_offload: CPUOffload | None = ..., auto_wrap_policy: Callable | ModuleWrapPolicy | CustomPolicy | None = ..., backward_prefetch: BackwardPrefetch | None = ..., mixed_precision: MixedPrecision | None = ..., ignored_modules: Iterable[torch.nn.Module] | None = ..., param_init_fn: Callable[[nn.Module], None] | None = ..., device_id: int | torch.device | None = ..., sync_module_states: bool = ..., forward_prefetch: bool = ..., limit_all_gathers: bool = ..., use_orig_params: bool = ..., ignored_states: Iterable[torch.nn.Parameter] | Iterable[torch.nn.Module] | None = ..., device_mesh: DeviceMesh | None = ...) -> None:
        ...
    ...
    @staticmethod
    def set_state_dict_type(module: nn.Module, state_dict_type: StateDictType, state_dict_config: StateDictConfig | None = ..., optim_state_dict_config: OptimStateDictConfig | None = ...) -> StateDictSettings:
    ...
    def state_dict_type(module: nn.Module, state_dict_type: StateDictType, state_dict_config: StateDictConfig | None = ..., optim_state_dict_config: OptimStateDictConfig | None = ...) -> Generator:
        """Set the ``state_dict_type`` of all the descendant FSDP modules of the target module.
    ...
    @staticmethod
    @contextlib.contextmanager
    def summon_full_params(module: nn.Module, recurse: bool = ..., writeback: bool = ..., rank0_only: bool = ..., offload_to_cpu: bool = ..., with_grads: bool = ...) -> Generator:
    ...
    @torch.no_grad()
    def clip_grad_norm_(self, max_norm: float | int, norm_type: float | int = ...) -> torch.Tensor:
    ...
    @staticmethod
    def full_optim_state_dict(model: torch.nn.Module, optim: torch.optim.Optimizer, optim_input: list[dict[str, Any]] | Iterable[torch.nn.Parameter] | None = ..., rank0_only: bool = ..., group: dist.ProcessGroup | None = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def sharded_optim_state_dict(model: torch.nn.Module, optim: torch.optim.Optimizer, group: dist.ProcessGroup | None = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def shard_full_optim_state_dict(full_optim_state_dict: dict[str, Any], model: torch.nn.Module, optim_input: list[dict[str, Any]] | Iterable[torch.nn.Parameter] | None = ..., optim: torch.optim.Optimizer | None = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def scatter_full_optim_state_dict(full_optim_state_dict: dict[str, Any] | None, model: torch.nn.Module, optim_input: list[dict[str, Any]] | Iterable[torch.nn.Parameter] | None = ..., optim: torch.optim.Optimizer | None = ..., group: Any | None = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def rekey_optim_state_dict(optim_state_dict: dict[str, Any], optim_state_key_type: OptimStateKeyType, model: torch.nn.Module, optim_input: list[dict[str, Any]] | Iterable[torch.nn.Parameter] | None = ..., optim: torch.optim.Optimizer | None = ...) -> dict[str, Any]:
    ...
    @staticmethod
    def optim_state_dict(model: torch.nn.Module, optim: torch.optim.Optimizer, optim_state_dict: dict[str, Any] | None = ..., group: dist.ProcessGroup | None = ...) -> dict[str, Any]:
        """
    ...
    @staticmethod
    def optim_state_dict_to_load(model: torch.nn.Module, optim: torch.optim.Optimizer, optim_state_dict: dict[str, Any], is_named_optimizer: bool = ..., load_directly: bool = ..., group: dist.ProcessGroup | None = ...) -> dict[str, Any]:
        """
