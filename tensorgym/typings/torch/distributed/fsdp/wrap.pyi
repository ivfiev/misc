...
def size_based_auto_wrap_policy(module: nn.Module, recurse: bool, nonwrapped_numel: int, min_num_params: int = ..., force_leaf_modules: set[type[nn.Module]] | None = ..., exclude_wrap_modules: set[type[nn.Module]] | None = ...) -> bool:
    """
