...
class ModTracker:
    ...
    def get_known_fqn(self, mod) -> None:
        """
        Return the fqn for the given module if it is known to the ``ModTracker``, otherwise ``None``.
        """
        ...
    
    def register_user_hooks(self, pre_fw_hook: Callable | None = ..., post_fw_hook: Callable | None = ..., pre_bw_hook: Callable | None = ..., post_bw_hook: Callable | None = ...) -> None:
        """
