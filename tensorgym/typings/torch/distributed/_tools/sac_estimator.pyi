...
class SACEstimator(TorchDispatchMode):
    ...
    def __torch_dispatch__(self, func, types, args=..., kwargs=...) -> Any:
        ...
    
    def display_sac_stats(self, sac_stats: SACStats, print_tabular: bool = ...) -> None:
        """
    ...
    def display_sac_tradeoff_stats(self, greedy_order_meta: SACGreedyOrderMeta, sac_stats: SACStats, print_tabular: bool = ...) -> None:
        """
    ...
    def pwlf_sac_tradeoff_curve(self, n_segments: int = ..., save_tradeoff_graphs: bool = ...) -> None:
        """
    ...
    def display_modulewise_sac_stats(self, depth: int = ..., print_tabular: bool = ...) -> None:
        """
