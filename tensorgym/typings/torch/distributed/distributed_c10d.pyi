...
class Backend(str):
    ...
    @classmethod
    def register_backend(cls, name, func, extended_api: bool = ..., devices: str | list[str] | None = ...) -> None:
        """
...
class P2POp:
    ...
    """
    def __init__(self, op: Callable, tensor: torch.Tensor, peer: int | None = ..., group: ProcessGroup | None = ..., tag: int = ..., group_peer: int | None = ...) -> None:
        """Init."""
        ...
    
    def __new__(cls, op: Callable, tensor: torch.Tensor, peer: int | None = ..., group: ProcessGroup | None = ..., tag: int = ..., group_peer: int | None = ...) -> Self:
        """Create and return a new instance of the class."""
        ...
...
class _CollOp:
    ...
    """
    def __init__(self, op: Callable, tensor: torch.Tensor, dst_tensor: torch.Tensor | None = ..., redop: ReduceOp | None = ..., root: int | None = ...) -> None:
        ...
...
@_exception_logger
@_time_logger
def init_process_group(backend: str | None = ..., init_method: str | None = ..., timeout: timedelta | None = ..., world_size: int = ..., rank: int = ..., store: Store | None = ..., group_name: str = ..., pg_options: Any | None = ..., device_id: torch.device | int | None = ..., _ranks: list[int] | None = ...) -> None:
    """
...
def isend(tensor: torch.Tensor, dst: int | None = ..., group: ProcessGroup | None = ..., tag: int = ..., group_dst: int | None = ...) -> Work | None:
    """
...
def irecv(tensor: torch.Tensor, src: int | None = ..., group: ProcessGroup | None = ..., tag: int = ..., group_src: int | None = ...) -> Work | None:
    """
...
@_exception_logger
def send(tensor: torch.Tensor, dst: int | None = ..., group: ProcessGroup | None = ..., tag: int = ..., group_dst: int | None = ...) -> None:
    """
...
@_exception_logger
def recv(tensor: torch.Tensor, src: int | None = ..., group: ProcessGroup | None = ..., tag: int = ..., group_src: int | None = ...) -> int:
    """
...
@_exception_logger
def broadcast(tensor: torch.Tensor, src: int | None = ..., group: ProcessGroup | None = ..., async_op: bool = ..., group_src: int | None = ...) -> Work | None:
    """
...
@_exception_logger
def all_reduce(tensor, op=..., group=..., async_op: bool = ...) -> Any | _IllegalWork | Work | None:
    """
...
def all_reduce_coalesced(tensors, op=..., group=..., async_op: bool = ...) -> Future[Any] | None:
    """
...
@_exception_logger
def reduce(tensor: torch.Tensor, dst: int | None = ..., op=..., group: ProcessGroup | None = ..., async_op: bool = ..., group_dst: int | None = ...) -> Work | None:
    """
...
@_exception_logger
def gather_object(obj: Any, object_gather_list: list[Any] | None = ..., dst: int | None = ..., group: ProcessGroup | None = ..., group_dst: int | None = ...) -> None:
    """
...
@_exception_logger
def send_object_list(object_list: list[Any], dst: int | None = ..., group: ProcessGroup | None = ..., device: torch.device | None = ..., group_dst: int | None = ..., use_batch: bool = ...) -> None:
    """
...
@_exception_logger
def recv_object_list(object_list: list[Any], src: int | None = ..., group: ProcessGroup | None = ..., device: torch.device | None = ..., group_src: int | None = ..., use_batch: bool = ...) -> int:
    """
...
@_exception_logger
def broadcast_object_list(object_list: list[Any], src: int | None = ..., group: ProcessGroup | None = ..., device: torch.device | None = ..., group_src: int | None = ...) -> None:
    """
...
@_exception_logger
def scatter_object_list(scatter_object_output_list: list[Any], scatter_object_input_list: list[Any] | None = ..., src: int | None = ..., group: ProcessGroup | None = ..., group_src: int | None = ...) -> None:
    """
...
@_exception_logger
def all_gather_into_tensor(output_tensor, input_tensor, group=..., async_op=...) -> Any | _IllegalWork | Work | None:
    """
...
@_exception_logger
@deprecated("`torch.distributed.all_gather_coalesced` will be deprecated. If you must use it, " "please revisit our documentation later at " "https://pytorch.org/docs/main/distributed.html#collective-functions", category=FutureWarning)
def all_gather_coalesced(output_tensor_lists, input_tensor_list, group=..., async_op: bool = ...) -> Future[Any] | None:
    """
...
@_exception_logger
def gather(tensor: torch.Tensor, gather_list: list[torch.Tensor] | None = ..., dst: int | None = ..., group: ProcessGroup | None = ..., async_op: bool = ..., group_dst: int | None = ...) -> Work | None:
    """
...
@_exception_logger
def scatter(tensor: torch.Tensor, scatter_list: list[torch.Tensor] | None = ..., src: int | None = ..., group: ProcessGroup | None = ..., async_op: bool = ..., group_src: int | None = ...) -> Work | None:
    """
...
@_exception_logger
def reduce_scatter(output, input_list, op=..., group=..., async_op: bool = ...) -> Work | None:
    """
...
@_exception_logger
def all_to_all_single(output, input, output_split_sizes=..., input_split_sizes=..., group=..., async_op: bool = ...) -> Any | Work | None:
    """
...
@_exception_logger
def all_to_all(output_tensor_list, input_tensor_list, group=..., async_op: bool = ...) -> Work | None:
    """
...
@_exception_logger
def barrier(group: ProcessGroup | None = ..., async_op: bool = ..., device_ids=...) -> Work | None:
    """
...
def monitored_barrier(group: ProcessGroup | None = ..., timeout=..., wait_all_ranks: bool = ...) -> None:
    """
...
@_time_logger
def split_group(parent_pg: ProcessGroup | None = ..., split_ranks: list | None = ..., timeout: timedelta | None = ..., pg_options: Any | None = ..., group_desc: str | None = ...) -> ProcessGroup | None:
    """
...
@_time_logger
def new_group(ranks=..., timeout=..., backend=..., pg_options=..., use_local_synchronization: bool = ..., group_desc=..., device_id: torch.device | None = ...) -> ProcessGroup | Literal[-100] | None:
    """
...
def new_subgroups(group_size=..., group=..., timeout=..., backend=..., pg_options=..., group_desc=...) -> tuple[ProcessGroup | Any | int | None, list[Any]]:
    """
...
def new_subgroups_by_enumeration(ranks_per_subgroup_list, timeout=..., backend=..., pg_options=..., group_desc=...) -> tuple[ProcessGroup | Any | int | None, list[Any]]:
    """
...
SHRINK_ABORT = ...
@_time_logger
def shrink_group(ranks_to_exclude: list[int], group: ProcessGroup | None = ..., shrink_flags: int = ..., pg_options: Any | None = ...) -> ProcessGroup:
    """
