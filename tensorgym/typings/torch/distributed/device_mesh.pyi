...
if not is_available():
    ...
    class DeviceMesh:
        ...
        def __init__(self, device_type: str, mesh: Union[torch.Tensor, ArrayLike] | None = ..., *, mesh_dim_names: tuple[str, ...] | None = ..., backend_override: tuple[BackendConfig, ...] | None = ..., _init_backend: bool = ..., _rank: int | None = ..., _layout: _MeshLayout | None = ..., _rank_map: torch.Tensor | None = ..., _root_mesh: Optional[DeviceMesh] = ...) -> None:
            ...
        ...
        @staticmethod
        def from_group(group: ProcessGroup | list[ProcessGroup], device_type: str, mesh: Union[torch.Tensor, ArrayLike] | None = ..., *, mesh_dim_names: tuple[str, ...] | None = ...) -> DeviceMesh:
            """
    ...
    def init_device_mesh(device_type: str, mesh_shape: tuple[int, ...], *, mesh_dim_names: tuple[str, ...] | None = ..., backend_override: dict[int | str, str | C10dBackend.Options | tuple[str, C10dBackend.Options]] | None = ...) -> DeviceMesh:
        """
