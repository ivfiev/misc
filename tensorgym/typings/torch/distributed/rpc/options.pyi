...
class TensorPipeRpcBackendOptions(_TensorPipeRpcBackendOptionsBase):
    ...
    """
    def __init__(self, *, num_worker_threads: int = ..., rpc_timeout: float = ..., init_method: str = ..., device_maps: dict[str, dict[DeviceType, DeviceType]] | None = ..., devices: list[DeviceType] | None = ..., _transports: list | None = ..., _channels: list | None = ...) -> None:
        ...
