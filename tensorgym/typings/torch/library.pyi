...
from typing import Any, TYPE_CHECKING, TypeVar, Union, overload
from typing_extensions import ParamSpec, deprecated
from torch._library.custom_ops import CustomOpDef, device_types_t
from torch._ops import OpOverload
from torch.types import _dtype

__all__ = ["Library", "impl", "define", "fallthrough_kernel", "impl_abstract", "register_autocast", "register_fake", "register_torch_dispatch", "register_vmap", "get_ctx", "get_kernel", "custom_op", "triton_op", "wrap_triton", "infer_schema"]
_T = TypeVar("_T")
_P = ParamSpec("_P")
_impls: set[str] = ...
_defs: set[str] = ...
...
@overload
def impl(qualname: str, types: str | Sequence[str], func: None = ..., *, lib: Library | None = ...) -> Callable[[Callable[..., object]], None]:
    ...
...
@functools.singledispatch
def impl(qualname: str, types: str | Sequence[str], func: Callable[_P, _T] | None = ..., *, lib: Library | None = ...) -> object:
...
def register_kernel(op: _op_identifier, device_types: device_types_t, func: Callable | None = ..., /, *, lib: Library | None = ...) -> Callable[..., Any] | Callable[[Callable[..., object]], None] | None:
    """Register an implementation for a device type for this operator.
...
def register_autocast(op: _op_identifier, device_type: str, cast_inputs: _dtype, /, *, lib: Library | None = ...) -> Callable[..., Any] | None:
...
def register_fake(op: _op_identifier, func: Callable | None = ..., /, *, lib: Library | None = ..., _stacklevel: int = ..., allow_override: bool = ...) -> Callable[[Callable[..., Any]], Callable[..., Any]] | Callable[..., Any]:
...
def register_autograd(op: _op_identifier, backward: Callable, /, *, setup_context: Callable | None = ..., lib=...) -> None:
...
def register_torch_dispatch(op: _op_identifier, torch_dispatch_class: Any, func: Callable | None = ..., /, *, lib: Library | None = ...) -> Callable[..., Any]:
...
def opcheck(op: torch._ops.OpOverload | torch._ops.OpOverloadPacket | CustomOpDef, args: tuple[Any, ...], kwargs: dict[str, Any] | None = ..., *, test_utils: str | Sequence[str] = ..., raise_exception: bool = ..., atol=..., rtol=...) -> dict[str, str]:
