...
def make_fake_inputs(nn_module, args, kwargs, dynamic_shapes, prefer_deferred_runtime_asserts_over_guards=...) -> tuple[Any | FakeTensorMode, PyTree, PyTree, EqualityConstraint, Signature, Any]:
    """
...
def produce_guards_and_solve_constraints(fake_mode: FakeTensorMode, gm: torch.fx.GraphModule, dynamic_shapes: Union[dict[str, Any], tuple[Any], list[Any], None], equalities_inputs: EqualityConstraint, original_signature: inspect.Signature) -> None:
    """
