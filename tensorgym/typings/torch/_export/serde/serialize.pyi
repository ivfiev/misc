...
from .schema import Argument, ConstantValue, CustomObjArgument, Device, ExportedProgram, Graph, GraphModule, GraphSignature, InputSpec, ModuleCallEntry, ModuleCallSignature, NamedArgument, Node, OutputSpec, RangeConstraint, ScalarType, SymBool, SymFloat, SymFloatArgument, SymInt, SymIntArgument, TensorArgument, TensorMeta
...
_SYM_OPS = ...
if any(isinstance(op, torch._ops.OpOverload) for op in _SYM_OPS):
    ...
@dataclass
...
def is_metadata_matched(config, entry_metadata) -> bool:
    ...

def get_triton_kernel_and_cache_entry(node: torch.fx.Node) -> tuple[Any, Any] | tuple[Any | JITFunction[Any], Any]:
    ...
