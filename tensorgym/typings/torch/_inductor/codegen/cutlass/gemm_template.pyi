...
from ... import ir
from ...ir import Buffer, CUTLASSTemplateBuffer, ChoiceCaller, IRNode, Layout, ReinterpretView
...
class CUTLASSGemmTemplate(CUTLASSTemplate, ABC):
    ...
    @classmethod
    def global_filter_ops(cls, ops: list[cutlass_library.gemm_op.GemmOperation]) -> list[cutlass_library.gemm_op.GemmOperation]:
        """
    ...
    def render(self, kernel: CUTLASSTemplateKernel, op: cutlass_gemm_op.GemmOperation = ..., template_buffer_node: Optional[CUTLASSTemplateBuffer] = ..., epilogue_nodes: Optional[list[BaseSchedulerNode]] = ..., **kwargs) -> str:
        """
...
class CUTLASS3xGemmTemplate(CUTLASSGemmTemplate):
    ...
    def render_gemm_arguments(self, argument_template: str, epilogue_template: str, should_swap_xw: bool, X: IRNode, W: IRNode, Bias: IRNode, Y: IRNode, alpha: float, beta: float, kernel: CUTLASSTemplateKernel, epilogue_args) -> str:
        """
...
class CUTLASS2xGemmTemplate(CUTLASSGemmTemplate):
    ...
    def render_gemm_arguments(self, instance_type: str, argument_template: str, epilogue_template: str, should_swap_xw: bool, X: IRNode, W: IRNode, Bias: IRNode, Meta: IRNode, Y: IRNode, alpha: float, beta: float, kernel: CUTLASSTemplateKernel, epilogue_args) -> str:
        """
        Render the Cutlass CUDA C++ code required for passing arguments to the GEMM operation.
