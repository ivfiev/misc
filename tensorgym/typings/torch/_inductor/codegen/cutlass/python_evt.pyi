...
class CutlassEVTCodegen(CutlassEVTOpsMixIn):
    ...
    @staticmethod
    def ir_to_evt_python_code(cutlass_template_node_name: str, epilogue_nodes: list[BaseSchedulerNode], removed_buffers: OrderedSet[str]) -> tuple[list[str], list[str], dict[str, Any], str]:
        ...
