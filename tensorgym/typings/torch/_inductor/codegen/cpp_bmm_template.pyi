...
class CppBmmTemplate(CppGemmTemplate):
    ...
    def get_options(self, kernel: CppTemplateKernel, template_buffer_node: Optional[ir.CppTemplateBuffer] = ..., flag_template_buffer_has_other_users: Optional[bool] = ..., epilogue_nodes: Optional[list[ir.IRNode]] = ..., **kwargs) -> dict[str, Any]:
        ...
