...
def reduction_combine(reduction_type, var, next_value, helper_val=..., index: Optional[sympy.Symbol] = ..., src_dtype=...) -> str:
    ...
...
class CppOverrides(OpOverrides):
    ...
    def partial_accumulate(self, name: str, reduction_type: str, value: CSEVariable, extra_meta: dict[str, Any]) -> None:
        ...
...
class CppVecKernel(CppKernel):
    ...
    def reduction_combine_vec(self, reduction_type, var, next_value, helper_val=..., index: Optional[sympy.Symbol] = ..., horizontal_reduction: Optional[bool] = ..., src_dtype: Optional[torch.dtype] = ...) -> str:
        ...
...
class CppTile2DKernel(CppVecKernel):
    ...
    def need_vec_transpose(self, index) -> NotImplementedType | bool:
        ...
