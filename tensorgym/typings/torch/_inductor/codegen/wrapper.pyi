...
from .. import ir
from ..ir import ExternKernel, IRNode, ReinterpretView
...
def codegen_reinterpret_view_helper(data) -> tuple[Any, Any, Any, Any, Literal[True]] | tuple[None, None, None, None, Literal[False]] | tuple[Sequence[Expr] | Any, Sequence[Expr] | Any, Expr | Any, dtype | Any, Literal[True]]:
    """
...
class MemoryPlanningState:
    ...
    def comm_buffer_push(self, key: CommBufferReuseKey, item: FreeIfNotReusedLine) -> None:
        ...
...
class PythonWrapperCodegen(CodeGen):
    ...
    def generate_scatter_fallback(self, node: ir.ScatterFallback) -> None:
        ...
    ...
    def codegen_dynamic_select_index(self, node, clamp) -> None:
        ...
    
    def codegen_dynamic_slice_size(self, node) -> None:
        ...
    ...
    def define_subgraph_launcher_fn(self, name: str, subgraph_code) -> None:
        ...
    
    def define_user_defined_triton_kernel(self, kernel, configs, kwargs, restore_value_args, reset_to_zero_args, grids: list[list[Union[int, sympy.Expr]]]) -> tuple[str, dict[str, Any], dict[str, Any], list[Expr] | list[Symbol]]:
        ...
    ...
    def generate_kernel_call(self, kernel_name: str, call_args, *, device=..., triton=..., arg_types=..., raw_keys=..., raw_args=..., triton_meta=..., inductor_meta=..., original_fxnode_name=...) -> None:
        """
    ...
    def write_provenance_debug_handle(self, kernel_name, debug_handle: Optional[int] = ...) -> None:
        ...
    ...
    def write_kernel_context_guard(self, kernel_name: str, node_schedule: Union[Sequence[BaseSchedulerNode], ExternKernel]) -> None:
        ...
    
    def write_kernel_context_guard_begin(self) -> None:
        """
        Mark the beginning of kernel context guard
        """
        ...
    
    def write_kernel_context_guard_end(self) -> None:
        """
...
class SubgraphPythonWrapperCodegen(PythonWrapperCodegen):
    ...
    def get_graph_inputs(self) -> dict[str, Union[ir.TensorBox, ir.TorchBindObject, sympy.Expr, None]]:
        ...
