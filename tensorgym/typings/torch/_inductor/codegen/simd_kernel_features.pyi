...
class SIMDKernelFeatures:
    ...
    """
    def __init__(self, node_schedule: list[NodeScheduleEntry], numel: sympy.Expr, reduction_numel: sympy.Expr = ..., coalesce_analysis: Optional[CoalesceVarAnalysis] = ...) -> None:
        ...
    ...
    def get_reduction_hint(self, tiling_scores: Optional[dict[str, int]] = ...) -> ReductionHint:
        ...
