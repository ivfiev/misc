...
class CppWrapperGpu(CppWrapperCpu):
    ...
    def generate_args_decl(self, code: Union[IndentedBuffer, Self], call_args, arg_types, arg_signatures, is_triton_kernel=..., scratch_spaces: Optional[dict[str, int]] = ...) -> str:
        """
