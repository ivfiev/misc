...
from typing import Any, ClassVar, Generic, NamedTuple, Optional, TYPE_CHECKING, Union
...
class DeviceOpOverrides:
    ...
    def cpp_scratch(self, idx: int, workspace: TritonScratchWorkspace, prefix: Optional[str] = ...) -> Optional[tuple[list[str], str]]:
        ...
...
def register_backend_for_device(device: str, device_scheduling: SchedulingConstructor, device_wrapper_codegen: WrapperConstructor, device_cpp_wrapper_codegen: Optional[WrapperConstructor] = ..., device_fx_wrapper_codegen: Optional[WrapperConstructor] = ..., device_custom_pass: Optional[CustomGraphModulePass] = ..., device_custom_config: Optional[ConfigModule] = ...) -> None:
    ...
...
def get_wrapper_codegen_for_device(device: str, cpp_wrapper: bool = ..., fx_wrapper: bool = ...) -> Optional[WrapperConstructor]:
    ...
...
def check_shape(buffer: IndentedBuffer, var: CSEVariableType, shape: BlockShapeType) -> None:
    ...
...
class KernelArgs:
    ...
    def workspace(self, nelem: sympy.Expr, zero_fill: bool, dtype: torch.dtype = ...) -> tuple[str, str, int]:
        """
...
class CSEVariable:
    ...
    """
    def __init__(self, name: str, bounds: ValueRanges[Any], dtype: Optional[torch.dtype] = ..., shape: BlockShapeType = ...) -> None:
        ...
...
class CSE(Generic[CSEVariableType, AugmentedKeyT]):
    ...
    def generate(self, buffer: IndentedBuffer, expr: Union[str, CSEVariable, OpsValue, IndentedBuffer, DeferredLineBase], *, bounds: ValueRanges[Any] = ..., write: bool = ..., assignment: bool = ..., dtype: Optional[torch.dtype] = ..., shape: BlockShapeType = ...) -> CSEVariableType:
        ...
    
    def newvar(self, bounds: ValueRanges[Any] = ..., dtype: Optional[torch.dtype] = ..., shape: BlockShapeType = ...) -> CSEVariableType:
        ...
    
    def namedvar(self, name: str, bounds: ValueRanges[Any] = ..., dtype: Optional[torch.dtype] = ..., shape: BlockShapeType = ...) -> CSEVariableType:
        ...
...
class Kernel(CodeGen, Generic[CSEVariableType]):
    ...
    def emit_kernel_override(self, wrapper, src_code: str, kernel_name: str, node_schedule, kernel_path: str, get_kernel_metadata) -> bool:
    ...
    def partial_accumulate(self, name: str, reduction_type: ReductionType, value: CSEVariable, extra_meta: dict[str, Any]) -> None:
        ...
...
class KernelTemplate:
    ...
    def __init__(self, name: str, hash: Optional[str] = ...) -> None:
        ...
