...
from ..utils import cache_property_on_self
...
class SIMDKernel(Kernel[CSEVariableType], Generic[CSEVariableType]):
    ...
    kernel_name: str
    def __init__(self, tiling: dict[str, sympy.Expr], features: SIMDKernelFeatures, pid_cache: Optional[dict[str, str]] = ..., override_persistent_reduction: Optional[bool] = ..., override_cooperative_reduction: Optional[bool] = ..., tiling_scores: Optional[dict[str, sympy.Expr]] = ..., mix_order_reduction: bool = ...) -> None:
        ...
    
    def codegen_template_override(self, scheduling, template_node, epilogue_nodes, prologue_nodes, buf_name_to_prologue_group, prologue_preserves_zero_mask_fn, render, only_gen_src_code: bool) -> str | None:
    ...
    def deallocate_workspaces(self) -> None:
        ...
...
class SIMDScheduling(BaseScheduling):
    ...
    def process_kernel(self, kernel: Any, node_schedule: list[NodeScheduleEntry], only_gen_src_code: bool = ...) -> None:
        """
    ...
    def codegen_template(self, template_node, epilogue_nodes, prologue_nodes, *, only_gen_src_code=..., hint_override: Optional[int] = ...) -> Optional[str]:
        """
    ...
    def generate_combo_kernel_code(self, subkernel_nodes: list[BaseSchedulerNode], custom_part_algorithm: bool, enable_autotune: bool, mixed_sizes: bool, only_gen_src_code: bool = ...) -> list[tuple[Optional[str], Any, Any]]:
        """
    ...
    @classmethod
    def create_tiling(cls, pw_tiling: Sequence[sympy.Expr], reduction_tiling: Sequence[sympy.Expr]) -> immutable_dict[str, sympy.Expr]:
        """
    ...
    @classmethod
    def create_partial_tiling(cls, tiling: Sequence[sympy.Expr], is_pointwise: bool) -> immutable_dict[str, sympy.Expr]:
        ...
    
    @classmethod
    def complete_partial_tiling(cls, tiling: dict[str, sympy.Expr], numel: sympy.Expr, reduction_numel: sympy.Expr) -> immutable_dict[str, sympy.Expr]:
        """
    ...
    def generate_kernel_code_from_nodes(self, nodes, benchmark_kernel=..., hint_override: Optional[int] = ...) -> str | Any:
        ...
...
class CantSplit(Exception):
    def __init__(self, expr, remaining) -> None:
        ...
