...
class HalideCSEVariable(CSEVariable):
    undefined_re = ...
    def __init__(self, name, bounds: ValueRanges[Any], dtype: Optional[torch.dtype] = ..., shape: BlockShapeType = ...) -> None:
        ...
...
class HalideKernel(SIMDKernel):
    ...
    def call_kernel(self, name: str, node=..., deallocate_ws: bool = ...) -> None:
