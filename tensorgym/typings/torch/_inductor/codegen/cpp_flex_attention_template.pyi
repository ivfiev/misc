...
class CppFlexAttentionTemplate(CppTemplate):
    ...
    @staticmethod
    def add_choices(choices, input_nodes, layout, scale, score_mod, mask_mod, kv_block_size, q_block_size, has_other_buffer, no_full_kv_block, fake_buffers, len_score_other, len_mask_other, kernel_input_name_to_buffer, block_vars) -> DataProcessorTemplateWrapper:
        ...
    
    def apply_score_mod(self, score, b, h, q_idx, kv_idx):
        ...
    
    def render(self, kernel, template_buffer_node: Optional[ir.CppTemplateBuffer] = ..., epilogue_nodes: Optional[list[ir.IRNode]] = ..., **kwargs) -> str:
        ...
