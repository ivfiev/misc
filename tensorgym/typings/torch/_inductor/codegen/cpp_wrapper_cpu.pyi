...
class CppWrapperCpu(PythonWrapperCodegen):
    ...
    def codegen_write_arg_with_large_length_string(self, arg_name: str, arg_str_val: str, max_truncate_length: int = ...) -> None:
        ...
    ...
    def generate_c_shim_extern_kernel_call(self, kernel: str, args: list[str], device: str, *, debug_args: Optional[list[str]] = ..., stack_traces: Optional[OrderedSet[str]] = ...) -> None:
