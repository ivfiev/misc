...
from .. import ir
from ..cpu_vec_isa import VecAMX, VecAVX2, VecAVX512, VecAVX512VNNI, VecISA, VecNEON, VecSVE256
...
@register_micro_gemm(*generate_gemm_config(VecAVX512VNNI, [(6, 64, 4)], input_dtype=torch.uint8, input2_dtype=torch.int8, output_dtype=torch.int32, compute_dtype=torch.int32, extra_check=check_vnni_extra))
class CppMicroGemmAVX512VNNI(CppMicroGemm):
    ...
    def get_b_layout(self) -> Literal[LayoutType.VNNI4]:
        ...
