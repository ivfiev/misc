...
class PersistentCache(CacheBase):
    def lookup(self, choices: list[ChoiceCaller], op: str, inputs: str, benchmark: Callable[[Any], dict[ChoiceCaller, float]] | None, hint_override: int | None = ...) -> dict[ChoiceCaller, float]:
        """
...
def write(content: str | bytes, extension: str, extra: str = ..., hash_type: str = ..., specified_dir: str = ..., key: str | None = ...) -> tuple[str, str]:
    ...
...
class GuardedCache(Generic[T]):
    ...
    """
    @classmethod
    def iterate_over_candidates(cls: type[GuardedCache[T]], local: bool, remote_cache: RemoteCache[JsonDataTy] | None, key: str) -> Generator[tuple[T, bytes, bool], None, None]:
        ...
...
class FxGraphCache(GuardedCache[CompiledFxGraph]):
    ...
    @staticmethod
    def load_with_key(key: str, debug_lines: list[str], example_inputs: Sequence[InputType], local: bool, remote_cache: RemoteCache[JsonDataTy] | None, is_backward: bool, constants: CompiledFxGraphConstants, evaluate_guards: Callable[[str, list[int] | list[torch.SymInt]], bool] | None = ...) -> tuple[CompiledFxGraph | None, dict[str, Any]]:
        """
...
class CudaKernelParamCache:
    ...
    cache_clear = ...
    @classmethod
    def set(cls, key: str, params: dict[str, str | None], cubin: str, bin_type: str, asm: str | None = ..., asm_type: str | None = ...) -> None:
        ...
...
class AotCodeCompiler:
    ...
    """
    @classmethod
    def compile(cls, graph: GraphLowering, wrapper_code: str, kernel_code: str, serialized_extern_kernel_nodes: str | None, *, device_type: str, additional_files: list[str]) -> list[Union[str, Weights]] | str:
        """
...
class CppCodeCache:
    ...
    @classmethod
    def load_async(cls, main_code: str, device_type: str = ..., submit_fn: Any = ..., extra_flags: Sequence[str] = ..., optimized_code: str | None = ...) -> Any:
...
class CppPythonBindingsCodeCache(CppCodeCache):
    ...
    suffix_template = ...
    @classmethod
    def load_pybinding_async(cls, argtypes: Sequence[str], main_code: str, device_type: str = ..., num_outputs: int = ..., submit_fn: Any = ..., extra_flags: Sequence[str] = ..., kernel_code: str | None = ...) -> Any:
        """
...
class PyCodeCache:
    ...
    @classmethod
    def load_by_key_path(cls, key: str, path: str, linemap: list[tuple[int, str]] | None = ..., attrs: dict[str, Any] | None = ...) -> ModuleType:
        ...
