...
@functools.cache
def get_promoted_dtype(*args: Sequence[tuple[torch.dtype, bool]], type_promotion_kind: Optional[ELEMENTWISE_TYPE_PROMOTION_KIND] = ...):
    ...

def promote_types(args: Sequence[DTypeArg], type_promotion_kind: Optional[ELEMENTWISE_TYPE_PROMOTION_KIND] = ...):
    ...
...
class DtypePropagationOpsHandler:
    ...
    """
    _instance: Optional[DtypePropagationOpsHandler] = ...
    ...
    @staticmethod
    def to_dtype(x: DTypeArg, dtype: torch.dtype, src_dtype: Optional[torch.dtype] = ..., use_compute_types=...) -> torch.dtype:
        ...
    ...
    @staticmethod
    def store(name: str, index, value: DTypeArg, mode: Optional[str] = ...) -> None:
        ...
    
    @staticmethod
    def partial_accumulate(name: str, reduction_type: str, value: DTypeArg, extra_meta: dict[str, Any]) -> None:
        ...
    ...
    @staticmethod
    def bucketize(values: DTypeArg, boundaries: tuple[str, sympy.Expr, sympy.Expr, sympy.Expr], boundary_indices: DTypeArg, indexing_dtype: torch.dtype, right: bool, sorter: Optional[tuple[str, sympy.Expr]] = ..., sorter_indices: Optional[T] = ...) -> torch.dtype:
        ...
