...
class QConvPointWisePT2E(ExternKernelAlloc):
    ...
    @classmethod
    def create(cls, qx: TensorBox, x_scale: TensorBox, x_zero_point: TensorBox, qw: TensorBox, w_scale: TensorBox, w_zero_point, bias: TensorBox, stride: list[int], padding: list[int], dilation: list[int], groups: int, output_scale: float, output_zero_point: int, output_dtype, attr, scalars, algorithm) -> QConvPointWisePT2E:
        ...
