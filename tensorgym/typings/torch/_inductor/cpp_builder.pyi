...
def get_mmap_self_macro(use_mmap_weights: bool, use_mmap_weights_external: bool) -> list[str]:
    ...

def get_caching_allocator_macro() -> list[str]:
    ...

def get_cpp_torch_options(cpp_compiler: str, vec_isa: VecISA, include_pytorch: bool, aot_mode: bool, use_relative_path: bool, use_mmap_weights: bool, use_mmap_weights_external: bool) -> tuple[list[str], list[str], list[str], list[str], list[str], list[str], list[str]]:
    """
...
class CppTorchOptions(CppOptions):
    ...
    5. MISC
    """
    def __init__(self, vec_isa: VecISA = ..., include_pytorch: bool = ..., warning_all: bool = ..., aot_mode: bool = ..., compile_only: bool = ..., use_relative_path: bool = ..., use_mmap_weights: bool = ..., use_mmap_weights_external: bool = ..., shared: bool = ..., extra_flags: Sequence[str] = ..., compiler: str = ..., min_optimize: bool = ..., precompiling: bool = ..., preprocessing: bool = ...) -> None:
        ...
...
class CppTorchDeviceOptions(CppTorchOptions):
    ...
    """
    def __init__(self, vec_isa: VecISA = ..., include_pytorch: bool = ..., device_type: str = ..., aot_mode: bool = ..., compile_only: bool = ..., use_relative_path: bool = ..., use_mmap_weights: bool = ..., use_mmap_weights_external: bool = ..., shared: bool = ..., extra_flags: Sequence[str] = ..., min_optimize: bool = ..., precompiling: bool = ..., preprocessing: bool = ...) -> None:
        ...
