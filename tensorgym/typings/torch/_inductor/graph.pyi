...
def extend_user_visible_output_strides(user_visible_outputs: dict[Node, tuple[int, ...]]) -> dict[Node, object]:
    """
...
class GraphLowering(torch.fx.Interpreter):
    ...
    def get_dep_size_hint(self, dep: Dep, count_bytes: bool = ...) -> int:
        """
    ...
    def get_attr(self, target: str, args: tuple[()], kwargs: dict[str, object]) -> Union[Constant, TensorBox, ShapeAsConstantBuffer, ir.Subgraph, TorchBindObject]:
        ...
