...
def pre_grad_passes(gm: torch.fx.GraphModule, example_inputs: Sequence[object] = ..., add_passes: str | None = ..., remove_passes: str | None = ...) -> torch.fx.GraphModule:
    """
