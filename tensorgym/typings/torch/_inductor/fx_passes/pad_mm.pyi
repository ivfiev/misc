...
def realize_symbols(ds: torch.Size | tuple[torch.SymInt, ...]) -> list[int]:
    """Helper to convert symbolic dimensions to their concrete hint values."""
    ...

def can_pad(mat1: Tensor, mat2: Tensor, op: torch._ops.OpOverloadPacket, input: Tensor | None = ...) -> bool:
    """
...
def pad_addmm(input: Tensor | None, mat1: Tensor, mat2: Tensor, m_padded_length: int, k_padded_length: int, n_padded_length: int, beta: float = ..., alpha: float = ..., mat1_pre_padded: bool = ..., mat2_pre_padded: bool = ...) -> Tensor:
    ...

def addmm_replace(input: Tensor | None, mat1: Tensor, mat2: Tensor, beta: float = ..., alpha: float = ...) -> Tensor:
    ...
...
def should_pad_bench_key(match: Match, mat1: Tensor, mat2: Tensor, op: torch._ops.OpOverloadPacket, input: Tensor | None = ..., is_base_time_key: bool = ...) -> str:
    ...
...
def should_pad(match: Match, mat1: Tensor, mat2: Tensor, op: torch._ops.OpOverloadPacket, input: Tensor | None = ...) -> bool:
    ...
