...
def call_function(graph: fx.Graph, target: str | Callable[..., Any], args: tuple[fx.node.Argument, ...] | None = ..., kwargs: dict[str, fx.node.Argument] | None = ...) -> fx.Node:
    ...
...
def get_all_comm_blocks(graph: fx.Graph, comm_ops: tuple[torch._ops.OpOverload, ...], comm_filter: Callable[..., bool] | None = ...) -> list[CommBlock]:
    ...
