...
from .static_triton_launcher import StaticallyLaunchedCudaKernel, StaticallyLaunchedXpuKernel
...
if TYPE_CHECKING:
    LauncherType = Any
_KernelType = Union[CompiledKernel, StaticallyLaunchedCudaKernel, StaticallyLaunchedXpuKernel]
...
class CachingAutotuner(KernelInterface):
    ...
    """
    def __init__(self, fn, triton_meta, configs, save_cache_hook, mutated_arg_names: list[str], optimize_mem, heuristic_type, size_hints=..., inductor_meta=..., custom_kernel=..., filename: str | None = ..., reset_to_zero_arg_names: list[str] | None = ..., autotune_cache_info: dict[str, Any] | None = ...) -> None:
        ...
    ...
    def precompile(self, warm_cache_only=..., reload_kernel: Callable[[], CachingAutotuner] | None = ..., static_triton_bundle_key: str | None = ...) -> None:
        ...
...
class StaticTritonCompileResult(CompileResult[_T]):
    ...
    """
    @staticmethod
    def can_statically_launch(kernel: CompiledKernel, inductor_meta: dict[str, Any], triton_meta: dict[str, Any], heuristic_type: HeuristicType) -> _KernelType | None:
        ...
...
def cached_autotune(size_hints: list[int] | None, configs: list[Config], triton_meta, heuristic_type, filename=..., inductor_meta=..., custom_kernel=..., caching_autotuner_cls: type[CachingAutotuner] = ..., debug_autotuner_cls: type[DebugAutotuner] = ...) -> Callable[..., DebugAutotuner | CachingAutotuner]:
    """
...
def triton_config(size_hints, x, y=..., z=..., num_stages=..., num_elements_per_warp=..., min_elem_per_thread=..., num_warps=..., matrix_instr=..., waves_per_eu=...) -> Config:
    """
...
def triton_config_reduction(size_hints, x: int, r: int, num_stages=..., num_warps=..., register_intensive=..., waves_per_eu=..., dynamic_scale_rblock=..., reduction_hint=..., min_num_warps=...) -> Config:
    """
...
def triton_config_tiled_reduction(size_hints, x, y, r, num_stages=..., register_intensive=..., waves_per_eu=...) -> object:
    """
...
def pointwise(size_hints, triton_meta, tile_hint=..., filename=..., min_elem_per_thread=..., inductor_meta=..., return_configs=...) -> Callable[..., DebugAutotuner | CachingAutotuner] | list[object] | list[Any]:
    """
    Construct @triton.heuristics() based on size_hints.
    """
    ...

def make_matmul_triton_config(sizes: dict[str, int], num_warps: int, num_stages: int) -> object:
    ...
...
def match_target_block_product(size_hints, tiling_scores, target_block_product, min_block_size=..., min_red_block: int | None = ...) -> dict[Any, Any]:
    """
...
def adapt_config_for_tiling(size_hints, tiling_scores, original_x, original_r, num_warps=..., num_stages=..., register_intensive=..., persistent_reduction=..., waves_per_eu=...) -> Config:
    """
...
def filter_reduction_configs_for_determinism(inductor_meta: dict[str, Any], configs: list[Config]) -> list[Config]:
    """
...
def reduction(size_hints, reduction_hint=..., triton_meta=..., filename=..., inductor_meta=..., return_configs=...) -> Callable[..., DebugAutotuner | CachingAutotuner] | list[Any]:
...
def persistent_reduction(size_hints, reduction_hint=..., triton_meta=..., filename=..., inductor_meta=..., return_configs=...) -> Callable[..., DebugAutotuner | CachingAutotuner] | list[Any]:
...
def template(num_stages, num_warps, triton_meta, num_consumer_groups=..., num_buffers_warp_spec=..., filename=..., inductor_meta=..., **kwargs) -> Callable[..., DebugAutotuner | CachingAutotuner]:
    """
...
def foreach(triton_meta, filename=..., inductor_meta=...) -> Callable[..., DebugAutotuner | CachingAutotuner]:
    """
...
class GridExpr:
    ...
    @staticmethod
    def from_meta(inductor_meta: dict[str, Any], cfg: Config | dict[str, int], mode: Literal["python", "cpp"] = ...) -> GridExpr:
        ...
