...
class StaticallyLaunchedCudaKernel(StaticallyLaunchedTritonKernel):
    @cached_property
    def C_impl(self) -> type[_StaticCudaLauncher]:
        ...
...
class StaticallyLaunchedXpuKernel(StaticallyLaunchedTritonKernel):
    @cached_property
    def C_impl(self) -> type[_StaticXpuLauncher]:
        ...
...
def statically_launched_kernel_by_device(kernel: CompiledKernel, device_type: str = ...) -> StaticallyLaunchedTritonKernel:
    ...
