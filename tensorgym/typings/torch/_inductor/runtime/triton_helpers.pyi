...
from .triton_compat import JITFunction, tl, triton
...
@triton.jit
def minimum_with_index(a_value, a_index, b_value, b_index) -> tuple[Any, Any]:
    ...

@triton.jit
def maximum_with_index(a_value, a_index, b_value, b_index) -> tuple[Any, Any]:
    ...
...
@triton.jit
def online_softmax_reduce(lhs_max, lhs_sum, dim, use_fast_math: tl.constexpr) -> tuple[Any, Any]:
    ...

@triton.jit
def online_softmax_combine(lhs_max, lhs_sum, rhs_max, use_fast_math: tl.constexpr) -> tuple[Any, Any]:
    """
...
@triton.jit
def welford_reduce(value, mean, m2, weight, first_iteration) -> tuple[Any, Any, Any]:
    ...

@triton.jit
def welford_combine(mean_1, m2_1, weight_1, mean_2, m2_2, weight_2) -> tuple[Any, Any, Any]:
    ...
...
@triton.jit
def exclusive_scan_decoupled_lookback(scratch_base, block_value, index, combine_fn, DTYPE_VALUE_AS_UINT: tl.constexpr, DTYPE_PACK: tl.constexpr) -> Any:
...
@triton.jit
def sort_with_index(x, idxs, rnumel, dim: tl.constexpr = ..., stable: tl.constexpr = ..., descending: tl.constexpr = ...) -> tuple[Any, Any]:
    ...
