...
class AutotuneCache:
    ...
    def save(self, config: Config, time_taken_ns: int, found_by_coordesc: bool = ..., triton_cache_hash: str | None = ...) -> None:
        ...
...
class AutotuneCacheBundler:
    ...
    @classmethod
    def begin_compile(cls, inductor_meta: _InductorMetaTy, *, code: str | None = ..., code_hash: str | None = ...) -> None:
        ...
