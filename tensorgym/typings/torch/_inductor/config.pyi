...
from torch.utils._config_module import inherit_fields_from
...
bucket_all_gathers_fx_bucket_size_determinator: Optional[Callable[[int], int]] = ...
bucket_reduce_scatters_fx: Literal["none", "all"] = ...
bucket_reduce_scatters_fx_bucket_size_determinator: Optional[Callable[[int], int]] = ...
bucket_all_reduces_fx: Literal["none", "all"] = ...
bucket_all_reduces_fx_bucket_size_determinator: Optional[Callable[[int], int]] = ...
estimate_op_runtime = ...
...
max_autotune_allow_flexible_layouts: bool = ...
force_same_precision: bool = ...
multi_kernel_hints: list[int] = ...
max_autotune_gemm_backends = ...
nvgemm_max_profiling_configs: Optional[int] = ...
...
fallback_by_default: bool = ...
selective_decompose: bool = ...
use_dce: bool = ...
use_pre_grad_passes: bool = ...
use_joint_graph_passes: bool = ...
use_post_grad_passes: bool = ...
...
collective_benchmark_nruns = ...
collective_benchmark_timeout = ...
...
partitioned_scatter_min_partitions: int = ...
partitioned_scatter_max_partitions: int = ...
partitioned_scatter_memory_budget: float = ...
class _collective:
    auto_select: bool = ...
...
class aten_distributed_optimizations:
    ...
    enable_overlap_scheduling: bool = ...
    collective_bucketing: Optional[bool] = ...
    insert_overlap_deps: Optional[bool] = ...
    max_compute_pre_fetch: Optional[int] = ...
    compute_overlap_multipler: Optional[float] = ...
    ...
    max_memory_increase_gb: Optional[float] = ...
    max_memory_increase_ratio: Optional[float] = ...
    max_in_flight_gb: Optional[float] = ...
    max_coll_distance: Optional[int] = ...
    log_final_collectives_estimations: bool = ...
    bucket_exposed_first: bool = ...
    enable_fusion_regions: Optional[bool] = ...
    prioritize_bucketing_during_scheduling: bool = ...
...
_use_fp64_for_unbacked_floats: bool = ...
_profile_var = ...
profile_bandwidth = ...
...
wrap_inductor_compiled_regions: bool = ...
assume_aligned_inputs: bool = ...
assume_32bit_indexing: bool = ...
...
class auto_chunker:
    enable: bool = ...
    output_size_threshold: int = ...
    amplify_ratio_threshold: int = ...
    num_chunk: int | None = ...
...
class triton:
    ...
    reorder_for_reducing_graph_partitions: bool = ...
    ...
    enable_pdl = ...
    mix_order_reduction = ...
    mix_order_reduction_initial_xblock = ...
    mix_order_reduction_split_size: Optional[int] = ...
    ...
    max_kernel_dump_occurrences = ...
    proton_profiling: bool = ...
    proton_output_dir: Optional[str] = ...
...
class aot_inductor:
    ...
    package_constants_on_disk_format: Optional[str] = ...
    precompile_headers: bool = ...
    embed_kernel_binary: Optional[bool] = ...
    emit_multi_arch_kernel: Optional[bool] = ...
    ...
    enable_lto = ...
    link_libtorch: bool = ...
    cross_target_platform: Optional[str] = ...
    aoti_shim_library: Optional[str | list[str]] = ...
    aoti_shim_library_path: Optional[str] = ...
...
class cutlass:
    ...
    cutlass_dynamic_cluster_shape: tuple[int, int, int] = ...
    cutlass_dynamic_cluster_fallback: tuple[int, int, int] = ...
...
cpu_backend: Literal["cpp", "triton", "halide", "pallas"] = ...
cuda_backend: Literal["triton", "halide", "pallas"] = ...
tpu_backend: Literal["pallas"] = ...
xpu_backend: Literal["triton"] = ...
class halide:
    cpu_target = ...
    gpu_target = ...
...
class lookup_table:
    table: Optional[dict[str, list[dict[str, Any]]]] = ...
    check_src_hash: bool = ...
...
class test_configs:
    ...
    track_memory_lifecycle: Optional[Literal["assert", "log"]] = ...
    use_libtorch = ...
    assume_bucketing_reduces_latency: bool = ...
    force_filter_reduction_configs = ...
    distort_benchmarking_result = ...
    bisect_pre_grad_graph = ...
    bisect_keep_custom_backend_for_inductor = ...
