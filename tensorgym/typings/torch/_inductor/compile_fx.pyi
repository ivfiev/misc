...
if TYPE_CHECKING or not config.is_fbcode():
    ...
    ...
if TYPE_CHECKING:
    CompileFxOutput = Union[Callable[[list[object]], Sequence[torch.Tensor]], str, list[str], Weights,]
...
def compile_fx_aot(model_: GraphModule, example_inputs_: list[InputType], inner_compile: _CompileFxCallable = ..., config_patches: Optional[dict[str, Any]] = ...) -> Union[list[Union[str, Weights]], str, GraphModule]:
    ...
...
def partition_fn(gm: GraphModule, joint_inputs: Sequence[object], **kwargs: object) -> tuple[GraphModule, GraphModule]:
    ...
...
def compile_fx_forward(gm: GraphModule, example_inputs: Sequence[InputType], num_orig_model_outputs: int, num_example_inputs: int, compiler_config_extra: CompilerConfigExtra, inner_compile: Callable[..., OutputCode] = ..., is_inference: bool = ...) -> OutputCode:
    """
...
def compile_fx_backward(gm: GraphModule, example_inputs: Sequence[InputType], compiler_config_extra: CompilerConfigExtra, inner_compile: Callable[..., OutputCode] = ...) -> OutputCode:
    """
...
def compile_fx(model_: GraphModule, example_inputs_: Sequence[InputType], inner_compile: Callable[..., OutputCode] = ..., config_patches: Optional[dict[str, Any]] = ..., decompositions: Optional[dict[OpOverload, Callable[..., Any]]] = ..., ignore_shape_env: bool = ...) -> CompileFxOutput:
    """
