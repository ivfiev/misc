...
class AsyncCompile:
    ...
    """
    _ready_future: Optional[Future[Any]] = ...
    ...
    def pallas(self, kernel_name: str, source_code: str) -> PallasKernelWrapper | LambdaFuture:
        """
    ...
    def nv_universal_gemm(self, kernel_name: str, source_code: str) -> NVUniversalGemmKernelWrapper | LambdaFuture:
        """
