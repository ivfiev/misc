...
log = ...
GRAPH_EXECUTION_ORDER: Optional[list[dict[str, object]]] = ...
RECORD_GRAPH_EXECUTION: bool = ...
GRAPH_COMPILE_IDS: Optional[dict[int, Optional[str]]] = ...
ir_pre_fusion_log = ...
ir_post_fusion_log = ...
...
save_args_cnt = ...
def create_mapping_pre_post_grad_nodes(pre_grad_graph_id: Optional[int], post_to_pre_grad_nodes_json: dict[str, Any]) -> dict[str, dict[str, list[str]]]:
    """
...
def create_node_mapping_kernel_to_post_grad(triton_kernel_to_post_grad_json: dict[str, Any]) -> dict[str, dict[str, Any]]:
...
def set_kernel_post_grad_provenance_tracing(node_schedule: Union[Sequence[BaseSchedulerNode], ExternKernel], kernel_name: str, is_extern: bool = ...) -> Optional[int]:
    """
