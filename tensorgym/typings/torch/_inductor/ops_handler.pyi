...
import sympy
import torch
from typing import Any, Generic, Literal, NamedTuple, Optional, TYPE_CHECKING, TypeVar, Union
...
if TYPE_CHECKING:
    ...
T = TypeVar("T")
AtomicMode = Literal["atomic_add", "atomic_max", "atomic_min", "atomic_and", "atomic_or", "atomic_xor", "atomic_cas", "atomic_xchg",]
StoreMode = Optional[Union[AtomicMode, Literal["tma"]]]
ReductionType = Literal["argmax", "argmin", "welford_reduce", "welford_combine", "any", "max", "min", "prod", "sum", "dot", "xor_sum", "online_softmax_reduce",]
class OpsHandler(Generic[T]):
    ...
    def to_dtype(self, x: T, dtype: torch.dtype, src_dtype: Optional[torch.dtype] = ..., use_compute_types: bool = ...) -> T:
        """
    ...
    def reduction(self, dtype: torch.dtype, src_dtype: torch.dtype, reduction_type: ReductionType, value: T) -> Union[T, tuple[T, ...]]:
        """
    ...
    def partial_accumulate(self, name: str, reduction_type: ReductionType, value: T, extra_meta: dict[str, Any]) -> None:
        ...
    ...
    def inline_asm_elementwise(self, *inputs: T, asm: str, constraints: Optional[str] = ..., dtype: torch.dtype = ..., is_pure: bool = ..., pack: int = ...) -> T:
        ...
...
class KernelFormatterHandler(DefaultHandler):
    ...
    def reduction(self, dtype: torch.dtype, src_dtype: torch.dtype, reduction_type: ReductionType, value: Union[str, tuple[str, ...]]) -> Union[str, tuple[str, ...]]:
        ...
...
class OpCounterCSE(DefaultHandler):
    ...
    def indirect_indexing(self, *args, **kwargs) -> Expr:
        ...
