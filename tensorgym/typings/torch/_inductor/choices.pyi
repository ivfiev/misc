...
class InductorChoices:
    ...
    def get_ktc(self, kernel_inputs: KernelInputs, template: Union[KernelTemplate, ExternKernelChoice], op_name: str, kwarg_overrides: Optional[dict[str, Any]] = ...) -> Generator[KernelTemplateChoice, None, None]:
        """
    ...
    def get_template_configs(self, kernel_inputs: KernelInputs, templates: list[Union[KernelTemplate, ExternKernelChoice]], op_name: str, kwarg_overrides: Optional[dict[str, dict[str, Any]]] = ...) -> list[ChoiceCaller]:
        """
