...
log = ...
def compile(gm: torch.fx.GraphModule, example_inputs: list[InputType], options: Optional[dict[str, Any]] = ...) -> CompileFxOutput:
    """
...
def aot_compile(gm: torch.fx.GraphModule, args: tuple[Any, ...], kwargs: Optional[dict[str, Any]] = ..., *, options: Optional[dict[str, Any]] = ...) -> Union[str, list[Union[str, Weights]], torch.fx.GraphModule]:
    """
...
def standalone_compile(gm: torch.fx.GraphModule, example_inputs: list[InputType], *, dynamic_shapes: Literal["from_example_inputs", "from_tracing_context", "from_graph"] = ..., options: Optional[dict[str, Any]] = ..., aot: bool = ...) -> CompiledArtifact:
    """
