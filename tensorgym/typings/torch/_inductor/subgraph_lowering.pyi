...
class PointwiseSubgraphLowering(torch.fx.Interpreter):
    ...
    def __init__(self, gm: torch.fx.GraphModule, root_graph_lowering: GraphLowering, allowed_mutations: Optional[OrderedSet[OpOverload]] = ..., additional_lowerings: Optional[LoweringDict] = ...) -> None:
        ...
