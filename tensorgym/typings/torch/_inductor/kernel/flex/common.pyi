...
from ...ir import ComputedBuffer, IRNode, Subgraph, TensorBox
...
def get_fwd_subgraph_outputs(subgraph_buffer: SubgraphResults, mask_graph_buffer: SubgraphResults) -> list[Optional[ComputedBuffer]]:
    ...

def build_subgraph_module_buffer(args: list[TensorBox], graph_module: torch.fx.GraphModule) -> SubgraphResults:
...
def create_placeholder(name: str, dtype: torch.dtype, device: torch.device, size: Optional[list[int]] = ...) -> TensorBox:
    """Creates a placeholder input buffers for producing subgraph_output."""
    ...

def construct_strides(sizes: Sequence[_IntLike], fill_order: Sequence[int]) -> Sequence[_IntLike]:
    """From a list of sizes and a fill order, construct the strides of the permuted tensor."""
    ...

def infer_dense_strides(size: Sequence[_IntLike], orig_strides: Sequence[_IntLike]) -> Sequence[_IntLike]:
