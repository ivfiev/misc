...
def find_broadcast_var(index: sympy.Expr, var_ranges: dict[sympy.Expr, int]) -> Optional[sympy.Expr]:
    """
...
def get_score(addr: sympy.Expr, var_ranges: dict[sympy.Symbol, int], buf_names: OrderedSet[str]) -> int:
    """
