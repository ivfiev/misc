...
class SizeVarAllocator:
    ...
    def symbolic_hint(self, expr: Union[Expr, int], use_user_provided_hint_override: bool = ...) -> Union[Expr, int]:
        ...
    ...
    def to_symints_or_ints(self, exprs: Sequence[Union[Expr, int]]) -> list[Union[SymInt, int]]:
    ...
    def optimization_hint(self, expr: Union[Expr, int], fallback: Optional[int] = ...) -> int:
        """
    ...
    def optimization_hints(self, exprs: Iterable[Union[Expr, int]], fallback: Optional[int] = ...) -> tuple[int, ...]:
        """
    ...
    def optimization_hint_with_override(self, expr: Union[Expr, int], hint_override: Optional[int]) -> int:
    ...
    def optimization_hints_with_override(self, exprs: Iterable[Union[Expr, int]], hint_override: Optional[int]) -> tuple[int, ...]:
        """
