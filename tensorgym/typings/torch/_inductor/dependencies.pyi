...
class _RecordLoadStoreInner(V.MockHandler):
    ...
    def store(self, name: str, index: sympy.Expr, value: str, mode: Optional[str] = ...) -> None:
        ...
...
def index_vars_squeeze(*argsizes: Sequence[sympy.Expr], prefix: str = ...) -> tuple[list[Sequence[sympy.Expr]], VarRanges]:
    ...
