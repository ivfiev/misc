...
def linear_dynamic_fp16_unpacked_weight(input: torch.Tensor, weight: torch.Tensor, bias: Optional[torch.Tensor] = ...) -> torch.Tensor:
    ...
...
def bucketize_scalar(self: torch.types.Number, boundaries: torch.Tensor, *, out_int32: bool = ..., right: bool = ...) -> torch.Tensor:
    ...
...
def conv1d_to_conv2d(input: torch.Tensor, weight: torch.Tensor, bias: Optional[torch.Tensor] = ..., stride: tuple[int] = ..., padding: tuple[int] = ..., dilation: tuple[int] = ..., groups: int = ...) -> torch.Tensor:
    ...
