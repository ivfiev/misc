...
from .ir import ComputedBuffer, GraphPartitionSignature
...
class FusionResult:
    ...
    callable_fn: Optional[Callable[[], bool]] = ...
    ...
    @classmethod
    def from_callable(cls, callable_fn: Callable[[], bool], future: Optional[LambdaFuture] = ...) -> FusionResult:
        ...
...
class MixOrderReduction:
    ...
    @classmethod
    def has_mix_reduction_orders(cls, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> bool:
        ...
    
    @classmethod
    def get_common_read(cls, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> list[str]:
        ...
    
    @classmethod
    def has_common_read(cls, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> bool:
        ...
    ...
    @classmethod
    def get_fusion_score(cls, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> int:
        ...
    ...
    @classmethod
    def are_mix_order_reductions(cls, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> bool:
        ...
...
class BaseSchedulerNode:
    ...
    override_estimated_runtime: Optional[float] = ...
...
class SchedulerNode(BaseSchedulerNode):
    ...
    _body: LoopBody
    def __init__(self, scheduler: Scheduler, node: Union[ir.ComputedBuffer, ir.TemplateBuffer]) -> None:
        ...
    
    def recompute_size_and_body(self, extra_indexing_constraints: Optional[tuple[dict[Any, Any], list[Any]]] = ..., recompute_sizes_body_func: Optional[Callable[..., Any]] = ...) -> None:
        ...
...
def refresh_group_node_dependencies(group_snode: Union[FusedSchedulerNode, GroupedSchedulerNode]) -> None:
    ...

def init_group_node(group_snode: Union[FusedSchedulerNode, GroupedSchedulerNode], scheduler: Scheduler, snodes: list[BaseSchedulerNode]) -> None:
    ...
...
class FusedMixOrderReductions(FusedSchedulerNode):
    ...
    def sub_node_can_fuse(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, other_nodes: tuple[BaseSchedulerNode, ...]) -> bool:
        """
    ...
    def fuse_with(self, other: BaseSchedulerNode) -> FusedMixOrderReductions:
        ...
...
class ForeachKernelSchedulerNode(FusedSchedulerNode):
    ...
    def __init__(self, scheduler: Scheduler, snodes: list[BaseSchedulerNode], use_custom_partition_algo: bool, prev_node_1: Optional[BaseSchedulerNode] = ..., prev_node_2: Optional[BaseSchedulerNode] = ..., enable_autotune: bool = ...) -> None:
        ...
...
def pick_loop_order(stride_lengths: list[list[int]], sizes: Sequence[sympy.Expr], priority_idx: Sequence[int] = ...) -> list[int]:
    """
...
def get_scheduler_node_symbol_uses(node: BaseSchedulerNode) -> OrderedSet[sympy.Symbol]:
    """
...
def is_epilogue_fusion(node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> bool:
    ...

def is_prologue_fusion(node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> bool:
    ...

def is_template_fusion(node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> bool:
    ...

def template_fusion_pw_node(node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> BaseSchedulerNode:
    ...
...
class Scheduler:
    ...
    def generate_kernel_code_from_nodes(self, nodes: Sequence[BaseSchedulerNode], benchmark_kernel: bool, hint_override: Optional[int] = ...) -> str:
        """
        Benchmark fused list of nodes and return the execution time
        in milliseconds on randomly generated inputs.
        """
    ...
    def compile_kernel(self, nodes: Sequence[BaseSchedulerNode], hint_override: Optional[int] = ...) -> tuple[Optional[LambdaFuture], ModuleType]:
        ...
    
    def speedup_by_fusion(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> FusionResult:
        """
    ...
    def fuse_two_nodes(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, fused_nodes: OrderedSet[BaseSchedulerNode]) -> BaseSchedulerNode:
        ...
    
    def fuse_if_speedup(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, speedup_fn: Callable[[], bool], fused_nodes: OrderedSet[BaseSchedulerNode]) -> bool:
        ...
    
    def fuse_nodes_once(self, nodes: list[BaseSchedulerNode], is_reorder_round: bool) -> list[BaseSchedulerNode]:
        """
        Combine eligible nodes into FusedSchedulerNodes.
    ...
    def create_combo_kernel_nodes(self, num_ck_nodes: Optional[int] = ...) -> None:
        """
    ...
    def get_possible_fusions(self, nodes: list[BaseSchedulerNode], is_reorder_round: bool) -> list[tuple[BaseSchedulerNode, BaseSchedulerNode]]:
        """
    ...
    def fusion_prevent_too_many_reads_and_writes(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, threshold: int) -> bool:
        ...
    ...
    def decide_fusion_fail_reason(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, common_buf_names: Union[tuple[str, ...], OrderedSet[str]]) -> str:
        """
    ...
    def shared_data_after_inverting_indexing(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> int:
        """
    ...
    def get_expand_dim_for_pointwise_nodes(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode) -> Optional[tuple[int, SchedulerNode, sympy.Expr]]:
        """
    ...
    def can_fuse(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, can_reorder: bool = ..., allow_mix_order_reduction: bool = ...) -> bool:
        """
    ...
    def dep_size_hint(self, dep: Dep, count_bytes: bool = ...) -> int:
        ...
    
    def score_fusion_memory(self, node1: BaseSchedulerNode, node2: BaseSchedulerNode, count_bytes: bool = ..., return_is_mix_order_reduction: bool = ..., allow_mix_order_reduction: bool = ...) -> int | tuple[int, bool]:
        """
    ...
    def get_name_to_nodes(self) -> dict[str, Union[ir.IRNode, ir.TorchBindObject, sympy.Expr]]:
        """
    ...
    def get_graph_partition_symbol_inputs(self, partition: PartitionType, input_nodes: dict[str, Union[ir.IRNode, ir.TorchBindObject, sympy.Expr]]) -> OrderedSet[sympy.Symbol]:
        """
    ...
    def use_default_device_context(self, partitions: list[PartitionType], signatures: list[GraphPartitionSignature]) -> contextlib.AbstractContextManager[None]:
        ...
    
    def update_graph_partition_default_device(self, partitions: list[PartitionType], signatures: list[GraphPartitionSignature]) -> None:
        ...
    
    def benchmark_combo_kernel(self, node_list: Sequence[BaseSchedulerNode], node_benchmark_results) -> tuple[float, float, list[Optional[str]]]:
        """
        Benchmark fused list of nodes and return the execution time
        in milliseconds on randomly generated inputs.
        """
...
class BaseScheduling:
    ...
    def codegen_comment(self, node_schedule: Sequence[BaseSchedulerNode], kernel_name: Optional[str] = ...) -> None:
        ...
