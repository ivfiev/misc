...
class ShapePropagationOpsHandler:
    ...
    @staticmethod
    def reduction(dtype: torch.dtype, src_dtype: torch.dtype, reduction_type: str, value: Union[ShapeArg, tuple[ShapeArg, ...]]) -> Union[BlockShapeType, tuple[BlockShapeType, ...]]:
        ...
    ...
    @staticmethod
    def to_dtype(value: ShapeVar, dtype: torch.dtype, src_dtype: Optional[torch.dtype] = ..., use_compute_types: bool = ...) -> BlockShapeType:
        ...
    ...
    @staticmethod
    def indirect_indexing(var: ShapeArg, size: Union[sympy.Expr, int], check: bool = ..., wrap_neg: bool = ...) -> None:
        ...
