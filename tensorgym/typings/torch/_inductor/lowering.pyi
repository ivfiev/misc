...
def group_foreach_args(arg_pairs: Iterable[Any]) -> defaultdict[tuple[Any, bool], list[tuple[int, Any]]]:
    ...
...
def tag_to_layout_constraint(tag: torch._C.Tag) -> Optional[Callable[..., tuple[Any, Any]]]:
    ...

def assert_nyi(cond: bool, msg: str) -> None:
    ...

def add_needs_realized_inputs(fn: Union[Collection[Union[torch._ops.OpOverload, torch._ops.OpOverloadPacket]], torch._ops.OpOverload, torch._ops.OpOverloadPacket,]) -> Optional[list[Any]]:
    ...

def add_layout_constraint(fn: Union[torch._ops.OpOverloadPacket, torch._ops.OpOverload], constraint: Callable[..., tuple[Any, Any]]) -> None:
    ...
...
def get_promoted_dtype(*args: Any, type_promotion_kind: ELEMENTWISE_TYPE_PROMOTION_KIND, return_compute_dtype: bool = ...) -> torch.dtype:
    ...

def get_overloads(aten_fn) -> list[Any]:
    ...

def in_namespace(op: Union[Any, torch._ops.OpOverloadPacket, torch._ops.OpOverload], namespace: str) -> bool:
    ...
...
def make_foreach_pointwise(pw_fn, allow_alpha=...) -> Callable[..., Any]:
    ...
...
def to_dtype(x: TensorBox, dtype: torch.dtype, copy: bool = ...) -> TensorBox:
    ...

def to_dtype_bitcast(x: TensorBox, dtype: torch.dtype, *, copy=...) -> TensorBox | PyTree:
    ...

def to_device(x: TensorBox, device: torch.device, *, copy=..., non_blocking=...) -> TensorBox:
    ...

def register_pointwise(aten_fn, name=..., broadcast=..., type_promotion_kind=..., convert_input_to_bool=..., override_return_dtype=..., override_fn_when_input_bool=..., allow_alpha=..., triton_fallback=...) -> Callable[..., Any | TensorBox]:
    """A pointwise function that maps ops.{name} to inputs"""
    ...

@register_lowering(aten.ldexp, broadcast=True, type_promotion_kind=None)
def ldexp_lowering(x: TensorBox, n: TensorBox) -> TensorBox:
    ...
...
def register_foreach_pointwise(aten_fn, pointwise_lowering_fn, allow_alpha=...) -> Callable[..., Any]:
    ...
...
def broadcast_tensors(*inputs) -> tuple[Any] | list[Any]:
    ...
...
def lower_assert_async(cond, msg) -> TensorBox:
    ...

@register_lowering(aten._functional_assert_async.msg)
def lower_assert_functional_async(cond, msg) -> TensorBox:
    ...
...
def inductor_seeds(count, device) -> ShapeAsConstantBuffer:
    ...
...
@register_lowering(aten.bucketize.Tensor, type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.NO_OPMATH)
...
def constrain_to_fake_tensor(arg, fake_arg) -> Any | dict[Any, Any | dict[Any, Any] | list[Any] | tuple[Any, ...]] | list[Any] | tuple[Any, ...]:
    ...

def constrain_to_fake_tensors(args, kwargs, fake_args, fake_kwargs) -> tuple[tuple[Any | dict[Any, Any | dict[Any, Any] | list[Any] | tuple[Any, ...]] | list[Any] | tuple[Any, ...], ...], dict[Any, Any | dict[Any, Any | dict[Any, Any] | list[Any] | tuple[Any, ...]] | list[Any] | tuple[Any, ...]]]:
    ...

def constrain_to_fx_strides(fx_node, *args, **kwargs) -> tuple[tuple[Any | dict[Any, Any | dict[Any, Any]], ...], dict[str, Any | dict[Any, Any | dict[Any, Any | dict[Any, Any]]]]]:
    ...
...
def select_scatter(x, src, dim: int, index: int) -> PyTree | TensorBox:
    ...
...
def as_tensor(data, dtype=..., device=...) -> TensorBox:
    ...
...
def should_fallback_max_pool_with_indices(kernel_size, *, n_dim) -> bool:
    ...

def max_pool_checks(x, kernel_size, stride, padding, dilation, n_dim, *, assert_fallback=...) -> tuple[Sequence[int], Sequence[int], Sequence[int], Sequence[int], bool]:
    ...
...
def upsample_nearest2d_backward(x, output_size=..., input_size=..., scales_h=..., scales_w=...) -> TensorBox:
    ...

@register_lowering(aten.avg_pool2d, type_promotion_kind=None)
def avg_pool2d(x, kernel_size, stride=..., padding=..., ceil_mode=..., count_include_pad=..., divisor_override=...) -> TensorBox:
    ...

@register_lowering(aten.avg_pool3d, type_promotion_kind=None)
def avg_pool3d(x, kernel_size, stride=..., padding=..., ceil_mode=..., count_include_pad=..., divisor_override=...) -> TensorBox:
    ...
...
def addcmul(self, tensor1, tensor2, *, value=...) -> NotImplementedType | TensorBox:
    """
...
def sym_size(a, dim) -> int:
    ...

@register_lowering(aten.sym_stride.int)
def sym_stride(a, dim) -> int:
    ...
...
def set__source_tensor(self, source_tensor) -> ShapeAsConstantBuffer:
    ...
...
def cond(pred, true_fn, false_fn, operands) -> list[Union[ir.TensorBox, ir.ShapeAsConstantBuffer]]:
    ...

@register_lowering(torch.ops.higher_order.while_loop, type_promotion_kind=None)
def while_loop(cond_fn, body_fn, carried_inputs, additional_inputs, stack_output=...) -> list[Any]:
    ...

@register_lowering(torch.ops.higher_order.invoke_subgraph, type_promotion_kind=None)
def invoke_subgraph(subgraph_fn: ir.Subgraph, identifier: str, *operands) -> list[ShapeAsConstantBuffer]:
    ...

def process_subgraph_nodes(graph_module: torch.fx.GraphModule, args: list[Any]) -> Any:
...
def control_deps_op_lowering(additional_deps, subgraph_fn, *args) -> Any:
    """
...
def with_effects(token, op, *args, **kwargs) -> tuple[Any, *tuple[Any, ...]] | tuple[Any, Any]:
    """
...
def cvt_e8m0_rceil_lowering(inp) -> TensorBox:
    """
