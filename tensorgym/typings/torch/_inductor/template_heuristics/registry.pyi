...
log = ...
def register_template_heuristic(template_name: str, device_type: Union[str, None], register: bool = ..., op_name: Optional[str] = ...) -> Any:
    """
...
def get_registered_heuristic_class(template_name: str, device_type: str, op_name: str) -> None | type[TemplateConfigHeuristics]:
    """
...
def override_template_heuristics(device_type: str, template_op_pairs: list[tuple[str, str]], override_heuristic_class: type[TemplateConfigHeuristics] = ...) -> Iterator[None]:
    """
