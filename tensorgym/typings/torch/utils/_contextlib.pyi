...
def context_decorator(ctx, func) -> _Wrapped[..., Any, ..., Generator[Any, Any, Any]] | _Wrapped[..., Any, ..., Any]:
    """
...
class _NoParamDecoratorContextManager(_DecoratorContextManager):
    ...
    @overload
    def __new__(cls, orig_func: None = ...) -> Self:
        ...
    
    def __new__(cls, orig_func: F | None = ...) -> Self | F:
        ...
