...
class SummaryWriter:
    ...
    training.
    """
    def __init__(self, log_dir=..., comment=..., purge_step=..., max_queue=..., flush_secs=..., filename_suffix=...) -> None:
    ...
    def add_hparams(self, hparam_dict, metric_dict, hparam_domain_discrete=..., run_name=..., global_step=...) -> None:
    ...
    def add_scalar(self, tag, scalar_value, global_step=..., walltime=..., new_style=..., double_precision=...) -> None:
    ...
    def add_histogram_raw(self, tag, min, max, num, sum, sum_squares, bucket_limits, bucket_counts, global_step=..., walltime=...) -> None:
    ...
    def add_image_with_boxes(self, tag, img_tensor, box_tensor, global_step=..., walltime=..., rescale=..., dataformats=..., labels=...) -> None:
    ...
    def add_figure(self, tag: str, figure: Union[Figure, list[Figure]], global_step: int | None = ..., close: bool = ..., walltime: float | None = ...) -> None:
    ...
    def add_embedding(self, mat, metadata=..., label_img=..., global_step=..., tag=..., metadata_header=...) -> None:
    ...
    def add_pr_curve(self, tag, labels, predictions, global_step=..., num_thresholds=..., weights=..., walltime=...) -> None:
    ...
    def add_pr_curve_raw(self, tag, true_positive_counts, false_positive_counts, true_negative_counts, false_negative_counts, precision, recall, global_step=..., num_thresholds=..., weights=..., walltime=...) -> None:
    ...
    def add_mesh(self, tag, vertices, colors=..., faces=..., config_dict=..., global_step=..., walltime=...) -> None:
