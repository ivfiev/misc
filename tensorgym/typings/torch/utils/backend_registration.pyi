...
def generate_methods_for_privateuse1_backend(for_tensor: bool = ..., for_module: bool = ..., for_packed_sequence: bool = ..., for_storage: bool = ..., unsupported_dtype: list[torch.dtype] | None = ...) -> None:
    r"""
