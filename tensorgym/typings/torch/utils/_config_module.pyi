...
if TYPE_CHECKING:
    def Config(default: T | object = ..., justknob: str | None = ..., env_name_default: str | list[str] | None = ..., env_name_force: str | list[str] | None = ..., value_type: type | None = ..., alias: str | None = ...) -> T:
        ...
...
class ConfigModule(ModuleType):
    ...
    def patch(self, arg1: str | dict[str, Any] | None = ..., arg2: Any = ..., **kwargs: dict[str, Any]) -> ContextDecorator:
        """
...
def inherit_fields_from(parent_cls) -> Callable[..., Any]:
    ...
