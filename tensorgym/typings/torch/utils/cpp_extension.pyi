...
class BuildExtension(build_ext):
    ...
    """
    @classmethod
    def with_options(cls, **options) -> type[cls_with_options]:
...
def include_paths(device_type: str = ..., torch_include_dirs=...) -> list[str]:
    """
...
def library_paths(device_type: str = ..., torch_include_dirs: bool = ..., cross_target_platform: str | None = ...) -> list[str]:
    """
...
def load(name, sources: str | list[str], extra_cflags=..., extra_cuda_cflags=..., extra_sycl_cflags=..., extra_ldflags=..., extra_include_paths=..., build_directory=..., verbose=..., with_cuda: bool | None = ..., with_sycl: bool | None = ..., is_python_module=..., is_standalone=..., keep_intermediates=...) -> ModuleType | str:
    """
...
def load_inline(name, cpp_sources, cuda_sources=..., sycl_sources=..., functions=..., extra_cflags=..., extra_cuda_cflags=..., extra_sycl_cflags=..., extra_ldflags=..., extra_include_paths=..., build_directory=..., verbose=..., with_cuda=..., with_sycl=..., is_python_module=..., with_pytorch_error_handling=..., keep_intermediates=..., use_pch=..., no_implicit_headers=...) -> ModuleType | str:
    r'''
