...
class DefaultDeviceType:
    ...
    """
    _default_device_type: Optional[str] = ...
    @staticmethod
...
def checkpoint(function, *args, use_reentrant: Optional[bool] = ..., context_fn: Callable[[], Tuple[ContextManager, ContextManager]] = ..., determinism_check: str = ..., debug: bool = ..., early_stop: bool = ..., **kwargs) -> Any | None:
...
class _CachingTorchDispatchMode(TorchDispatchMode):
    @classmethod
    def ignore_compile_internals(cls) -> Literal[True]:
        ...
...
def create_selective_checkpoint_contexts(policy_fn_or_list, allow_cache_entry_mutation=...) -> tuple[_CachingTorchDispatchMode, _CachedTorchDispatchMode]:
    """
