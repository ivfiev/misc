...
@register_flop_formula([aten.convolution, aten._convolution, aten.cudnn_convolution, aten._slow_conv2d_forward, aten.convolution_overrideable])
...
class FlopCounterMode:
    ...
    """
    def __init__(self, mods: torch.nn.Module | list[torch.nn.Module] | None = ..., depth: int = ..., display: bool = ..., custom_mapping: dict[Any, Any] | None = ...) -> None:
        ...
