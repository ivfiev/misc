...
def package_pt2(f: FileLike, *, exported_programs: ExportedProgram | dict[str, ExportedProgram] | None = ..., aoti_files: AOTI_FILES | None = ..., extra_files: dict[str, Any] | None = ..., opset_version: dict[str, int] | None = ..., pickle_protocol: int = ..., executorch_files: dict[str, bytes] | None = ...) -> FileLike:
    r"""
...
def load_pt2(f: FileLike, *, expected_opset_version: dict[str, int] | None = ..., run_single_threaded: bool = ..., num_runners: int = ..., device_index: int = ..., load_weights_from_disk: bool = ...) -> PT2ArchiveContents:
    """
