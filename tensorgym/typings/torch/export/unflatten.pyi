...
class InterpreterModuleDispatcher(_SubmoduleBase, torch.nn.Module):
    ...
    def print_readable(self, print_output=..., include_stride=..., include_device=..., colored=...) -> LiteralString:
        ...
...
class FlatArgsAdapter(abc.ABC):
    ...
    """
    @abc.abstractmethod
    def adapt(self, target_spec: pytree.TreeSpec, input_spec: pytree.TreeSpec, input_args: list[Any], metadata: dict[str, Any] | None = ..., obj: Any | None = ...) -> list[Any]:
...
class _ModuleFrame:
    def __init__(self, flat_graph: torch.fx.Graph, nodes: tuple[torch.fx.Node, ...], seen_nodes, seen_modules, seen_attrs, created_modules, parent, module_stack: list[tuple[str, str | None, int]], module_id, module_call_graph: dict[str, ModuleCallSignature], module: torch.fx.GraphModule | UnflattenedModule | None = ...) -> None:
        ...
