...
__all__ = ["AdditionalInputs", "Constraint", "CustomDecompTable", "default_decompositions", "Dim", "dims", "draft_export", "export", "ExportBackwardSignature", "ExportedProgram", "ExportGraphSignature", "FlatArgsAdapter", "load", "ModuleCallEntry", "ModuleCallSignature", "register_dataclass", "save", "ShapesCollection", "unflatten", "UnflattenedModule"]
PassType = Callable[[torch.fx.GraphModule], PassResult | None]
log: logging.Logger = ...
def export(mod: torch.nn.Module, args: tuple[Any, ...], kwargs: Mapping[str, Any] | None = ..., *, dynamic_shapes: dict[str, Any] | tuple[Any, ...] | list[Any] | None = ..., strict: bool = ..., preserve_module_call_signature: tuple[str, ...] = ..., prefer_deferred_runtime_asserts_over_guards: bool = ...) -> ExportedProgram:
    """
...
def save(ep: ExportedProgram, f: FileLike, *, extra_files: dict[str, Any] | None = ..., opset_version: dict[str, int] | None = ..., pickle_protocol: int = ...) -> None:
    """
...
def load(f: FileLike, *, extra_files: dict[str, Any] | None = ..., expected_opset_version: dict[str, int] | None = ...) -> ExportedProgram:
    """
...
def draft_export(mod: torch.nn.Module, args: tuple[Any, ...], kwargs: Mapping[str, Any] | None = ..., *, dynamic_shapes: dict[str, Any] | tuple[Any, ...] | list[Any] | None = ..., preserve_module_call_signature: tuple[str, ...] = ..., strict: bool = ..., prefer_deferred_runtime_asserts_over_guards: bool = ...) -> ExportedProgram:
    """
