...
def draft_export(mod: torch.nn.Module, args: tuple[Any, ...], kwargs: Mapping[str, Any] | None = ..., *, dynamic_shapes: dict[str, Any] | tuple[Any] | list[Any] | None = ..., preserve_module_call_signature: tuple[str, ...] = ..., strict: bool = ..., pre_dispatch: bool = ..., prefer_deferred_runtime_asserts_over_guards: bool = ...) -> ExportedProgram:
    ...
