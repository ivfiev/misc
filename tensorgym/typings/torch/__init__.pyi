...
from typing import Any as _Any, TYPE_CHECKING, TypeVar as _TypeVar, get_origin as _get_origin, overload as _overload
from typing_extensions import ParamSpec as _ParamSpec, TypeIs as _TypeIs, deprecated as _deprecated
...
class SymBool:
    ...
    def __sym_float__(self) -> int | float | bool | SymInt | SymFloat | SymBool:
        """
...
class _TorchCompileInductorWrapper:
    ...
    def __call__(self, model_, inputs_) -> CompileFxOutput:
        ...
...
@_overload
def compile(model: _Callable[_InputT, _RetT], *, fullgraph: builtins.bool = ..., dynamic: builtins.bool | None = ..., backend: str | _Callable = ..., mode: str | None = ..., options: dict[str, str | builtins.int | builtins.bool | _Callable] | None = ..., disable: builtins.bool = ...) -> _Callable[_InputT, _RetT]:
    ...

@_overload
def compile(model: None = ..., *, fullgraph: builtins.bool = ..., dynamic: builtins.bool | None = ..., backend: str | _Callable = ..., mode: str | None = ..., options: dict[str, str | builtins.int | builtins.bool | _Callable] | None = ..., disable: builtins.bool = ...) -> _Callable[[_Callable[_InputT, _RetT]], _Callable[_InputT, _RetT]]:
    ...

def compile(model: _Callable[_InputT, _RetT] | None = ..., *, fullgraph: builtins.bool = ..., dynamic: builtins.bool | None = ..., backend: str | _Callable = ..., mode: str | None = ..., options: dict[str, str | builtins.int | builtins.bool | _Callable] | None = ..., disable: builtins.bool = ...) -> (_Callable[[_Callable[_InputT, _RetT]], _Callable[_InputT, _RetT]] | _Callable[_InputT, _RetT]):
    """
